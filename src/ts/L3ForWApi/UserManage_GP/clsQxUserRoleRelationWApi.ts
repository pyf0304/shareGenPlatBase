 ...
 **/
export  function QxUserRoleRelation_CopyToEx(objQxUserRoleRelationENS:clsQxUserRoleRelationEN ): clsQxUserRoleRelationENEx
{
const strThisFuncName  = QxUserRoleRelation_CopyToEx.name;
...
{
const strMsg = Format("(errid:Watl001294)Copy表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
 return objQxUserRoleRelationENT;
}
...
*/
export  function QxUserRoleRelation_FuncMapByFldName(strFldName: string, objQxUserRoleRelationEx: clsQxUserRoleRelationENEx)
{
const strThisFuncName = QxUserRoleRelation_FuncMapByFldName.name;
...
return QxUserRoleRelation_FuncMapDepartmentName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_DepartmentTypeName:
return QxUserRoleRelation_FuncMapDepartmentTypeName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_RoleName:
return QxUserRoleRelation_FuncMapRoleName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_UserName:
return QxUserRoleRelation_FuncMapUserName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_PrjName:
return QxUserRoleRelation_FuncMapPrjName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_DepartmentId:
return QxUserRoleRelation_FuncMapDepartmentId(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_OrderNum:
return QxUserRoleRelation_FuncMapOrderNum(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_DepartmentAbbrName:
return QxUserRoleRelation_FuncMapDepartmentAbbrName(objQxUserRoleRelationEx);
case clsQxUserRoleRelationENEx.con_SchoolName:
return QxUserRoleRelation_FuncMapSchoolName(objQxUserRoleRelationEx);
        default:
 ...
 * @returns 返回两个对象比较的结果
*/
export  function QxUserRoleRelation_SortFunByExKey(strKey:string, AscOrDesc: string)
{
...
case clsQxUserRoleRelationENEx.con_DepartmentAbbrName:
return (a: clsQxUserRoleRelationENEx, b: clsQxUserRoleRelationENEx) => {
    if (a.departmentAbbrName === null && b.departmentAbbrName === null) return 0;
 ...
 **/
export  async function QxUserRoleRelation_FuncMapDepartmentName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapDepartmentName.name;
try
{
if (IsNullOrEmpty(objQxUserRoleRelation.departmentName) == true){
 const vQxUsersSimUserId = objQxUserRoleRelation.userId;
 const vQxUsersSimDepartmentId = await vQxUsersSim_func(clsvQxUsersSimEN.con_UserId, clsvQxUsersSimEN.con_DepartmentId, vQxUsersSimUserId );
...
{
const strMsg = Format("(errid:Watl001498)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapDepartmentTypeName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapDepartmentTypeName.name;
try
{
...
{
const strMsg = Format("(errid:Watl001499)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapRoleName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapRoleName.name;
try
{
if (IsNullOrEmpty(objQxUserRoleRelation.roleName) == true){
 const QxUserRolesRoleId = objQxUserRoleRelation.roleId;
if (IsNullOrEmpty(objQxUserRoleRelation.qxPrjId) == true)
{
const strMsg = `函数映射[RoleName]数据出错,qxPrjId不能为空!(in ${ qxUserRoleRelation_ConstructorName }.${strThisFuncName})`
console.error(strMsg);
alert(strMsg);
return;
}
 const QxUserRolesRoleName = await QxRoles_func(clsQxRolesEN.con_RoleId, clsQxRolesEN.con_RoleName, QxUserRolesRoleId , objQxUserRoleRelation.qxPrjId);
 objQxUserRoleRelation.roleName = QxUserRolesRoleName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl001496)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapUserName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapUserName.name;
try
{
...
{
const strMsg = Format("(errid:Watl001416)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapPrjName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapPrjName.name;
try
{
...
{
const strMsg = Format("(errid:Watl001315)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapDepartmentId(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapDepartmentId.name;
try
{
...
{
const strMsg = Format("(errid:Watl001500)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapOrderNum(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapOrderNum.name;
try
{
if (objQxUserRoleRelation.orderNum == 0){
 ...
 const vQxUsersSimDepartmentId = await vQxUsersSim_func(clsvQxUsersSimEN.con_UserId, clsvQxUsersSimEN.con_DepartmentId, vQxUsersSimUserId );
 const QxDepartmentInfoDepartmentId = vQxUsersSimDepartmentId;
 const QxDepartmentInfoOrderNum = await QxDepartmentInfo_func(clsQxDepartmentInfoEN.con_DepartmentId, clsQxDepartmentInfoEN.con_OrderNum, QxDepartmentInfoDepartmentId );
 objQxUserRoleRelation.orderNum = QxDepartmentInfoOrderNum;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl001339)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapDepartmentAbbrName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapDepartmentAbbrName.name;
try
{
if (IsNullOrEmpty(objQxUserRoleRelation.departmentAbbrName) == true){
 ...
 const vQxUsersSimDepartmentId = await vQxUsersSim_func(clsvQxUsersSimEN.con_UserId, clsvQxUsersSimEN.con_DepartmentId, vQxUsersSimUserId );
 const QxDepartmentInfoDepartmentId = vQxUsersSimDepartmentId;
 const QxDepartmentInfoDepartmentAbbrName = await QxDepartmentInfo_func(clsQxDepartmentInfoEN.con_DepartmentId, clsQxDepartmentInfoEN.con_DepartmentAbbrName, QxDepartmentInfoDepartmentId );
 objQxUserRoleRelation.departmentAbbrName = QxDepartmentInfoDepartmentAbbrName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl001501)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxUserRoleRelationS:源对象
 **/
export  async function QxUserRoleRelation_FuncMapSchoolName(objQxUserRoleRelation:clsQxUserRoleRelationENEx )
{
const strThisFuncName = QxUserRoleRelation_FuncMapSchoolName.name;
try
{
if (IsNullOrEmpty(objQxUserRoleRelation.schoolName) == true){
 const vQxXzSchoolIdSchool = objQxUserRoleRelation.id_School;
 ...
 objQxUserRoleRelation.schoolName = vQxXzSchoolSchoolName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl001403)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxUserRoleRelation_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
...
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.id_School) == false && GetStrLen(pobjQxUserRoleRelationEN.id_School) > 4)
{
 throw new Error(`(errid:Watl000413)字段[学校流水号(id_School)]的长度不能超过4(In 用户角色关系(QxUserRoleRelation))!值:${pobjQxUserRoleRelationEN.id_School}(clsQxUserRoleRelationBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.id_School) == false && undefined !== pobjQxUserRoleRelationEN.id_School && tzDataType.isString(pobjQxUserRoleRelationEN.id_School) === false)
{
 throw new Error(`(errid:Watl000414)字段[学校流水号(id_School)]的值:[${pobjQxUserRoleRelationEN.id_School}], 非法,应该为字符型(In 用户角色关系(QxUserRoleRelation))!(clsQxUserRoleRelationBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.id_School) == false && GetStrLen(pobjQxUserRoleRelationEN.id_School) > 4)
{
 throw new Error(`(errid:Watl000416)字段[学校流水号(id_School)]的长度不能超过4(In 用户角色关系(QxUserRoleRelation))!值:${pobjQxUserRoleRelationEN.id_School}(clsQxUserRoleRelationBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.qxPrjId) == false && GetStrLen(pobjQxUserRoleRelationEN.qxPrjId) > 4)
{
...
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.id_School) == false && undefined !== pobjQxUserRoleRelationEN.id_School && tzDataType.isString(pobjQxUserRoleRelationEN.id_School) === false)
{
 throw new Error(`(errid:Watl000417)字段[学校流水号(id_School)]的值:[${pobjQxUserRoleRelationEN.id_School}], 非法,应该为字符型(In 用户角色关系(QxUserRoleRelation))!(clsQxUserRoleRelationBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjQxUserRoleRelationEN.qxPrjId) == false && undefined !== pobjQxUserRoleRelationEN.qxPrjId && tzDataType.isString(pobjQxUserRoleRelationEN.qxPrjId) === false)
{
...
if (Object.prototype.hasOwnProperty.call(objQxUserRoleRelationCond.dicFldComparisonOp, clsQxUserRoleRelationEN.con_Id_School) == true)
{
const strComparisonOpId_School:string = objQxUserRoleRelationCond.dicFldComparisonOp[clsQxUserRoleRelationEN.con_Id_School];
strWhereCond += Format(" And {0} {2} '{1}'", clsQxUserRoleRelationEN.con_Id_School, objQxUserRoleRelationCond.id_School, strComparisonOpId_School);
}
