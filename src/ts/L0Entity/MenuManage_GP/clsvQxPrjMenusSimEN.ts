...
public static readonly _CurrTabName: string = "vQxPrjMenusSim"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "MenuId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 9;
public static readonly _AttributeName = ["menuId", "menuName", "qxPrjId", "upMenuId", "pageDispModeId", "inUse", "subMenusNum", "roleNum", "menuSetId"];
//以下是属性变量
