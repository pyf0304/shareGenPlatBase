 ...
 **/
export async function XzSchool_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 **/
export async function XzSchool_AddNewObjSave(
  objXzSchoolEN: clsXzSchoolEN,
...
*/
export async function XzSchool_BindDdl_IdSchoolInDivCache(
...
export function XzSchool_CheckPropertyNew(pobjXzSchoolEN: clsXzSchoolEN) {
  ...
  if (IsNullOrEmpty(pobjXzSchoolEN.schoolNameA) === true) {
    throw new Error(
      `(errid:Watl000411)字段[学校简称]不能为空(In 学校)!(clsXzSchoolBL:CheckPropertyNew0)`,
    );
  }
  ...
  if (
    ...
    GetStrLen(pobjXzSchoolEN.schoolNameA) > 21
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学校简称(schoolNameA)]的长度不能超过21(In 学校(XzSchool))!值:${pobjXzSchoolEN.schoolNameA}(clsXzSchoolBL:CheckPropertyNew)`,
    );
  }
  if (
...
export function XzSchool_CheckProperty4Update(pobjXzSchoolEN: clsXzSchoolEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学校简称(schoolNameA)]的长度不能超过21(In 学校(XzSchool))!值:${pobjXzSchoolEN.schoolNameA}(clsXzSchoolBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzSchoolEN.schoolTypeId) == false &&
