...
<tr >
<td class="text-right">
<label id="lblRoleName_q" name="lblRoleName_q" class="col-form-label text-right" style="width:90px;">角色名称
</label>
</td>
<td class="text-left">
<input  id="txtRoleName_q" v-model="roleName_q" class="form-control form-control-sm" style="width:120px;"/>
</td>
<td class="text-right">
<label id="lblQxPrjId_q" name="lblQxPrjId_q" class="col-form-label text-right" style="width:90px;">项目Id
</label>
</td>
<td class="text-left">
<select id="ddlQxPrjId_q" v-model='qxPrjId_q' class="form-control form-control-sm" style="width:120px;">
...
<ul class="nav">
<li class="nav-item">
<label id="lblQxRolesV2List" name="lblQxRolesV2List" class="col-form-label text-info" style="width:250px;">角色V2列表
</label>
</li>
...
<QxRolesV2_ListCom 
ref="refQxRolesV2_List" 
:items="dataListQxRolesV2"
...
<!--编辑层-->
<QxRolesV2_EditCom ref='refQxRolesV2_Edit'></QxRolesV2_EditCom>
</div>
</template>
<script lang="ts">
...
import { divVarSet,refDivLayout,refDivQuery,refDivFunction,refDivList,refQxRolesV2_Edit,refQxRolesV2_List,showErrorMessage,dataListQxRolesV2,emptyRecNumInfo,dataColumn,roleName_q,qxPrjId_q, } from "@/views/UserManage_GP/QxRolesV2VueShare";
...
import QxRolesV2_ListCom from '@/views/UserManage_GP/QxRolesV2_List.vue';
...
setup() {
 ...
 const objPage = ref<QxRolesV2CRUDEx>();
 const objPage_Edit = ref<QxRolesV2_EditEx>();
 const opType = ref('');
 const thisConstructorName = 'QxRolesV2CRUD';
...
await objPage.value.BindGv_QxRolesV2(refDivList.value);
}
...
objPage_Edit.value = new QxRolesV2_EditEx('QxRolesV2_EditEx', objPage.value);
...
{
opType.value = "Add";
const bolIsSuccess = await objPage_Edit.value.ShowDialog_QxRolesV2(opType.value);
...
const intRId = Number(strFstKeyId);
if (intRId == 0)
{
...
await objPage.value.BindGv_QxRolesV2(divVarSet.refDivList);
}
catch(e)
{
...
const objExportExcelData: ExportExcelData = await objPage.value.ExportExcel_QxRolesV2();
...
QxRolesV2CRUDEx.vuebtn_Click = btn_Click;
QxRolesV2CRUDEx.GetPropValue = GetPropValue;
objPage.value = new QxRolesV2CRUDEx();
...
QxRolesV2CRUDEx.btn_Click(strCommandName, strKeyId);
}
return {
showErrorMessage,
dataListQxRolesV2,
...
router.push({ name: 'editQxRolesV2', params: { courseId: data.courseId } });
},
