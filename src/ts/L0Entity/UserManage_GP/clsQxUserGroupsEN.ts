...
export class  clsQxUserGroupsEN extends clsGeneralTab
{
...
public static readonly _CurrTabName: string = "QxUserGroups"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "GroupId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 4;
public static readonly _AttributeName = ["groupId", "groupName", "qxPrjId", "memo"];
//以下是属性变量
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxUserGroups]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxUserGroups]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsQxUserGroupsEN();
const instance = new clsQxUserGroupsEN();
