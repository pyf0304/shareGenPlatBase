...
public static readonly _CurrTabName: string = "QxPrjMenuSet"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "MenuSetId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 9;
public static readonly _AttributeName = ["menuSetId", "menuSetName", "menuSetENName", "qxPrjId", "cmPrjId", "isDefault", "updDate", "updUser", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_MenuSetENName = "menuSetENName";    //菜单集英文名
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsDefault = "isDefault";    //是否默认
