...
import { qxRolesCache, isFuncMapCache } from '@/viewsShare/UserManage_GP/QxRolesVueShare';
...
import { vQx_UserType_func } from '@/ts/L3ForWApi/SysPara/clsvQx_UserTypeWApi';
...
export async function QxRoles_GetObjByRoleIdAsync(strRoleId: string): Promise<clsQxRolesEN | null> {
  ...
  if (strRoleId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strRoleId]的长度:[{0}]不正确!(clsQxRolesWApi.GetObjByRoleIdAsync)',
      strRoleId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function QxRoles_GetObjByRoleIdlocalStorage(strRoleId: string) {
  ...
  if (IsNullOrEmpty(strRoleId) == true) {
    const strMsg = Format(
      '参数:[strRoleId]不能为空!(In clsQxRolesWApi.GetObjByRoleIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strRoleId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strRoleId]的长度:[{0}]不正确!(clsQxRolesWApi.GetObjByRoleIdlocalStorage)',
      strRoleId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function QxRoles_GetObjByRoleIdCache(
  strRoleId: string,
  strQxPrjId: string,
  ...
  if (strRoleId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strRoleId]的长度:[{0}]不正确!(clsQxRolesWApi.GetObjByRoleIdCache)',
      strRoleId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function QxRoles_UpdateObjInLstCache(objQxRoles: clsQxRolesEN, strQxPrjId: string) {
  ...
  try {
    const arrQxRolesObjLstCache = await QxRoles_GetObjLstCache(strQxPrjId);
    const obj = arrQxRolesObjLstCache.find(
      (x) => x.roleName == objQxRoles.roleName && x.qxPrjId == objQxRoles.qxPrjId,
    );
    if (obj != null) {
...
export async function QxRoles_GetNameByRoleIdCache(strRoleId: string, strQxPrjId: string) {
  ...
  if (strRoleId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strRoleId]的长度:[{0}]不正确!(clsQxRolesWApi.GetNameByRoleIdCache)',
      strRoleId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
*/
export async function QxRoles_func(
  strInFldName: string,
  ...
  if (strQxPrjIdClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjIdClassfy]的长度:[{0}]不正确!(clsQxRolesWApi.func)',
  ...
  if (clsQxRolesEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      ...
      strOutFldName,
      clsQxRolesEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
*/
export async function QxRoles_funcKey(
  strInFldName: string,
  strInValue: any,
  ...
  if (strQxPrjIdClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjIdClassfy]的长度:[{0}]不正确!(clsQxRolesWApi.funcKey)',
      strQxPrjIdClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 **/
export async function QxRoles_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
...
export async function QxRoles_GetObjLstCache(strQxPrjId: string): Promise<Array<clsQxRolesEN>> {
  ...
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxRolesWApi.QxRoles_GetObjLstCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象列表子集
 */
export async function QxRoles_GetSubObjLstCache(
  objQxRolesCond: ConditionCollection,
  strQxPrjId: string,
) {
 ...
 * @returns 对象列表
 **/
export async function QxRoles_GetObjLstByRoleIdLstAsync(
  arrRoleId: Array<string>,
): Promise<Array<clsQxRolesEN>> {
 ...
 * @returns 对象列表
 */
export async function QxRoles_GetObjLstByRoleIdLstCache(
  arrRoleIdLst: Array<string>,
  strQxPrjId: string,
) {
 ...
 * @returns 获取的相应对象列表
 **/
export async function QxRoles_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QxRoles_GetObjLstByRangeAsync(
 ...
 * @returns 对象列表
 */
export async function QxRoles_GetObjLstByPagerCache(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QxRoles_GetObjLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsQxRolesEN>> {
 ...
 * @returns 对象列表
 */
export async function QxRoles_GetObjExLstByPagerCache(
  objPagerPara: stuPagerPara,
  strQxPrjId: string,
  ...
  const arrQxRolesExObjLst = arrQxRolesObjLst.map((obj) => {
    ...
    if (qxRolesCache[cacheKey]) {
      ...
      const newObj = QxRoles_CopyToEx(obj);
  ...
  for (const newObj of arrNewObj) {
    for (const strFldName of Object.keys(isFuncMapCache)) {
      await QxRoles_FuncMapByFldName(strFldName, newObj);
    }
  }
  ...
  if (
    ...
    for (const newObj of arrQxRolesExObjLst) {
      await QxRoles_FuncMapByFldName(objSortInfo.SortFld, newObj);
  ...
  try {
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      arrQxRolesSel = arrQxRolesSel.sort(
        QxRoles_SortFunByExKey(objSortInfo.SortFld, objSortInfo.SortType),
      );
    } else {
      //如果排序字段名[OrderBy]为空,就调用排序函数
      arrQxRolesSel = arrQxRolesSel.sort(objPagerPara.sortFun);
 ...
 **/
export function QxRoles_CopyToEx(objQxRolesENS: clsQxRolesEN): clsQxRolesENEx {
  const strThisFuncName = QxRoles_CopyToEx.name;
 ...
 */
export function QxRoles_FuncMapByFldName(strFldName: string, objQxRolesEx: clsQxRolesENEx) {
  const strThisFuncName = QxRoles_FuncMapByFldName.name;
  ...
  switch (strFldName) {
    case clsQxRolesENEx.con_UserTypeName:
      return QxRoles_FuncMapUserTypeName(objQxRolesEx);
    case clsQxRolesENEx.con_UserTypeNameSim:
      return QxRoles_FuncMapUserTypeNameSim(objQxRolesEx);
    case clsQxRolesENEx.con_RoleTypeName:
      return QxRoles_FuncMapRoleTypeName(objQxRolesEx);
    default:
      strMsg = Format(
 ...
 * @returns 返回两个对象比较的结果
 */
export function QxRoles_SortFunByExKey(strKey: string, AscOrDesc: string) {
 ...
 **/
export async function QxRoles_FuncMapUserTypeName(objQxRoles: clsQxRolesENEx) {
  const strThisFuncName = QxRoles_FuncMapUserTypeName.name;
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001400)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxRoles_ConstructorName,
      strThisFuncName,
    );
 ...
 * @param objQxRolesS:源对象
 **/
export async function QxRoles_FuncMapUserTypeNameSim(objQxRoles: clsQxRolesENEx) {
  const strThisFuncName = QxRoles_FuncMapUserTypeNameSim.name;
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001401)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxRoles_ConstructorName,
      strThisFuncName,
    );
 ...
 * @param objQxRolesS:源对象
 **/
export async function QxRoles_FuncMapRoleTypeName(objQxRoles: clsQxRolesENEx) {
  const strThisFuncName = QxRoles_FuncMapRoleTypeName.name;
  try {
    if (IsNullOrEmpty(objQxRoles.roleTypeName) == true) {
      const RoleTypeRoleTypeId = objQxRoles.roleTypeId;
      const RoleTypeRoleTypeName = await QxRoleType_func(
        clsQxRoleTypeEN.con_RoleTypeId,
        clsQxRoleTypeEN.con_RoleTypeName,
        RoleTypeRoleTypeId,
      );
    ...
    const strMsg = Format(
      '(errid:Watl001402)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxRoles_ConstructorName,
      strThisFuncName,
    );
 ...
 * @returns 获取相应的记录的对象
 **/
export async function QxRoles_AddNewRecordWithMaxIdAsync(
  objQxRolesEN: clsQxRolesEN,
): Promise<string> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function QxRoles_AddNewRecordWithReturnKeyAsync(
  objQxRolesEN: clsQxRolesEN,
): Promise<string> {
...
export async function QxRoles_UpdateRecordAsync(objQxRolesEN: clsQxRolesEN): Promise<boolean> {
  ...
  if (
    objQxRolesEN.sfUpdFldSetStr === undefined ||
    objQxRolesEN.sfUpdFldSetStr === null ||
    objQxRolesEN.sfUpdFldSetStr === ''
  ) {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function QxRoles_UpdateWithConditionAsync(
  objQxRolesEN: clsQxRolesEN,
  strWhereCond: string,
): Promise<boolean> {
 ...
 * @returns 对象列表子集
 */
export async function QxRoles_IsExistRecordCache(
  objQxRolesCond: ConditionCollection,
  strQxPrjId: string,
) {
 ...
 * @returns 对象列表记录数
 */
export async function QxRoles_GetRecCountByCondCache(
  objQxRolesCond: ConditionCollection,
  strQxPrjId: string,
) {
...
export function QxRoles_ReFreshCache(strQxPrjId: string): void {
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空！(In clsQxRolesWApi.clsQxRolesWApi.ReFreshCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxRolesWApi.clsQxRolesWApi.ReFreshCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export function QxRoles_ReFreshThisCache(strQxPrjId: string): void {
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空！(In clsQxRolesWApi.QxRoles_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxRolesWApi.QxRoles_ReFreshThisCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @param strQxPrjId:
*/
export async function QxRoles_BindDdl_RoleIdByQxPrjIdInDivCache(
 ...
 * @param strQxPrjId:
*/
export async function QxRoles_BindDdl_RoleIdByUserTypeIdInDivCache(
  objDiv: HTMLDivElement,
  strDdlName: string,
  strUserTypeId: string,
  strRoleTypeId: string,
  strQxPrjId: string,
) {
  if (IsNullOrEmpty(strUserTypeId) == true) {
    const strMsg = Format(
      '参数:[strUserTypeId]不能为空！(In clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strUserTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strUserTypeId]的长度:[{0}]不正确！(clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
  ...
  if (IsNullOrEmpty(strRoleTypeId) == true) {
    const strMsg = Format(
      '参数:[strRoleTypeId]不能为空！(In clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strRoleTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strRoleTypeId]的长度:[{0}]不正确！(clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
      strRoleTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
  ...
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空！(In clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxRolesWApi.BindDdl_RoleIdByUserTypeIdInDiv)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  arrObjLstSel = arrObjLstSel.filter(
    (x) => x.userTypeId == strUserTypeId && x.roleTypeId == strRoleTypeId,
  );
 ...
 * @param strQxPrjId:
*/
export async function QxRoles_GetArrQxRolesByUserTypeId(
  strUserTypeId: string,
  strRoleTypeId: string,
  strQxPrjId: string,
) {
...
export function QxRoles_CheckPropertyNew(pobjQxRolesEN: clsQxRolesEN) {
  ...
  if (IsNullOrEmpty(pobjQxRolesEN.roleName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[角色名称]不能为空(In 角色)!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.qxPrjId) === true || pobjQxRolesEN.qxPrjId.toString() === '0') {
    throw new Error(
      `(errid:Watl000411)字段[项目Id]不能为空(In 角色)!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (IsNullOrEmpty(pobjQxRolesEN.roleId) == false && GetStrLen(pobjQxRolesEN.roleId) > 8) {
    throw new Error(
      `(errid:Watl000413)字段[角色Id(roleId)]的长度不能超过8(In 角色(QxRoles))!值:${pobjQxRolesEN.roleId}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.roleName) == false && GetStrLen(pobjQxRolesEN.roleName) > 50) {
    throw new Error(
      `(errid:Watl000413)字段[角色名称(roleName)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.roleName}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleENName) == false &&
    GetStrLen(pobjQxRolesEN.roleENName) > 50
  ) {
    throw new Error(
      `(errid:Watl000413)字段[角色英文名(roleENName)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.roleENName}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.userType) == false && GetStrLen(pobjQxRolesEN.userType) > 50) {
    throw new Error(
      `(errid:Watl000413)字段[用户类型(userType)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.userType}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.userTypeId) == false && GetStrLen(pobjQxRolesEN.userTypeId) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[用户类型Id(userTypeId)]的长度不能超过2(In 角色(QxRoles))!值:${pobjQxRolesEN.userTypeId}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.roleTypeId) == false && GetStrLen(pobjQxRolesEN.roleTypeId) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[角色类型Id(roleTypeId)]的长度不能超过2(In 角色(QxRoles))!值:${pobjQxRolesEN.roleTypeId}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.qxPrjId) == false && GetStrLen(pobjQxRolesEN.qxPrjId) > 4) {
    throw new Error(
      `(errid:Watl000413)字段[项目Id(qxPrjId)]的长度不能超过4(In 角色(QxRoles))!值:${pobjQxRolesEN.qxPrjId}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.updDate) == false && GetStrLen(pobjQxRolesEN.updDate) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 角色(QxRoles))!值:${pobjQxRolesEN.updDate}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.updUserId) == false && GetStrLen(pobjQxRolesEN.updUserId) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[修改用户Id(updUserId)]的长度不能超过20(In 角色(QxRoles))!值:${pobjQxRolesEN.updUserId}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.memo) == false && GetStrLen(pobjQxRolesEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 角色(QxRoles))!值:${pobjQxRolesEN.memo}(clsQxRolesBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleId) == false &&
    undefined !== pobjQxRolesEN.roleId &&
    tzDataType.isString(pobjQxRolesEN.roleId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色Id(roleId)]的值:[${pobjQxRolesEN.roleId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleName) == false &&
    undefined !== pobjQxRolesEN.roleName &&
    tzDataType.isString(pobjQxRolesEN.roleName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色名称(roleName)]的值:[${pobjQxRolesEN.roleName}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleENName) == false &&
    undefined !== pobjQxRolesEN.roleENName &&
    tzDataType.isString(pobjQxRolesEN.roleENName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色英文名(roleENName)]的值:[${pobjQxRolesEN.roleENName}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjQxRolesEN.roleIndex &&
    undefined !== pobjQxRolesEN.roleIndex &&
    tzDataType.isNumber(pobjQxRolesEN.roleIndex) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色序号(roleIndex)]的值:[${pobjQxRolesEN.roleIndex}], 非法,应该为数值型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.userType) == false &&
    undefined !== pobjQxRolesEN.userType &&
    tzDataType.isString(pobjQxRolesEN.userType) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[用户类型(userType)]的值:[${pobjQxRolesEN.userType}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.userTypeId) == false &&
    undefined !== pobjQxRolesEN.userTypeId &&
    tzDataType.isString(pobjQxRolesEN.userTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[用户类型Id(userTypeId)]的值:[${pobjQxRolesEN.userTypeId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleTypeId) == false &&
    undefined !== pobjQxRolesEN.roleTypeId &&
    tzDataType.isString(pobjQxRolesEN.roleTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色类型Id(roleTypeId)]的值:[${pobjQxRolesEN.roleTypeId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.qxPrjId) == false &&
    undefined !== pobjQxRolesEN.qxPrjId &&
    tzDataType.isString(pobjQxRolesEN.qxPrjId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[项目Id(qxPrjId)]的值:[${pobjQxRolesEN.qxPrjId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjQxRolesEN.isInUse &&
    undefined !== pobjQxRolesEN.isInUse &&
    tzDataType.isBoolean(pobjQxRolesEN.isInUse) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[是否在使用(isInUse)]的值:[${pobjQxRolesEN.isInUse}], 非法,应该为布尔型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.updDate) == false &&
    undefined !== pobjQxRolesEN.updDate &&
    tzDataType.isString(pobjQxRolesEN.updDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjQxRolesEN.updDate}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.updUserId) == false &&
    undefined !== pobjQxRolesEN.updUserId &&
    tzDataType.isString(pobjQxRolesEN.updUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改用户Id(updUserId)]的值:[${pobjQxRolesEN.updUserId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.memo) == false &&
    undefined !== pobjQxRolesEN.memo &&
    tzDataType.isString(pobjQxRolesEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjQxRolesEN.memo}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckPropertyNew0)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
  if (
    IsNullOrEmpty(pobjQxRolesEN.qxPrjId) == false &&
    pobjQxRolesEN.qxPrjId != '[nuull]' &&
    GetStrLen(pobjQxRolesEN.qxPrjId) != 4
  ) {
...
export function QxRoles_CheckProperty4Update(pobjQxRolesEN: clsQxRolesEN) {
  ...
  if (IsNullOrEmpty(pobjQxRolesEN.roleId) == false && GetStrLen(pobjQxRolesEN.roleId) > 8) {
    throw new Error(
      `(errid:Watl000416)字段[角色Id(roleId)]的长度不能超过8(In 角色(QxRoles))!值:${pobjQxRolesEN.roleId}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.roleName) == false && GetStrLen(pobjQxRolesEN.roleName) > 50) {
    throw new Error(
      `(errid:Watl000416)字段[角色名称(roleName)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.roleName}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleENName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[角色英文名(roleENName)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.roleENName}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.userType) == false && GetStrLen(pobjQxRolesEN.userType) > 50) {
    throw new Error(
      `(errid:Watl000416)字段[用户类型(userType)]的长度不能超过50(In 角色(QxRoles))!值:${pobjQxRolesEN.userType}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.userTypeId) == false && GetStrLen(pobjQxRolesEN.userTypeId) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[用户类型Id(userTypeId)]的长度不能超过2(In 角色(QxRoles))!值:${pobjQxRolesEN.userTypeId}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.roleTypeId) == false && GetStrLen(pobjQxRolesEN.roleTypeId) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[角色类型Id(roleTypeId)]的长度不能超过2(In 角色(QxRoles))!值:${pobjQxRolesEN.roleTypeId}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.qxPrjId) == false && GetStrLen(pobjQxRolesEN.qxPrjId) > 4) {
    throw new Error(
      `(errid:Watl000416)字段[项目Id(qxPrjId)]的长度不能超过4(In 角色(QxRoles))!值:${pobjQxRolesEN.qxPrjId}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.updDate) == false && GetStrLen(pobjQxRolesEN.updDate) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 角色(QxRoles))!值:${pobjQxRolesEN.updDate}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.updUserId) == false && GetStrLen(pobjQxRolesEN.updUserId) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[修改用户Id(updUserId)]的长度不能超过20(In 角色(QxRoles))!值:${pobjQxRolesEN.updUserId}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxRolesEN.memo) == false && GetStrLen(pobjQxRolesEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 角色(QxRoles))!值:${pobjQxRolesEN.memo}(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色Id(roleId)]的值:[${pobjQxRolesEN.roleId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色名称(roleName)]的值:[${pobjQxRolesEN.roleName}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleENName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色英文名(roleENName)]的值:[${pobjQxRolesEN.roleENName}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjQxRolesEN.roleIndex &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色序号(roleIndex)]的值:[${pobjQxRolesEN.roleIndex}], 非法,应该为数值型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.userType) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[用户类型(userType)]的值:[${pobjQxRolesEN.userType}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.userTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[用户类型Id(userTypeId)]的值:[${pobjQxRolesEN.userTypeId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.roleTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色类型Id(roleTypeId)]的值:[${pobjQxRolesEN.roleTypeId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.qxPrjId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[项目Id(qxPrjId)]的值:[${pobjQxRolesEN.qxPrjId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjQxRolesEN.isInUse &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否在使用(isInUse)]的值:[${pobjQxRolesEN.isInUse}], 非法,应该为布尔型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(updDate)]的值:[${pobjQxRolesEN.updDate}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.updUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改用户Id(updUserId)]的值:[${pobjQxRolesEN.updUserId}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxRolesEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjQxRolesEN.memo}], 非法,应该为字符型(In 角色(QxRoles))!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjQxRolesEN.roleId) === true || pobjQxRolesEN.roleId.toString() === '0') {
    throw new Error(
      `(errid:Watl000064)字段[角色Id]不能为空(In 角色)!(clsQxRolesBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
  if (
 ...
 * @returns 返回一个生成的对象列表
 */
export function QxRoles_GetObjLstByJSONObjLst(
  arrQxRolesObjLstS: Array<clsQxRolesEN>,
): Array<clsQxRolesEN> {
...
export function QxRoles_GetCombineCondition(objQxRolesCond: clsQxRolesEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_RoleId,
    ) == true
  ) {
    const strComparisonOpRoleId: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_RoleId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_RoleId,
      objQxRolesCond.roleId,
  ...
  if (
    ...
    const strComparisonOpRoleName: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_RoleName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_RoleName,
      objQxRolesCond.roleName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_RoleENName,
    ) == true
  ) {
    const strComparisonOpRoleENName: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_RoleENName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_RoleENName,
      objQxRolesCond.roleENName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_RoleIndex,
    ) == true
  ) {
    const strComparisonOpRoleIndex: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_RoleIndex];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsQxRolesEN.con_RoleIndex,
      objQxRolesCond.roleIndex,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_UserType,
    ) == true
  ) {
    const strComparisonOpUserType: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_UserType];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_UserType,
      objQxRolesCond.userType,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_UserTypeId,
    ) == true
  ) {
    const strComparisonOpUserTypeId: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_UserTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_UserTypeId,
      objQxRolesCond.userTypeId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_RoleTypeId,
    ) == true
  ) {
    const strComparisonOpRoleTypeId: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_RoleTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_RoleTypeId,
      objQxRolesCond.roleTypeId,
      strComparisonOpRoleTypeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_QxPrjId,
    ) == true
  ) {
    const strComparisonOpQxPrjId: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_QxPrjId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_QxPrjId,
      objQxRolesCond.qxPrjId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_UpdDate,
    ) == true
  ) {
    const strComparisonOpUpdDate: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_UpdDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_UpdDate,
      objQxRolesCond.updDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxRolesCond.dicFldComparisonOp,
      clsQxRolesEN.con_UpdUserId,
    ) == true
  ) {
    const strComparisonOpUpdUserId: string =
      objQxRolesCond.dicFldComparisonOp[clsQxRolesEN.con_UpdUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxRolesEN.con_UpdUserId,
      objQxRolesCond.updUserId,
