...
export class  clsQxRoleTypeEN extends clsGeneralTab
{
...
public static readonly _CurrTabName: string = "QxRoleType"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "RoleTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 4;
public static readonly _AttributeName = ["roleTypeId", "roleTypeName", "roleTypeEnName", "memo"];
//以下是属性变量
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxRoleType]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxRoleType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
 ...
 */
 public static readonly con_RoleTypeId = "roleTypeId";    //角色类型Id

 /**
 * 常量:"RoleTypeName"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_RoleTypeName = "roleTypeName";    //角色类型名

 /**
 * 常量:"RoleTypeEnName"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_RoleTypeEnName = "roleTypeEnName";    //角色类型英文名
...
//return propName in new clsQxRoleTypeEN();
const instance = new clsQxRoleTypeEN();
