...
export const CombineQxUserRoleRelationCondition = async (): Promise<string> => {
  ...
  try {
    ...
    if (idSchool_q.value != '' && idSchool_q.value != '0') {
      strWhereCond += Format(
        " And QxUserRoleRelation.{0} = '{1}'",
        clsQxUserRoleRelationEN.con_Id_School,
        idSchool_q.value,
      );
    }
  } catch (objException) {
    const strMsg: string = Format(
      '在组合查询条件(CombineQxUserRoleRelationCondition)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
...
export const CombineQxUserRoleRelationConditionObj = async (): Promise<ConditionCollection> => {
  ...
  let strWhereCond = ' 1 = 1 ';
  objQxUserRoleRelationCond.SetCondFldValue(
  ...
  try {
    ...
    const strMsg: string = Format(
      '在组合查询条件对象(CombineQxUserRoleRelationConditionObj)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
 ...
 * @returns 条件串(strWhereCond)
 **/
export const CombineQxUserRoleRelationConditionObj4ExportExcel =
  async (): Promise<ConditionCollection> => {
    ...
    try {
      ...
      const strMsg: string = Format(
        '在组合导出Excel条件对象(CombineQxUserRoleRelationConditionObj4ExportExcel)时出错!请联系管理员!{0}',
        objException,
      );
      throw strMsg;
    }
...
export const BindTabByList = async (
  ...
  if (refQxUserRoleRelation_List.value != null)
    refQxUserRoleRelation_List.value.selectAllChecked = false;
};
