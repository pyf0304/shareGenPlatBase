...
import {
  ...
  QxDepartmentInfo_GetObjLstAsync,
  QxDepartmentInfo_SortFunByKey,
  QxDepartmentInfo_FilterFunByKey,
 ...
 * @returns 对象列表
 */
export async function QxDepartmentInfoEx_GetObjExLstByPagerCache(
  ...
  try {
    ...
    for (const strKey of sstrKeys) {
      ...
      arrQxDepartmentInfo_Sel = arrQxDepartmentInfo_Sel.filter(
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrQxDepartmentInfo_Sel = arrQxDepartmentInfo_Sel.sort(
