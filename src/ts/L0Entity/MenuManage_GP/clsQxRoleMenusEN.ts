...
public static readonly _CurrTabName: string = "QxRoleMenus"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 10;
public static readonly _AttributeName = ["mId", "roleId", "qxPrjId", "cmPrjId", "menuSetId", "menuId", "isDisp", "updDate", "updUserId", "memo"];
//以下是属性变量
