 ...
 /**
 * 类名:clsBatchStateENEx
 * 表名:BatchState(01120979)
 * 版本:2025.01.04.1(服务器:WIN-SRV103-116)
 * 日期:2025/01/06 16:39:40
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsBatchStateENEx extends clsBatchStateEN
{
//以下是属性变量
...
//return propName in new clsBatchStateENEx();
const instance = new clsBatchStateENEx();
