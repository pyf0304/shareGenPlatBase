 ...
 * @returns 对象
 **/
export async function RsProfGrade_GetObjByIdProfGradeAsync(
  strIdProfGrade: string,
): Promise<clsRsProfGradeEN | null> {
  const strThisFuncName = 'GetObjByIdProfGradeAsync';

  if (IsNullOrEmpty(strIdProfGrade) == true) {
    const strMsg = Format(
      '参数:[strIdProfGrade]不能为空!(In clsRsProfGradeWApi.GetObjByIdProfGradeAsync)',
    );
  ...
  if (strIdProfGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdProfGrade]的长度:[{0}]不正确!(clsRsProfGradeWApi.GetObjByIdProfGradeAsync)',
      strIdProfGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function RsProfGrade_GetObjByIdProfGradelocalStorage(strIdProfGrade: string) {
  ...
  if (IsNullOrEmpty(strIdProfGrade) == true) {
    const strMsg = Format(
      '参数:[strIdProfGrade]不能为空!(In clsRsProfGradeWApi.GetObjByIdProfGradelocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdProfGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdProfGrade]的长度:[{0}]不正确!(clsRsProfGradeWApi.GetObjByIdProfGradelocalStorage)',
      strIdProfGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function RsProfGrade_GetObjByIdProfGradeCache(
  strIdProfGrade: string,
  ...
  if (IsNullOrEmpty(strIdProfGrade) == true) {
    const strMsg = Format(
      '参数:[strIdProfGrade]不能为空!(In clsRsProfGradeWApi.GetObjByIdProfGradeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdProfGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdProfGrade]的长度:[{0}]不正确!(clsRsProfGradeWApi.GetObjByIdProfGradeCache)',
      strIdProfGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrRsProfGradeSel = arrRsProfGradeObjLstCache.filter(
      (x) => x.idProfGrade == strIdProfGrade,
    );
...
export async function RsProfGrade_UpdateObjInLstCache(objRsProfGrade: clsRsProfGradeEN) {
  ...
  try {
    const arrRsProfGradeObjLstCache = await RsProfGrade_GetObjLstCache();
    const obj = arrRsProfGradeObjLstCache.find((x) => x.idProfGrade == objRsProfGrade.idProfGrade);
    if (obj != null) {
...
export function RsProfGrade_SortFunDefa2Fld(a: clsRsProfGradeEN, b: clsRsProfGradeEN): number {
  if (a.profenssionalGradeId == b.profenssionalGradeId)
...
export async function RsProfGrade_GetNameByIdProfGradeCache(strIdProfGrade: string) {
  if (IsNullOrEmpty(strIdProfGrade) == true) {
    const strMsg = Format(
      '参数:[strIdProfGrade]不能为空!(In clsRsProfGradeWApi.GetNameByIdProfGradeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdProfGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdProfGrade]的长度:[{0}]不正确!(clsRsProfGradeWApi.GetNameByIdProfGradeCache)',
      strIdProfGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function RsProfGrade_func(
  strInFldName: string,
  ...
  if (clsRsProfGradeEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsRsProfGradeEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function RsProfGrade_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrRsProfGradeSel = arrRsProfGradeSel.filter(
 ...
 **/
export async function RsProfGrade_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function RsProfGrade_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsRsProfGradeEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsProfGrade_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsRsProfGradeEN>> {
...
export async function RsProfGrade_GetSubObjLstCache(objRsProfGradeCond: clsRsProfGradeEN) {
  ...
  if (objRsProfGradeCond.sfFldComparisonOp == null || objRsProfGradeCond.sfFldComparisonOp == '')
    return arrRsProfGradeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsProfGradeCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objRsProfGradeCond),
      rsProfGrade_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function RsProfGrade_GetObjLstByIdProfGradeLstAsync(
  arrIdProfGrade: Array<string>,
): Promise<Array<clsRsProfGradeEN>> {
...
export async function RsProfGrade_GetObjLstByIdProfGradeLstCache(arrIdProfGradeLst: Array<string>) {
  ...
  try {
    const arrRsProfGradeObjLstCache = await RsProfGrade_GetObjLstCache();
    const arrRsProfGradeSel = arrRsProfGradeObjLstCache.filter(
      (x) => arrIdProfGradeLst.indexOf(x.idProfGrade) > -1,
    );
    return arrRsProfGradeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsProfGrade_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsProfGrade_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsProfGrade_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsProfGrade_DelRsProfGradesAsync(
  arrIdProfGrade: Array<string>,
): Promise<number> {
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsProfGrade_DelRsProfGradesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsProfGrade_AddNewRecordAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsProfGrade_AddNewRecordWithMaxIdAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<string> {
 ...
 **/
export async function RsProfGrade_AddNewObjSave(
  objRsProfGradeEN: clsRsProfGradeEN,
 ...
 **/
export async function RsProfGrade_UpdateObjSave(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function RsProfGrade_AddNewRecordWithReturnKeyAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsProfGrade_UpdateRecordAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objRsProfGradeEN.sfUpdFldSetStr === undefined ||
    objRsProfGradeEN.sfUpdFldSetStr === null ||
    objRsProfGradeEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsProfGrade_EditRecordExAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function RsProfGrade_UpdateWithConditionAsync(
  objRsProfGradeEN: clsRsProfGradeEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function RsProfGrade_IsExistRecordCache(objRsProfGradeCond: clsRsProfGradeEN) {
  ...
  let arrRsProfGradeSel = arrRsProfGradeObjLstCache;
  if (objRsProfGradeCond.sfFldComparisonOp == null || objRsProfGradeCond.sfFldComparisonOp == '')
    return arrRsProfGradeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsProfGradeCond.sfFldComparisonOp,
  );
  //console.log("clsRsProfGradeWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function RsProfGrade_BindDdl_IdProfGradeInDivCache(
...
export function RsProfGrade_CheckPropertyNew(pobjRsProfGradeEN: clsRsProfGradeEN) {
  ...
  if (IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[专业职称ID]不能为空(In 专业职称)!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[专业职称]不能为空(In 专业职称)!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.idProfGrade) == false &&
    GetStrLen(pobjRsProfGradeEN.idProfGrade) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[专业职称流水号(idProfGrade)]的长度不能超过4(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.idProfGrade}(clsRsProfGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeId) == false &&
    GetStrLen(pobjRsProfGradeEN.profenssionalGradeId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[专业职称ID(profenssionalGradeId)]的长度不能超过4(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.profenssionalGradeId}(clsRsProfGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeName) == false &&
    GetStrLen(pobjRsProfGradeEN.profenssionalGradeName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[专业职称(profenssionalGradeName)]的长度不能超过30(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.profenssionalGradeName}(clsRsProfGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyDate) == false &&
    GetStrLen(pobjRsProfGradeEN.modifyDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(modifyDate)]的长度不能超过20(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.modifyDate}(clsRsProfGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyUserId) == false &&
    GetStrLen(pobjRsProfGradeEN.modifyUserId) > 18
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(modifyUserId)]的长度不能超过18(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.modifyUserId}(clsRsProfGradeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.idProfGrade) == false &&
    undefined !== pobjRsProfGradeEN.idProfGrade &&
    tzDataType.isString(pobjRsProfGradeEN.idProfGrade) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业职称流水号(idProfGrade)]的值:[${pobjRsProfGradeEN.idProfGrade}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeId) == false &&
    undefined !== pobjRsProfGradeEN.profenssionalGradeId &&
    tzDataType.isString(pobjRsProfGradeEN.profenssionalGradeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业职称ID(profenssionalGradeId)]的值:[${pobjRsProfGradeEN.profenssionalGradeId}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeName) == false &&
    undefined !== pobjRsProfGradeEN.profenssionalGradeName &&
    tzDataType.isString(pobjRsProfGradeEN.profenssionalGradeName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业职称(profenssionalGradeName)]的值:[${pobjRsProfGradeEN.profenssionalGradeName}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyDate) == false &&
    undefined !== pobjRsProfGradeEN.modifyDate &&
    tzDataType.isString(pobjRsProfGradeEN.modifyDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(modifyDate)]的值:[${pobjRsProfGradeEN.modifyDate}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyUserId) == false &&
    undefined !== pobjRsProfGradeEN.modifyUserId &&
    tzDataType.isString(pobjRsProfGradeEN.modifyUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(modifyUserId)]的值:[${pobjRsProfGradeEN.modifyUserId}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckPropertyNew0)`,
    );
  }
...
export function RsProfGrade_CheckProperty4Update(pobjRsProfGradeEN: clsRsProfGradeEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[专业职称流水号(idProfGrade)]的长度不能超过4(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.idProfGrade}(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[专业职称ID(profenssionalGradeId)]的长度不能超过4(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.profenssionalGradeId}(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[专业职称(profenssionalGradeName)]的长度不能超过30(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.profenssionalGradeName}(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(modifyDate)]的长度不能超过20(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.modifyDate}(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(modifyUserId)]的长度不能超过18(In 专业职称(RsProfGrade))!值:${pobjRsProfGradeEN.modifyUserId}(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业职称流水号(idProfGrade)]的值:[${pobjRsProfGradeEN.idProfGrade}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业职称ID(profenssionalGradeId)]的值:[${pobjRsProfGradeEN.profenssionalGradeId}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.profenssionalGradeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业职称(profenssionalGradeName)]的值:[${pobjRsProfGradeEN.profenssionalGradeName}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(modifyDate)]的值:[${pobjRsProfGradeEN.modifyDate}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsProfGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(modifyUserId)]的值:[${pobjRsProfGradeEN.modifyUserId}], 非法,应该为字符型(In 专业职称(RsProfGrade))!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjRsProfGradeEN.idProfGrade) === true) {
    throw new Error(
      `(errid:Watl000064)字段[专业职称流水号]不能为空(In 专业职称)!(clsRsProfGradeBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function RsProfGrade_GetObjLstByJSONObjLst(
  arrRsProfGradeObjLstS: Array<clsRsProfGradeEN>,
): Array<clsRsProfGradeEN> {
...
export function RsProfGrade_GetCombineCondition(objRsProfGradeCond: clsRsProfGradeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsProfGradeCond.dicFldComparisonOp,
      clsRsProfGradeEN.con_IdProfGrade,
    ) == true
  ) {
    const strComparisonOpIdProfGrade: string =
      objRsProfGradeCond.dicFldComparisonOp[clsRsProfGradeEN.con_IdProfGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsProfGradeEN.con_IdProfGrade,
      objRsProfGradeCond.idProfGrade,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsProfGradeCond.dicFldComparisonOp,
      clsRsProfGradeEN.con_ProfenssionalGradeId,
    ) == true
  ) {
    const strComparisonOpProfenssionalGradeId: string =
      objRsProfGradeCond.dicFldComparisonOp[clsRsProfGradeEN.con_ProfenssionalGradeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsProfGradeEN.con_ProfenssionalGradeId,
      objRsProfGradeCond.profenssionalGradeId,
      strComparisonOpProfenssionalGradeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpProfenssionalGradeName: string =
      objRsProfGradeCond.dicFldComparisonOp[clsRsProfGradeEN.con_ProfenssionalGradeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsProfGradeEN.con_ProfenssionalGradeName,
      objRsProfGradeCond.profenssionalGradeName,
      strComparisonOpProfenssionalGradeName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objRsProfGradeCond.dicFldComparisonOp,
      clsRsProfGradeEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objRsProfGradeCond.dicFldComparisonOp[clsRsProfGradeEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsProfGradeEN.con_ModifyDate,
      objRsProfGradeCond.modifyDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsProfGradeCond.dicFldComparisonOp,
      clsRsProfGradeEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objRsProfGradeCond.dicFldComparisonOp[clsRsProfGradeEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsProfGradeEN.con_ModifyUserId,
      objRsProfGradeCond.modifyUserId,
 ...
 */
export function RsProfGrade_CopyObjTo(
  objRsProfGradeENS: clsRsProfGradeEN,
  objRsProfGradeENT: clsRsProfGradeEN,
): void {
 ...
 * @param objRsProfGradeENT:目标对象
 */
export function RsProfGrade_GetObjFromJsonObj(
  objRsProfGradeENS: clsRsProfGradeEN,
): clsRsProfGradeEN {
