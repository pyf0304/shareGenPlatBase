...
import {
  CombineQxUserRoleRelationCondition,
  QxPrjId_Local,
  QxUserRoleRelation_DeleteKeyIdCache,
  divVarSet,
  viewVarSet,
  dataColumn,
  BindTabByList,
...
import {
  QxUserRoleRelation_GetRecCountByCondAsync,
  QxUserRoleRelation_GetObjLstAsync,
  QxUserRoleRelation_DelRecordAsync,
  QxUserRoleRelation_GetObjBymIdAsync,
  QxUserRoleRelation_FuncMapByFldName,
  QxUserRoleRelation_GetObjLstBymIdLstAsync,
  QxUserRoleRelation_AddNewRecordAsync,
  QxUserRoleRelation_UpdateRecordAsync,
  QxUserRoleRelation_DelQxUserRoleRelationsAsync,
...
export abstract class QxUserRoleRelationCRUD implements clsOperateList {
  ...
  public async PageLoad() {
    ...
    try {
      ...
      if (viewVarSet.sortQxUserRoleRelationBy == '')
        viewVarSet.sortQxUserRoleRelationBy = `${clsQxUserRoleRelationEN.con_mId} Asc`;
   ...
   **/
  public CombineData(
    arrQxUserRoleRelationObjLst: Array<clsQxUserRoleRelationEN>,
    ...
    const strFileName = Format('用户角色关系({0})导出.xlsx', clsQxUserRoleRelationEN._CurrTabName);
  ...
  public CombineData4Func(
    arrQxUserRoleRelationExObjLst: Array<clsQxUserRoleRelationENEx>,
    arrDataColumn: Array<clsDataColumn>,
  ): ExportExcelData {
  ...
  public async ExportExcel_QxUserRoleRelation4Func(): Promise<ExportExcelData> {
    ...
    if (viewVarSet.sortQxUserRoleRelationBy == null) {
      const strMsg = Format(
        '在显示列表时,排序字段(sortQxUserRoleRelationBy)为空,请检查!(In BindGv_QxUserRoleRelationCache)',
      );
    ...
    try {
      ...
      arrQxUserRoleRelationExObjLst = arrQxUserRoleRelationObjLst.map(
        QxUserRoleRelationEx_CopyToEx,
      );
    } catch (e) {
   ...
   **/
  public async BindTab_QxUserRoleRelation(
   ...
   **/
  public async BindTab_QxUserRoleRelation4Func(
    divContainer: HTMLDivElement,
    arrQxUserRoleRelationExObjLst: Array<clsQxUserRoleRelationENEx>,
  ) {
  ...
  public async BindGv_QxUserRoleRelation4Func(divList: HTMLDivElement) {
    ...
    try {
      ...
      arrQxUserRoleRelationExObjLst =
        await QxUserRoleRelationEx_GetObjExLstByPagerAsync(objPagerPara);
    } catch (e) {
  ...
  public async SortBy(objAnchorElement: any) {
    ...
    const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(
      ...
      viewVarSet.sortQxUserRoleRelationBy,
      strSortExpress,
    );
    // 将 sortBy 按空格分成两部分
   ...
   **/
  public ShowQxUserRoleRelationObj(
    divContainer: HTMLDivElement,
