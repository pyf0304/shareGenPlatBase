 ...
 **/
export function vQx_UserTypeEx_CopyToEx(
  objvQx_UserTypeENS: clsvQx_UserTypeEN,
): clsvQx_UserTypeENEx {
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      vQx_UserTypeEx_ConstructorName,
      strThisFuncName,
    );
 ...
 */
export function vQx_UserTypeEx_FuncMapByFldName(
  strFldName: string,
  objvQx_UserTypeEx: clsvQx_UserTypeENEx,
) {
