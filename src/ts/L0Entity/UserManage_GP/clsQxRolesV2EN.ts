...
public static readonly _CurrTabName: string = "QxRolesV2"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "RId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 9;
public static readonly _AttributeName = ["rId", "roleName", "roleENName", "roleIndex", "qxPrjId", "isInUse", "updDate", "updUserId", "memo"];
//以下是属性变量
 ...
 */
 public static readonly con_RId = "rId";    //角色Id
