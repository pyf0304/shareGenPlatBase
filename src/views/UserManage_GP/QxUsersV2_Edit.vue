<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
          ...
          <tr id="trname">
            ...
            <td class="text-left">
              <select
                ...
                v-model.number="departmentIdInt"
    ...
    <template #footer>
      ...
      <el-button id="btnSubmitQxUsersV2" type="primary" @click="btnSubmit_Click">{{
        strSubmitButtonText
      }}</el-button>
    </template>
  </el-dialog>
              ...
              if (['02', '03', '06'].indexOf(clsQxUsersV2EN._PrimaryTypeId) > -1) {
                ...
                if (returnKeyId != 0) {
                  ...
                  if (objPage_Edit.value.iShowList != null)
                    objPage_Edit.value.iShowList.BindGvCache(clsQxUsersV2EN._CurrTabName, '');
                }
              } else {
