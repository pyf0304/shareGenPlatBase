...
public static _CurrTabName= "vQxRolesByPotenceNum"; //当前表名,与该类相关的表名
public static _KeyFldName= "RoleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 11;
public static AttributeName = ["roleId", "roleName", "roleENName", "roleIndex", "qxPrjId", "prjName", "isInUse", "updDate", "updUserId", "memo", "potenceNum"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static get con_PotenceNum(): string {return "potenceNum";}    //PotenceNum
