...
import {
  ...
  Resource_CheckPropertyNew,
  Resource_AddNewRecordWithMaxIdAsync,
  Resource_GetUniCondStr,
  Resource_IsExistRecordAsync,
  Resource_GetUniCondStr4Update,
  Resource_IsExistAsync,
  Resource_GetObjByIdResourceAsync,
  Resource_CheckProperty4Update,
  Resource_UpdateRecordAsync,
  Resource_EditRecordExAsync,
} from '@/ts/L3ForWApi/ResourceMan/clsResourceWApi';
import { clsResourceEN } from '@/ts/L0Entity/ResourceMan/clsResourceEN';
import {
  Resource_DeleteKeyIdCache,
  divVarSet,
  refResource_Edit,
...
export abstract class Resource_Edit {
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      ...
      if (['02', '03', '06'].indexOf(clsResourceEN._PrimaryTypeId) > -1) {
          ...
          if (['02', '03', '06'].indexOf(clsResourceEN._PrimaryTypeId) > -1) {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGv(clsResourceEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGv(clsResourceEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
