...
export class  clsQxPrjModuleEN extends clsGeneralTab
{
...
public static readonly _CurrTabName: string = "QxPrjModule"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "ModuleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 4;
public static readonly _AttributeName = ["moduleId", "moduleName", "qxPrjId", "memo"];
//以下是属性变量
...
if (value  != undefined)
{
 this.moduleName = value;
    this.hmProperty["moduleName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxPrjModule]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxPrjModule]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_ModuleName = "moduleName";    //模块名称
...
//return propName in new clsQxPrjModuleEN();
const instance = new clsQxPrjModuleEN();
