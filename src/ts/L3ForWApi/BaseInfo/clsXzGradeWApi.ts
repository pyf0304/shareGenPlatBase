 ...
 * @returns 对象
 **/
export async function XzGrade_GetObjByIdGradeAsync(
  strIdGrade: string,
): Promise<clsXzGradeEN | null> {
  ...
  if (strIdGrade.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strIdGrade]的长度:[{0}]不正确!(clsXzGradeWApi.GetObjByIdGradeAsync)',
      strIdGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function XzGrade_GetObjByIdGradelocalStorage(strIdGrade: string) {
  ...
  if (IsNullOrEmpty(strIdGrade) == true) {
    const strMsg = Format(
      '参数:[strIdGrade]不能为空!(In clsXzGradeWApi.GetObjByIdGradelocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdGrade.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strIdGrade]的长度:[{0}]不正确!(clsXzGradeWApi.GetObjByIdGradelocalStorage)',
      strIdGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function XzGrade_GetObjByIdGradeCache(strIdGrade: string, bolTryAsyncOnce = true) {
  ...
  if (strIdGrade.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strIdGrade]的长度:[{0}]不正确!(clsXzGradeWApi.GetObjByIdGradeCache)',
      strIdGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function XzGrade_UpdateObjInLstCache(objXzGrade: clsXzGradeEN) {
  ...
  try {
    const arrXzGradeObjLstCache = await XzGrade_GetObjLstCache();
    const obj = arrXzGradeObjLstCache.find((x) => x.idGrade == objXzGrade.idGrade);
    if (obj != null) {
...
export async function XzGrade_GetNameByIdGradeCache(strIdGrade: string) {
  ...
  if (strIdGrade.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strIdGrade]的长度:[{0}]不正确!(clsXzGradeWApi.GetNameByIdGradeCache)',
      strIdGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function XzGrade_func(
  strInFldName: string,
 ...
 * @returns 返回一个关键字值列表
 */
export async function XzGrade_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrXzGradeSel = arrXzGradeSel.filter(
 ...
 **/
export async function XzGrade_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
...
export async function XzGrade_GetSubObjLstCache(objXzGradeCond: clsXzGradeEN) {
  ...
  if (objXzGradeCond.sfFldComparisonOp == null || objXzGradeCond.sfFldComparisonOp == '')
    return arrXzGradeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objXzGradeCond.sfFldComparisonOp,
  );
 ...
 * @returns 对象列表
 **/
export async function XzGrade_GetObjLstByIdGradeLstAsync(
  arrIdGrade: Array<string>,
): Promise<Array<clsXzGradeEN>> {
...
export async function XzGrade_GetObjLstByIdGradeLstCache(arrIdGradeLst: Array<string>) {
  ...
  try {
    const arrXzGradeObjLstCache = await XzGrade_GetObjLstCache();
    const arrXzGradeSel = arrXzGradeObjLstCache.filter(
      (x) => arrIdGradeLst.indexOf(x.idGrade) > -1,
    );
    return arrXzGradeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function XzGrade_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function XzGrade_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function XzGrade_GetObjLstByPagerAsync(
 ...
 * @returns 获取相应的记录的对象
 **/
export async function XzGrade_AddNewRecordWithMaxIdAsync(
  objXzGradeEN: clsXzGradeEN,
): Promise<string> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function XzGrade_AddNewRecordWithReturnKeyAsync(
  objXzGradeEN: clsXzGradeEN,
): Promise<string> {
...
export async function XzGrade_UpdateRecordAsync(objXzGradeEN: clsXzGradeEN): Promise<boolean> {
  ...
  if (
    objXzGradeEN.sfUpdFldSetStr === undefined ||
    objXzGradeEN.sfUpdFldSetStr === null ||
    objXzGradeEN.sfUpdFldSetStr === ''
  ) {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function XzGrade_UpdateWithConditionAsync(
  objXzGradeEN: clsXzGradeEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function XzGrade_IsExistRecordCache(objXzGradeCond: clsXzGradeEN) {
  ...
  let arrXzGradeSel = arrXzGradeObjLstCache;
  if (objXzGradeCond.sfFldComparisonOp == null || objXzGradeCond.sfFldComparisonOp == '')
    return arrXzGradeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objXzGradeCond.sfFldComparisonOp,
  );
  //console.log("clsXzGradeWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function XzGrade_BindDdl_IdGradeInDivCache(
...
export function XzGrade_CheckPropertyNew(pobjXzGradeEN: clsXzGradeEN) {
  ...
  if (IsNullOrEmpty(pobjXzGradeEN.gradeName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[年级名称]不能为空(In 年级)!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeEN.idStudyLevel) === true) {
    throw new Error(
      `(errid:Watl000411)字段[学段流水号]不能为空(In 年级)!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (IsNullOrEmpty(pobjXzGradeEN.idGrade) == false && GetStrLen(pobjXzGradeEN.idGrade) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[年级流水号(idGrade)]的长度不能超过2(In 年级(XzGrade))!值:${pobjXzGradeEN.idGrade}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeEN.gradeName) == false && GetStrLen(pobjXzGradeEN.gradeName) > 50) {
    throw new Error(
      `(errid:Watl000413)字段[年级名称(gradeName)]的长度不能超过50(In 年级(XzGrade))!值:${pobjXzGradeEN.gradeName}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.idStudyLevel) == false &&
    GetStrLen(pobjXzGradeEN.idStudyLevel) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学段流水号(idStudyLevel)]的长度不能超过4(In 年级(XzGrade))!值:${pobjXzGradeEN.idStudyLevel}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeLeaderId) == false &&
    GetStrLen(pobjXzGradeEN.gradeLeaderId) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[年级组长Id(gradeLeaderId)]的长度不能超过8(In 年级(XzGrade))!值:${pobjXzGradeEN.gradeLeaderId}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyUserId) == false &&
    GetStrLen(pobjXzGradeEN.modifyUserId) > 18
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(modifyUserId)]的长度不能超过18(In 年级(XzGrade))!值:${pobjXzGradeEN.modifyUserId}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyDate) == false &&
    GetStrLen(pobjXzGradeEN.modifyDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(modifyDate)]的长度不能超过20(In 年级(XzGrade))!值:${pobjXzGradeEN.modifyDate}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeEN.memo) == false && GetStrLen(pobjXzGradeEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 年级(XzGrade))!值:${pobjXzGradeEN.memo}(clsXzGradeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjXzGradeEN.idGrade) == false &&
    undefined !== pobjXzGradeEN.idGrade &&
    tzDataType.isString(pobjXzGradeEN.idGrade) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级流水号(idGrade)]的值:[${pobjXzGradeEN.idGrade}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeName) == false &&
    undefined !== pobjXzGradeEN.gradeName &&
    tzDataType.isString(pobjXzGradeEN.gradeName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级名称(gradeName)]的值:[${pobjXzGradeEN.gradeName}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.idStudyLevel) == false &&
    undefined !== pobjXzGradeEN.idStudyLevel &&
    tzDataType.isString(pobjXzGradeEN.idStudyLevel) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学段流水号(idStudyLevel)]的值:[${pobjXzGradeEN.idStudyLevel}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeLeaderId) == false &&
    undefined !== pobjXzGradeEN.gradeLeaderId &&
    tzDataType.isString(pobjXzGradeEN.gradeLeaderId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级组长Id(gradeLeaderId)]的值:[${pobjXzGradeEN.gradeLeaderId}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjXzGradeEN.gradeIndex &&
    undefined !== pobjXzGradeEN.gradeIndex &&
    tzDataType.isNumber(pobjXzGradeEN.gradeIndex) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级序号(gradeIndex)]的值:[${pobjXzGradeEN.gradeIndex}], 非法,应该为数值型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyUserId) == false &&
    undefined !== pobjXzGradeEN.modifyUserId &&
    tzDataType.isString(pobjXzGradeEN.modifyUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(modifyUserId)]的值:[${pobjXzGradeEN.modifyUserId}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyDate) == false &&
    undefined !== pobjXzGradeEN.modifyDate &&
    tzDataType.isString(pobjXzGradeEN.modifyDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(modifyDate)]的值:[${pobjXzGradeEN.modifyDate}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.memo) == false &&
    undefined !== pobjXzGradeEN.memo &&
    tzDataType.isString(pobjXzGradeEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjXzGradeEN.memo}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckPropertyNew0)`,
    );
  }
...
export function XzGrade_CheckProperty4Update(pobjXzGradeEN: clsXzGradeEN) {
  ...
  if (IsNullOrEmpty(pobjXzGradeEN.idGrade) == false && GetStrLen(pobjXzGradeEN.idGrade) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[年级流水号(idGrade)]的长度不能超过2(In 年级(XzGrade))!值:${pobjXzGradeEN.idGrade}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeEN.gradeName) == false && GetStrLen(pobjXzGradeEN.gradeName) > 50) {
    throw new Error(
      `(errid:Watl000416)字段[年级名称(gradeName)]的长度不能超过50(In 年级(XzGrade))!值:${pobjXzGradeEN.gradeName}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.idStudyLevel) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[学段流水号(idStudyLevel)]的长度不能超过4(In 年级(XzGrade))!值:${pobjXzGradeEN.idStudyLevel}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeLeaderId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[年级组长Id(gradeLeaderId)]的长度不能超过8(In 年级(XzGrade))!值:${pobjXzGradeEN.gradeLeaderId}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(modifyUserId)]的长度不能超过18(In 年级(XzGrade))!值:${pobjXzGradeEN.modifyUserId}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(modifyDate)]的长度不能超过20(In 年级(XzGrade))!值:${pobjXzGradeEN.modifyDate}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeEN.memo) == false && GetStrLen(pobjXzGradeEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 年级(XzGrade))!值:${pobjXzGradeEN.memo}(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级流水号(idGrade)]的值:[${pobjXzGradeEN.idGrade}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级名称(gradeName)]的值:[${pobjXzGradeEN.gradeName}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.idStudyLevel) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学段流水号(idStudyLevel)]的值:[${pobjXzGradeEN.idStudyLevel}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.gradeLeaderId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级组长Id(gradeLeaderId)]的值:[${pobjXzGradeEN.gradeLeaderId}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjXzGradeEN.gradeIndex &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级序号(gradeIndex)]的值:[${pobjXzGradeEN.gradeIndex}], 非法,应该为数值型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(modifyUserId)]的值:[${pobjXzGradeEN.modifyUserId}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(modifyDate)]的值:[${pobjXzGradeEN.modifyDate}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzGradeEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjXzGradeEN.memo}], 非法,应该为字符型(In 年级(XzGrade))!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjXzGradeEN.idGrade) === true || pobjXzGradeEN.idGrade.toString() === '0') {
    throw new Error(
      `(errid:Watl000064)字段[年级流水号]不能为空(In 年级)!(clsXzGradeBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function XzGrade_GetObjLstByJSONObjLst(
  arrXzGradeObjLstS: Array<clsXzGradeEN>,
): Array<clsXzGradeEN> {
...
export function XzGrade_GetCombineCondition(objXzGradeCond: clsXzGradeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_IdGrade,
    ) == true
  ) {
    const strComparisonOpIdGrade: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_IdGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_IdGrade,
      objXzGradeCond.idGrade,
  ...
  if (
    ...
    const strComparisonOpGradeName: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_GradeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_GradeName,
      objXzGradeCond.gradeName,
      strComparisonOpGradeName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_IdStudyLevel,
    ) == true
  ) {
    const strComparisonOpIdStudyLevel: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_IdStudyLevel];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_IdStudyLevel,
      objXzGradeCond.idStudyLevel,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_GradeLeaderId,
    ) == true
  ) {
    const strComparisonOpGradeLeaderId: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_GradeLeaderId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_GradeLeaderId,
      objXzGradeCond.gradeLeaderId,
      strComparisonOpGradeLeaderId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_GradeIndex,
    ) == true
  ) {
    const strComparisonOpGradeIndex: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_GradeIndex];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsXzGradeEN.con_GradeIndex,
      objXzGradeCond.gradeIndex,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_ModifyUserId,
      objXzGradeCond.modifyUserId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzGradeCond.dicFldComparisonOp,
      clsXzGradeEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objXzGradeCond.dicFldComparisonOp[clsXzGradeEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzGradeEN.con_ModifyDate,
      objXzGradeCond.modifyDate,
