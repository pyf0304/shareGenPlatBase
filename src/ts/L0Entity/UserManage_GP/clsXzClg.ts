...
export class clsXzClg {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_ClgEnglishName(): string {
    return 'clgEnglishName';
  } //ClgEnglishName
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IdUni(): string {
    return 'idUni';
  } //id_Uni
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IsVisible4Tea(): string {
    return 'isVisible4Tea';
  } //IsVisible4Tea
