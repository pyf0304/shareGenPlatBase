...
export class clsvUsers {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_StuIdTeacherId(): string {
    return 'stuIdTeacherId';
  } //学工号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_MobilePhone(): string {
    return 'mobilePhone';
  } //手机
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_UserNameWithUserId(): string {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_AvatarsPicture(): string {
