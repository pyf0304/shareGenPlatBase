 ...
 * @returns 对象
 **/
export async function PlatDefaRole_GetObjBymIdAsync(
  lngmId: number,
): Promise<clsPlatDefaRoleEN | null> {
 ...
 **/
export async function PlatDefaRole_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
 ...
 * @returns 第一条记录对象
 **/
export async function PlatDefaRole_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsPlatDefaRoleEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function PlatDefaRole_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsPlatDefaRoleEN>> {
 ...
 * @returns 对象列表
 **/
export async function PlatDefaRole_GetObjLstBymIdLstAsync(
  arrmId: Array<string>,
): Promise<Array<clsPlatDefaRoleEN>> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function PlatDefaRole_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function PlatDefaRole_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function PlatDefaRole_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function PlatDefaRole_DelPlatDefaRolesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function PlatDefaRole_AddNewRecordAsync(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
 ...
 **/
export async function PlatDefaRole_AddNewObjSave(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
 ...
 **/
export async function PlatDefaRole_CheckUniCond4Add(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
 ...
 **/
export async function PlatDefaRole_CheckUniCond4Update(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
 ...
 **/
export async function PlatDefaRole_UpdateObjSave(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function PlatDefaRole_AddNewRecordWithReturnKeyAsync(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function PlatDefaRole_UpdateRecordAsync(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objPlatDefaRoleEN.sfUpdFldSetStr === undefined ||
    objPlatDefaRoleEN.sfUpdFldSetStr === null ||
    objPlatDefaRoleEN.sfUpdFldSetStr === ''
  ) {
 ...
 * @returns 获取修改是否成功？
 **/
export async function PlatDefaRole_EditRecordExAsync(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function PlatDefaRole_UpdateWithConditionAsync(
  objPlatDefaRoleEN: clsPlatDefaRoleEN,
  strWhereCond: string,
): Promise<boolean> {
...
export function PlatDefaRole_CheckPropertyNew(pobjPlatDefaRoleEN: clsPlatDefaRoleEN) {
  ...
  if (IsNullOrEmpty(pobjPlatDefaRoleEN.personType) === true) {
    throw new Error(
      `(errid:Watl000411)字段[人员类别]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjPlatDefaRoleEN.prjId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[PrjId]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.roleId) === true ||
    pobjPlatDefaRoleEN.roleId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000411)字段[角色Id]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.id_School) == false &&
    GetStrLen(pobjPlatDefaRoleEN.id_School) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.id_School}(clsPlatDefaRoleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.personType) == false &&
    GetStrLen(pobjPlatDefaRoleEN.personType) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[人员类别(personType)]的长度不能超过30(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.personType}(clsPlatDefaRoleBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjPlatDefaRoleEN.prjId) == false && GetStrLen(pobjPlatDefaRoleEN.prjId) > 4) {
    throw new Error(
      `(errid:Watl000413)字段[PrjId(prjId)]的长度不能超过4(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.prjId}(clsPlatDefaRoleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.roleId) == false &&
    GetStrLen(pobjPlatDefaRoleEN.roleId) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[角色Id(roleId)]的长度不能超过8(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.roleId}(clsPlatDefaRoleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.memo) == false &&
    GetStrLen(pobjPlatDefaRoleEN.memo) > 1000
  ) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.memo}(clsPlatDefaRoleBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    null != pobjPlatDefaRoleEN.mId &&
    undefined !== pobjPlatDefaRoleEN.mId &&
    tzDataType.isNumber(pobjPlatDefaRoleEN.mId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[mId(mId)]的值:[${pobjPlatDefaRoleEN.mId}], 非法,应该为数值型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.id_School) == false &&
    undefined !== pobjPlatDefaRoleEN.id_School &&
    tzDataType.isString(pobjPlatDefaRoleEN.id_School) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjPlatDefaRoleEN.id_School}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.personType) == false &&
    undefined !== pobjPlatDefaRoleEN.personType &&
    tzDataType.isString(pobjPlatDefaRoleEN.personType) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[人员类别(personType)]的值:[${pobjPlatDefaRoleEN.personType}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.prjId) == false &&
    undefined !== pobjPlatDefaRoleEN.prjId &&
    tzDataType.isString(pobjPlatDefaRoleEN.prjId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[PrjId(prjId)]的值:[${pobjPlatDefaRoleEN.prjId}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.roleId) == false &&
    undefined !== pobjPlatDefaRoleEN.roleId &&
    tzDataType.isString(pobjPlatDefaRoleEN.roleId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[角色Id(roleId)]的值:[${pobjPlatDefaRoleEN.roleId}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.memo) == false &&
    undefined !== pobjPlatDefaRoleEN.memo &&
    tzDataType.isString(pobjPlatDefaRoleEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjPlatDefaRoleEN.memo}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckPropertyNew0)`,
    );
  }
...
export function PlatDefaRole_CheckProperty4Update(pobjPlatDefaRoleEN: clsPlatDefaRoleEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.id_School}(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.personType) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[人员类别(personType)]的长度不能超过30(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.personType}(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjPlatDefaRoleEN.prjId) == false && GetStrLen(pobjPlatDefaRoleEN.prjId) > 4) {
    throw new Error(
      `(errid:Watl000416)字段[PrjId(prjId)]的长度不能超过4(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.prjId}(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.roleId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[角色Id(roleId)]的长度不能超过8(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.roleId}(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 平台默认角色(PlatDefaRole))!值:${pobjPlatDefaRoleEN.memo}(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[mId(mId)]的值:[${pobjPlatDefaRoleEN.mId}], 非法,应该为数值型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.id_School) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjPlatDefaRoleEN.id_School}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.personType) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[人员类别(personType)]的值:[${pobjPlatDefaRoleEN.personType}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.prjId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[PrjId(prjId)]的值:[${pobjPlatDefaRoleEN.prjId}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.roleId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[角色Id(roleId)]的值:[${pobjPlatDefaRoleEN.roleId}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjPlatDefaRoleEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjPlatDefaRoleEN.memo}], 非法,应该为字符型(In 平台默认角色(PlatDefaRole))!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    ...
    throw new Error(
      `(errid:Watl000064)字段[mId]不能为空(In 平台默认角色)!(clsPlatDefaRoleBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function PlatDefaRole_GetObjLstByJSONObjLst(
  arrPlatDefaRoleObjLstS: Array<clsPlatDefaRoleEN>,
): Array<clsPlatDefaRoleEN> {
...
export function PlatDefaRole_GetCombineCondition(objPlatDefaRoleCond: clsPlatDefaRoleEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_mId,
    ) == true
  ) {
    const strComparisonOpmId: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_mId];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsPlatDefaRoleEN.con_mId,
      objPlatDefaRoleCond.mId,
      strComparisonOpmId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_IdSchool,
    ) == true
  ) {
    const strComparisonOpIdSchool: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_IdSchool];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsPlatDefaRoleEN.con_IdSchool,
      objPlatDefaRoleCond.id_School,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_PersonType,
    ) == true
  ) {
    const strComparisonOpPersonType: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_PersonType];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsPlatDefaRoleEN.con_PersonType,
      objPlatDefaRoleCond.personType,
      strComparisonOpPersonType,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_PrjId,
    ) == true
  ) {
    const strComparisonOpPrjId: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_PrjId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsPlatDefaRoleEN.con_PrjId,
      objPlatDefaRoleCond.prjId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_RoleId,
    ) == true
  ) {
    const strComparisonOpRoleId: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_RoleId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsPlatDefaRoleEN.con_RoleId,
      objPlatDefaRoleCond.roleId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objPlatDefaRoleCond.dicFldComparisonOp,
      clsPlatDefaRoleEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objPlatDefaRoleCond.dicFldComparisonOp[clsPlatDefaRoleEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsPlatDefaRoleEN.con_Memo,
      objPlatDefaRoleCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
...
export function PlatDefaRole_GetUniCondStr(objPlatDefaRoleEN: clsPlatDefaRoleEN): string {
  let strWhereCond = ' 1 = 1 ';
  strWhereCond += Format(" and IdSchool = '{0}'", objPlatDefaRoleEN.id_School);
 ...
 */
export function PlatDefaRole_CopyObjTo(
  objPlatDefaRoleENS: clsPlatDefaRoleEN,
  objPlatDefaRoleENT: clsPlatDefaRoleEN,
): void {
 ...
 * @param objPlatDefaRoleENT:目标对象
 */
export function PlatDefaRole_GetObjFromJsonObj(
  objPlatDefaRoleENS: clsPlatDefaRoleEN,
): clsPlatDefaRoleEN {
