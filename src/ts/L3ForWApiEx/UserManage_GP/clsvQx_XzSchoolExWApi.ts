 ...
 **/
export function vQx_XzSchoolEx_CopyToEx(
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      vQx_XzSchoolEx_ConstructorName,
      strThisFuncName,
    );
 ...
 */
export function vQx_XzSchoolEx_FuncMapByFldName(
  strFldName: string,
  objvQx_XzSchoolEx: clsvQx_XzSchoolENEx,
) {
