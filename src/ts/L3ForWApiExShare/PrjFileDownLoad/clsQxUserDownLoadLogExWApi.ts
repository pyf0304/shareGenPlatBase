 ...
 **/
export function QxUserDownLoadLogEx_CopyToEx(
  objQxUserDownLoadLogENS: clsQxUserDownLoadLogEN,
): clsQxUserDownLoadLogENEx {
 ...
 */
export function QxUserDownLoadLogEx_FuncMapByFldName(
  strFldName: string,
  objQxUserDownLoadLogEx: clsQxUserDownLoadLogENEx,
) {
  ...
  let strMsg = '';
  //如果是本表中字段,不需要映射
  const arrFldName = clsQxUserDownLoadLogEN._AttributeName;
