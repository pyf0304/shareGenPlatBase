 ...
 * @returns 对象
 **/
export async function BatchState_GetObjByBatchStateIdAsync(
  strBatchStateId: string,
): Promise<clsBatchStateEN | null> {
  const strThisFuncName = 'GetObjByBatchStateIdAsync';

  if (IsNullOrEmpty(strBatchStateId) == true) {
    const strMsg = Format(
      '参数:[strBatchStateId]不能为空!(In clsBatchStateWApi.GetObjByBatchStateIdAsync)',
    );
  ...
  if (strBatchStateId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strBatchStateId]的长度:[{0}]不正确!(clsBatchStateWApi.GetObjByBatchStateIdAsync)',
      strBatchStateId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function BatchState_GetObjByBatchStateIdlocalStorage(strBatchStateId: string) {
  ...
  if (IsNullOrEmpty(strBatchStateId) == true) {
    const strMsg = Format(
      '参数:[strBatchStateId]不能为空!(In clsBatchStateWApi.GetObjByBatchStateIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strBatchStateId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strBatchStateId]的长度:[{0}]不正确!(clsBatchStateWApi.GetObjByBatchStateIdlocalStorage)',
      strBatchStateId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function BatchState_GetObjByBatchStateIdCache(
  strBatchStateId: string,
  ...
  if (IsNullOrEmpty(strBatchStateId) == true) {
    const strMsg = Format(
      '参数:[strBatchStateId]不能为空!(In clsBatchStateWApi.GetObjByBatchStateIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strBatchStateId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strBatchStateId]的长度:[{0}]不正确!(clsBatchStateWApi.GetObjByBatchStateIdCache)',
      strBatchStateId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrBatchStateSel = arrBatchStateObjLstCache.filter(
      (x) => x.batchStateId == strBatchStateId,
    );
...
export async function BatchState_UpdateObjInLstCache(objBatchState: clsBatchStateEN) {
  ...
  try {
    const arrBatchStateObjLstCache = await BatchState_GetObjLstCache();
    const obj = arrBatchStateObjLstCache.find((x) => x.batchStateId == objBatchState.batchStateId);
    if (obj != null) {
...
export function BatchState_SortFunDefa2Fld(a: clsBatchStateEN, b: clsBatchStateEN): number {
  if (a.batchStateName == b.batchStateName)
...
export async function BatchState_GetNameByBatchStateIdCache(strBatchStateId: string) {
  if (IsNullOrEmpty(strBatchStateId) == true) {
    const strMsg = Format(
      '参数:[strBatchStateId]不能为空!(In clsBatchStateWApi.GetNameByBatchStateIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strBatchStateId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strBatchStateId]的长度:[{0}]不正确!(clsBatchStateWApi.GetNameByBatchStateIdCache)',
      strBatchStateId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function BatchState_func(
  strInFldName: string,
  ...
  if (clsBatchStateEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsBatchStateEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function BatchState_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrBatchStateSel = arrBatchStateSel.filter(
 ...
 **/
export async function BatchState_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function BatchState_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsBatchStateEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function BatchState_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsBatchStateEN>> {
...
export async function BatchState_GetSubObjLstCache(objBatchStateCond: clsBatchStateEN) {
  ...
  if (objBatchStateCond.sfFldComparisonOp == null || objBatchStateCond.sfFldComparisonOp == '')
    return arrBatchStateSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objBatchStateCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objBatchStateCond),
      batchState_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function BatchState_GetObjLstByBatchStateIdLstAsync(
  arrBatchStateId: Array<string>,
): Promise<Array<clsBatchStateEN>> {
 ...
 * @returns 对象列表
 */
export async function BatchState_GetObjLstByBatchStateIdLstCache(
  arrBatchStateIdLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstByBatchStateIdLstCache';
  try {
    const arrBatchStateObjLstCache = await BatchState_GetObjLstCache();
    const arrBatchStateSel = arrBatchStateObjLstCache.filter(
      (x) => arrBatchStateIdLst.indexOf(x.batchStateId) > -1,
    );
    return arrBatchStateSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function BatchState_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function BatchState_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function BatchState_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function BatchState_DelBatchStatesAsync(
  arrBatchStateId: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function BatchState_AddNewRecordAsync(
  objBatchStateEN: clsBatchStateEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function BatchState_AddNewRecordWithMaxIdAsync(
  objBatchStateEN: clsBatchStateEN,
): Promise<string> {
 ...
 **/
export async function BatchState_AddNewObjSave(
  objBatchStateEN: clsBatchStateEN,
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function BatchState_AddNewRecordWithReturnKeyAsync(
  objBatchStateEN: clsBatchStateEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function BatchState_UpdateRecordAsync(
  objBatchStateEN: clsBatchStateEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objBatchStateEN.sfUpdFldSetStr === undefined ||
    objBatchStateEN.sfUpdFldSetStr === null ||
    objBatchStateEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
      '对象(关键字: {0})的【修改字段集】为空,不能修改!',
      objBatchStateEN.batchStateId,
    );
    throw strMsg;
  }
  const strUrl = GetWebApiUrl(batchState_Controller, strAction);
 ...
 * @returns 获取修改是否成功？
 **/
export async function BatchState_EditRecordExAsync(
  objBatchStateEN: clsBatchStateEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function BatchState_UpdateWithConditionAsync(
  objBatchStateEN: clsBatchStateEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function BatchState_IsExistRecordCache(objBatchStateCond: clsBatchStateEN) {
  ...
  let arrBatchStateSel = arrBatchStateObjLstCache;
  if (objBatchStateCond.sfFldComparisonOp == null || objBatchStateCond.sfFldComparisonOp == '')
    return arrBatchStateSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objBatchStateCond.sfFldComparisonOp,
  );
  //console.log("clsBatchStateWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
export function BatchState_CheckPropertyNew(pobjBatchStateEN: clsBatchStateEN) {
  ...
  if (IsNullOrEmpty(pobjBatchStateEN.batchStateName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[批次状态名]不能为空(In 批次状态)!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjBatchStateEN.batchStateEnName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[批次状态英文名]不能为空(In 批次状态)!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateId) == false &&
    GetStrLen(pobjBatchStateEN.batchStateId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[批次状态Id(batchStateId)]的长度不能超过2(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateId}(clsBatchStateBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateName) == false &&
    GetStrLen(pobjBatchStateEN.batchStateName) > 50
  ) {
    throw new Error(
      `(errid:Watl000413)字段[批次状态名(batchStateName)]的长度不能超过50(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateName}(clsBatchStateBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateEnName) == false &&
    GetStrLen(pobjBatchStateEN.batchStateEnName) > 50
  ) {
    throw new Error(
      `(errid:Watl000413)字段[批次状态英文名(batchStateEnName)]的长度不能超过50(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateEnName}(clsBatchStateBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjBatchStateEN.memo) == false && GetStrLen(pobjBatchStateEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 批次状态(BatchState))!值:${pobjBatchStateEN.memo}(clsBatchStateBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateId) == false &&
    undefined !== pobjBatchStateEN.batchStateId &&
    tzDataType.isString(pobjBatchStateEN.batchStateId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[批次状态Id(batchStateId)]的值:[${pobjBatchStateEN.batchStateId}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateName) == false &&
    undefined !== pobjBatchStateEN.batchStateName &&
    tzDataType.isString(pobjBatchStateEN.batchStateName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[批次状态名(batchStateName)]的值:[${pobjBatchStateEN.batchStateName}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateEnName) == false &&
    undefined !== pobjBatchStateEN.batchStateEnName &&
    tzDataType.isString(pobjBatchStateEN.batchStateEnName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[批次状态英文名(batchStateEnName)]的值:[${pobjBatchStateEN.batchStateEnName}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.memo) == false &&
    undefined !== pobjBatchStateEN.memo &&
    tzDataType.isString(pobjBatchStateEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjBatchStateEN.memo}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckPropertyNew0)`,
    );
  }
...
export function BatchState_CheckProperty4Update(pobjBatchStateEN: clsBatchStateEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[批次状态Id(batchStateId)]的长度不能超过2(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateId}(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[批次状态名(batchStateName)]的长度不能超过50(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateName}(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateEnName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[批次状态英文名(batchStateEnName)]的长度不能超过50(In 批次状态(BatchState))!值:${pobjBatchStateEN.batchStateEnName}(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjBatchStateEN.memo) == false && GetStrLen(pobjBatchStateEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 批次状态(BatchState))!值:${pobjBatchStateEN.memo}(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[批次状态Id(batchStateId)]的值:[${pobjBatchStateEN.batchStateId}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[批次状态名(batchStateName)]的值:[${pobjBatchStateEN.batchStateName}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateEnName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[批次状态英文名(batchStateEnName)]的值:[${pobjBatchStateEN.batchStateEnName}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjBatchStateEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjBatchStateEN.memo}], 非法,应该为字符型(In 批次状态(BatchState))!(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    IsNullOrEmpty(pobjBatchStateEN.batchStateId) === true ||
    pobjBatchStateEN.batchStateId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000064)字段[批次状态Id]不能为空(In 批次状态)!(clsBatchStateBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function BatchState_GetObjLstByJSONObjLst(
  arrBatchStateObjLstS: Array<clsBatchStateEN>,
): Array<clsBatchStateEN> {
...
export function BatchState_GetCombineCondition(objBatchStateCond: clsBatchStateEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objBatchStateCond.dicFldComparisonOp,
      clsBatchStateEN.con_BatchStateId,
    ) == true
  ) {
    const strComparisonOpBatchStateId: string =
      objBatchStateCond.dicFldComparisonOp[clsBatchStateEN.con_BatchStateId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsBatchStateEN.con_BatchStateId,
      objBatchStateCond.batchStateId,
      strComparisonOpBatchStateId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objBatchStateCond.dicFldComparisonOp,
      clsBatchStateEN.con_BatchStateName,
    ) == true
  ) {
    const strComparisonOpBatchStateName: string =
      objBatchStateCond.dicFldComparisonOp[clsBatchStateEN.con_BatchStateName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsBatchStateEN.con_BatchStateName,
      objBatchStateCond.batchStateName,
      strComparisonOpBatchStateName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objBatchStateCond.dicFldComparisonOp,
      clsBatchStateEN.con_BatchStateEnName,
    ) == true
  ) {
    const strComparisonOpBatchStateEnName: string =
      objBatchStateCond.dicFldComparisonOp[clsBatchStateEN.con_BatchStateEnName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsBatchStateEN.con_BatchStateEnName,
      objBatchStateCond.batchStateEnName,
      strComparisonOpBatchStateEnName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objBatchStateCond.dicFldComparisonOp,
      clsBatchStateEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objBatchStateCond.dicFldComparisonOp[clsBatchStateEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsBatchStateEN.con_Memo,
      objBatchStateCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function BatchState_CopyObjTo(
  objBatchStateENS: clsBatchStateEN,
  objBatchStateENT: clsBatchStateEN,
): void {
