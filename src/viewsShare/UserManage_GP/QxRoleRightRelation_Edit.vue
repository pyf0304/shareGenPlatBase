<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
    ...
    <template #footer>
      ...
      <el-button id="btnSubmitQxRoleRightRelation" type="primary" @click="btnSubmit_Click">{{
        strSubmitButtonText
      }}</el-button>
    </template>
  </el-dialog>
...
<script lang="ts">
  ...
  import { QxRoleRightRelation_Edit } from '@/viewsBase/UserManage_GP/QxRoleRightRelation_Edit';
  ...
  export default defineComponent({
    ...
    setup() {
       ...
       **/
      async function GetEditDataQxRoleRightRelationObj() {
        const pobjQxRoleRightRelationEN = new clsQxRoleRightRelationEN();
        pobjQxRoleRightRelationEN.SetMyRoleId(myRoleId.value); // 主角色Id
        pobjQxRoleRightRelationEN.SetRoleId(roleId.value); // 角色Id
        pobjQxRoleRightRelationEN.SetQxPrjId(qxPrjId.value); // 项目Id
        pobjQxRoleRightRelationEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1)); // 修改日期
        pobjQxRoleRightRelationEN.SetUpdUser(userStore.getUserId); // 修改用户
        pobjQxRoleRightRelationEN.SetMemo(memo.value); // 备注
       ...
       **/
      async function ShowDataFromQxRoleRightRelationObj(
        pobjQxRoleRightRelationEN: clsQxRoleRightRelationEN,
      ) {
        myRoleId.value = pobjQxRoleRightRelationEN.myRoleId; // 主角色Id
        roleId.value = pobjQxRoleRightRelationEN.roleId; // 角色Id
        qxPrjId.value = pobjQxRoleRightRelationEN.qxPrjId; // 项目Id
        memo.value = pobjQxRoleRightRelationEN.memo; // 备注
      }
      ...
      const showDialog = async (pobjPage_Edit: QxRoleRightRelation_EditEx) => {
      ...
      return {
        ...
        strSubmitButtonText,
        strCancelButtonText,
        GetEditDataQxRoleRightRelationObj,
        ShowDataFromQxRoleRightRelationObj,
        Clear,
        btnSubmit_Click,
        myRoleId,
        roleId,
