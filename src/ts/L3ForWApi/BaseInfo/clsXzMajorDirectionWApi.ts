 ...
 **/
export async function XzMajorDirection_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 **/
export async function XzMajorDirection_AddNewObjSave(
  objXzMajorDirectionEN: clsXzMajorDirectionEN,
 ...
 **/
export async function XzMajorDirection_CheckUniCond4Add(
  objXzMajorDirectionEN: clsXzMajorDirectionEN,
): Promise<boolean> {
 ...
 **/
export async function XzMajorDirection_CheckUniCond4Update(
  objXzMajorDirectionEN: clsXzMajorDirectionEN,
): Promise<boolean> {
 ...
 **/
export async function XzMajorDirection_UpdateObjSave(
  objXzMajorDirectionEN: clsXzMajorDirectionEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function XzMajorDirection_EditRecordExAsync(
  objXzMajorDirectionEN: clsXzMajorDirectionEN,
): Promise<boolean> {
...
export function XzMajorDirection_ReFreshThisCache(strIdXzMajor: string): void {
  if (IsNullOrEmpty(strIdXzMajor) == true) {
    const strMsg = Format(
      '参数:[strIdXzMajor]不能为空!(In clsXzMajorDirectionWApi.XzMajorDirection_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdXzMajor.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdXzMajor]的长度:[{0}]不正确!(clsXzMajorDirectionWApi.XzMajorDirection_ReFreshThisCache)',
      strIdXzMajor.length,
    );
    console.error(strMsg);
    throw strMsg;
