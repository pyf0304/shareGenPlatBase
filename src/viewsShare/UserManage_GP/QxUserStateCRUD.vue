<template>
  <div id="divLayout" ref="refDivLayout" class="div_layout">
    ...
    <div id="divList" ref="refDivList" class="div_List">
      <QxUserState_ListCom
        ref="refQxUserState_List"
        :items="dataListQxUserState"
    ...
    <!--编辑层-->
    <QxUserState_EditCom ref="refQxUserState_Edit"></QxUserState_EditCom>
    <!--详细信息层-->
...
<script lang="ts">
  ...
  import QxUserState_EditCom from '@/viewsShare/UserManage_GP/QxUserState_Edit.vue';
  import QxUserState_DetailCom from '@/viewsShare/UserManage_GP/QxUserState_Detail.vue';
  import QxUserState_ListCom from '@/viewsShare/UserManage_GP/QxUserState_List.vue';
  ...
  export default defineComponent({
    ...
    setup() {
      const objPage = ref<QxUserStateCRUDEx>();
      const objPage_Edit = ref<QxUserState_EditEx>();
      const objPage_Detail = ref<QxUserState_DetailEx>();
      const opType = ref('');
      const thisConstructorName = 'QxUserStateCRUD';
      ...
      const btnQuery_Click = async () => {
        ...
        await objPage.value.BindGv_QxUserStateCache(refDivList.value);
      };
      ...
      const btnCreate_Click = async () => {
        ...
        objPage_Edit.value = new QxUserState_EditEx('QxUserState_EditEx', objPage.value);
        ...
        try {
          opType.value = 'Add';
          const bolIsSuccess = await objPage_Edit.value.ShowDialog_QxUserState(opType.value);
          if (bolIsSuccess == false) return;
          if (['02', '03', '06'].indexOf(clsQxUserStateEN._PrimaryTypeId) > -1) {
      ...
      const btnUpdate_Click = async () => {
        ...
        const strUserStateId = GetFirstCheckedKeyIdInDivObj(divVarSet.refDivList);
        ...
        try {
          ...
          const bolIsSuccess = await objPage_Edit.value.ShowDialog_QxUserState(opType.value);
          if (bolIsSuccess == false) return;
          const update = await objPage_Edit.value.UpdateRecord(strUserStateId);
          if (update == false) {
      ...
      const btnDelete_Click = async () => {
        ...
        try {
          ...
          await objPage.value.BindGv_QxUserStateCache(divVarSet.refDivList);
        } catch (e) {
      ...
      const btnExportExcel_Click = async () => {
        ...
        await objPage.value.ExportExcel_QxUserStateCache();
      };
      ...
      onMounted(() => {
        ...
        QxUserStateCRUDEx.vuebtn_Click = btn_Click;
        QxUserStateCRUDEx.GetPropValue = GetPropValue;
        objPage.value = new QxUserStateCRUDEx();
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        QxUserStateCRUDEx.btn_Click(strCommandName, strKeyId);
      }
      return {
        showErrorMessage,
        dataListQxUserState,
    ...
    methods: {
      ...
      async EditTabRelaInfo(data: any) {
        ...
        router.push({ name: 'editQxUserState', params: { courseId: data.courseId } });
      },
