 ...
 **/
export function vQxRolesByUserNumEx_CopyToEx(
  objvQxRolesByUserNumENS: clsvQxRolesByUserNumEN,
): clsvQxRolesByUserNumENEx {
 ...
 */
export function vQxRolesByUserNumEx_FuncMapByFldName(
  strFldName: string,
  objvQxRolesByUserNumEx: clsvQxRolesByUserNumENEx,
) {
  ...
  let strMsg = '';
  //如果是本表中字段,不需要映射
  const arrFldName = clsvQxRolesByUserNumEN._AttributeName;
