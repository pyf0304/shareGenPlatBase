...
public static readonly _CurrTabName: string = "PageDispMode"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "PageDispModeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 4;
public static readonly _AttributeName = ["pageDispModeId", "pageDispModeName", "pageDispModeENName", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_PageDispModeENName = "pageDispModeENName";    //页面显示模式英文名
