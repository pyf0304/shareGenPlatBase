 ...
 **/
export async function OperationType_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 **/
export async function OperationType_AddNewObjSave(
  objOperationTypeEN: clsOperationTypeEN,
 ...
 **/
export async function OperationType_CheckUniCond4Add(
  objOperationTypeEN: clsOperationTypeEN,
): Promise<boolean> {
 ...
 **/
export async function OperationType_CheckUniCond4Update(
  objOperationTypeEN: clsOperationTypeEN,
): Promise<boolean> {
 ...
 **/
export async function OperationType_UpdateObjSave(
  objOperationTypeEN: clsOperationTypeEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function OperationType_EditRecordExAsync(
  objOperationTypeEN: clsOperationTypeEN,
): Promise<boolean> {
