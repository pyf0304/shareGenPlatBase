 ...
 /**
 * 类名:QxUserState_Detail(界面:QxUserStateCRUD,00140035)
 * 表名:QxUserState(00140016)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/13 16:02:54
 * 生成者:
 工程名称:统一平台(0014)
...
import { divVarSet,refQxUserState_Detail } from "@/viewsShare/UserManage_GP/QxUserStateVueShare";
...
if (refQxUserState_Detail.value == null)
{
const strMsg = Format('当前详细信息区的DetailObj为空，请检查！(in {0}.{1}).\nrefQxUserState_Detail imported from: @/views/UserManage_GP/QxUserStateVueShare',
this.constructor.name,
strThisFuncName,
);
console.error(strMsg);
...
await refQxUserState_Detail.value.ShowDataFromQxUserStateObj(objQxUserStateEN);
...
refQxUserState_Detail.value.strCancelButtonText = value;
}
}