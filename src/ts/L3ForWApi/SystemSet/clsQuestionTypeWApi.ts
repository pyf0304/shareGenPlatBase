 ...
 * @returns 对象
 **/
export async function QuestionType_GetObjByQuestionTypeIdAsync(
  strQuestionTypeId: string,
): Promise<clsQuestionTypeEN | null> {
  const strThisFuncName = 'GetObjByQuestionTypeIdAsync';

  if (IsNullOrEmpty(strQuestionTypeId) == true) {
    const strMsg = Format(
      '参数:[strQuestionTypeId]不能为空!(In clsQuestionTypeWApi.GetObjByQuestionTypeIdAsync)',
    );
  ...
  if (strQuestionTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strQuestionTypeId]的长度:[{0}]不正确!(clsQuestionTypeWApi.GetObjByQuestionTypeIdAsync)',
      strQuestionTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function QuestionType_GetObjByQuestionTypeIdlocalStorage(strQuestionTypeId: string) {
  ...
  if (IsNullOrEmpty(strQuestionTypeId) == true) {
    const strMsg = Format(
      '参数:[strQuestionTypeId]不能为空!(In clsQuestionTypeWApi.GetObjByQuestionTypeIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQuestionTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strQuestionTypeId]的长度:[{0}]不正确!(clsQuestionTypeWApi.GetObjByQuestionTypeIdlocalStorage)',
      strQuestionTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function QuestionType_GetObjByQuestionTypeIdCache(
  strQuestionTypeId: string,
  ...
  if (IsNullOrEmpty(strQuestionTypeId) == true) {
    const strMsg = Format(
      '参数:[strQuestionTypeId]不能为空!(In clsQuestionTypeWApi.GetObjByQuestionTypeIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQuestionTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strQuestionTypeId]的长度:[{0}]不正确!(clsQuestionTypeWApi.GetObjByQuestionTypeIdCache)',
      strQuestionTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrQuestionTypeSel = arrQuestionTypeObjLstCache.filter(
      (x) => x.questionTypeId == strQuestionTypeId,
    );
    ...
    if (arrQuestionTypeSel.length > 0) {
      ...
      if (bolTryAsyncOnce == true) {
        const objQuestionTypeConst =
          await QuestionType_GetObjByQuestionTypeIdAsync(strQuestionTypeId);
...
export async function QuestionType_UpdateObjInLstCache(objQuestionType: clsQuestionTypeEN) {
  ...
  try {
    const arrQuestionTypeObjLstCache = await QuestionType_GetObjLstCache();
    const obj = arrQuestionTypeObjLstCache.find(
      (x) => x.questionTypeName == objQuestionType.questionTypeName,
    );
    if (obj != null) {
...
export async function QuestionType_GetNameByQuestionTypeIdCache(strQuestionTypeId: string) {
  if (IsNullOrEmpty(strQuestionTypeId) == true) {
    const strMsg = Format(
      '参数:[strQuestionTypeId]不能为空!(In clsQuestionTypeWApi.GetNameByQuestionTypeIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQuestionTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strQuestionTypeId]的长度:[{0}]不正确!(clsQuestionTypeWApi.GetNameByQuestionTypeIdCache)',
      strQuestionTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function QuestionType_func(
  strInFldName: string,
  ...
  if (clsQuestionTypeEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsQuestionTypeEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function QuestionType_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrQuestionTypeSel = arrQuestionTypeSel.filter(
 ...
 **/
export async function QuestionType_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function QuestionType_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsQuestionTypeEN | null> {
...
export async function QuestionType_GetObjLstClientCache() {
  ...
  try {
    ...
    const strInfo = Format(
      ...
      strKey,
      arrQuestionTypeExObjLst.length,
    );
    console.log(strInfo);
 ...
 * @returns 获取的相应对象列表
 **/
export async function QuestionType_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsQuestionTypeEN>> {
...
export async function QuestionType_GetSubObjLstCache(objQuestionTypeCond: clsQuestionTypeEN) {
  ...
  if (objQuestionTypeCond.sfFldComparisonOp == null || objQuestionTypeCond.sfFldComparisonOp == '')
    return arrQuestionTypeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objQuestionTypeCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objQuestionTypeCond),
      questionType_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function QuestionType_GetObjLstByQuestionTypeIdLstAsync(
  arrQuestionTypeId: Array<string>,
): Promise<Array<clsQuestionTypeEN>> {
 ...
 * @returns 对象列表
 */
export async function QuestionType_GetObjLstByQuestionTypeIdLstCache(
  arrQuestionTypeIdLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstByQuestionTypeIdLstCache';
  try {
    const arrQuestionTypeObjLstCache = await QuestionType_GetObjLstCache();
    const arrQuestionTypeSel = arrQuestionTypeObjLstCache.filter(
      (x) => arrQuestionTypeIdLst.indexOf(x.questionTypeId) > -1,
    );
    return arrQuestionTypeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function QuestionType_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QuestionType_GetObjLstByRangeAsync(
  ...
  try {
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrQuestionTypeSel = arrQuestionTypeSel.sort(
        QuestionType_SortFunByKey(strSortFld, strSortType),
      );
    } else {
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QuestionType_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function QuestionType_DelQuestionTypesAsync(
  arrQuestionTypeId: Array<string>,
): Promise<number> {
 ...
 * @returns 实际删除记录的个数
 **/
export async function QuestionType_DelQuestionTypesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function QuestionType_AddNewRecordAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function QuestionType_AddNewRecordWithMaxIdAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<string> {
 ...
 **/
export async function QuestionType_AddNewObjSave(
  objQuestionTypeEN: clsQuestionTypeEN,
 ...
 **/
export async function QuestionType_CheckUniCond4Add(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
 ...
 **/
export async function QuestionType_CheckUniCond4Update(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
 ...
 **/
export async function QuestionType_UpdateObjSave(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function QuestionType_AddNewRecordWithReturnKeyAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function QuestionType_UpdateRecordAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objQuestionTypeEN.sfUpdFldSetStr === undefined ||
    objQuestionTypeEN.sfUpdFldSetStr === null ||
    objQuestionTypeEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function QuestionType_EditRecordExAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function QuestionType_UpdateWithConditionAsync(
  objQuestionTypeEN: clsQuestionTypeEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function QuestionType_IsExistRecordCache(objQuestionTypeCond: clsQuestionTypeEN) {
  ...
  let arrQuestionTypeSel = arrQuestionTypeObjLstCache;
  if (objQuestionTypeCond.sfFldComparisonOp == null || objQuestionTypeCond.sfFldComparisonOp == '')
    return arrQuestionTypeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objQuestionTypeCond.sfFldComparisonOp,
  );
  //console.log("clsQuestionTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @param bolIsUse:
*/
export async function QuestionType_BindDdl_QuestionTypeIdInDivCache(
...
export function QuestionType_CheckPropertyNew(pobjQuestionTypeEN: clsQuestionTypeEN) {
  ...
  if (IsNullOrEmpty(pobjQuestionTypeEN.questionTypeName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[题目类型名]不能为空(In 题目类型)!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjQuestionTypeEN.updUser) === true) {
    throw new Error(
      `(errid:Watl000411)字段[修改人]不能为空(In 题目类型)!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeId) == false &&
    GetStrLen(pobjQuestionTypeEN.questionTypeId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[题目类型Id(questionTypeId)]的长度不能超过2(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeId}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeName) == false &&
    GetStrLen(pobjQuestionTypeEN.questionTypeName) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[题目类型名(questionTypeName)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeName}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeENName) == false &&
    GetStrLen(pobjQuestionTypeEN.questionTypeENName) > 50
  ) {
    throw new Error(
      `(errid:Watl000413)字段[题目类型英文名(questionTypeENName)]的长度不能超过50(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeENName}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerModeId) == false &&
    GetStrLen(pobjQuestionTypeEN.defaAnswerModeId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[默认答案模式Id(defaAnswerModeId)]的长度不能超过4(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.defaAnswerModeId}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerTypeId) == false &&
    GetStrLen(pobjQuestionTypeEN.defaAnswerTypeId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[默认答案类型Id(defaAnswerTypeId)]的长度不能超过2(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.defaAnswerTypeId}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updDate) == false &&
    GetStrLen(pobjQuestionTypeEN.updDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.updDate}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updUser) == false &&
    GetStrLen(pobjQuestionTypeEN.updUser) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(updUser)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.updUser}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.memo) == false &&
    GetStrLen(pobjQuestionTypeEN.memo) > 1000
  ) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.memo}(clsQuestionTypeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeId) == false &&
    undefined !== pobjQuestionTypeEN.questionTypeId &&
    tzDataType.isString(pobjQuestionTypeEN.questionTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[题目类型Id(questionTypeId)]的值:[${pobjQuestionTypeEN.questionTypeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeName) == false &&
    undefined !== pobjQuestionTypeEN.questionTypeName &&
    tzDataType.isString(pobjQuestionTypeEN.questionTypeName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[题目类型名(questionTypeName)]的值:[${pobjQuestionTypeEN.questionTypeName}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeENName) == false &&
    undefined !== pobjQuestionTypeEN.questionTypeENName &&
    tzDataType.isString(pobjQuestionTypeEN.questionTypeENName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[题目类型英文名(questionTypeENName)]的值:[${pobjQuestionTypeEN.questionTypeENName}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerModeId) == false &&
    undefined !== pobjQuestionTypeEN.defaAnswerModeId &&
    tzDataType.isString(pobjQuestionTypeEN.defaAnswerModeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[默认答案模式Id(defaAnswerModeId)]的值:[${pobjQuestionTypeEN.defaAnswerModeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerTypeId) == false &&
    undefined !== pobjQuestionTypeEN.defaAnswerTypeId &&
    tzDataType.isString(pobjQuestionTypeEN.defaAnswerTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[默认答案类型Id(defaAnswerTypeId)]的值:[${pobjQuestionTypeEN.defaAnswerTypeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.orderNum &&
    undefined !== pobjQuestionTypeEN.orderNum &&
    tzDataType.isNumber(pobjQuestionTypeEN.orderNum) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[序号(orderNum)]的值:[${pobjQuestionTypeEN.orderNum}], 非法,应该为数值型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.isUse &&
    undefined !== pobjQuestionTypeEN.isUse &&
    tzDataType.isBoolean(pobjQuestionTypeEN.isUse) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[是否使用(isUse)]的值:[${pobjQuestionTypeEN.isUse}], 非法,应该为布尔型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.isExercise &&
    undefined !== pobjQuestionTypeEN.isExercise &&
    tzDataType.isBoolean(pobjQuestionTypeEN.isExercise) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[是否练习题(isExercise)]的值:[${pobjQuestionTypeEN.isExercise}], 非法,应该为布尔型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updDate) == false &&
    undefined !== pobjQuestionTypeEN.updDate &&
    tzDataType.isString(pobjQuestionTypeEN.updDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjQuestionTypeEN.updDate}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updUser) == false &&
    undefined !== pobjQuestionTypeEN.updUser &&
    tzDataType.isString(pobjQuestionTypeEN.updUser) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(updUser)]的值:[${pobjQuestionTypeEN.updUser}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.memo) == false &&
    undefined !== pobjQuestionTypeEN.memo &&
    tzDataType.isString(pobjQuestionTypeEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjQuestionTypeEN.memo}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckPropertyNew0)`,
    );
  }
...
export function QuestionType_CheckProperty4Update(pobjQuestionTypeEN: clsQuestionTypeEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[题目类型Id(questionTypeId)]的长度不能超过2(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeId}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[题目类型名(questionTypeName)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeName}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeENName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[题目类型英文名(questionTypeENName)]的长度不能超过50(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.questionTypeENName}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerModeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[默认答案模式Id(defaAnswerModeId)]的长度不能超过4(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.defaAnswerModeId}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[默认答案类型Id(defaAnswerTypeId)]的长度不能超过2(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.defaAnswerTypeId}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.updDate}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(updUser)]的长度不能超过20(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.updUser}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 题目类型(QuestionType))!值:${pobjQuestionTypeEN.memo}(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[题目类型Id(questionTypeId)]的值:[${pobjQuestionTypeEN.questionTypeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[题目类型名(questionTypeName)]的值:[${pobjQuestionTypeEN.questionTypeName}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.questionTypeENName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[题目类型英文名(questionTypeENName)]的值:[${pobjQuestionTypeEN.questionTypeENName}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerModeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[默认答案模式Id(defaAnswerModeId)]的值:[${pobjQuestionTypeEN.defaAnswerModeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.defaAnswerTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[默认答案类型Id(defaAnswerTypeId)]的值:[${pobjQuestionTypeEN.defaAnswerTypeId}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.orderNum &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[序号(orderNum)]的值:[${pobjQuestionTypeEN.orderNum}], 非法,应该为数值型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.isUse &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否使用(isUse)]的值:[${pobjQuestionTypeEN.isUse}], 非法,应该为布尔型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjQuestionTypeEN.isExercise &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否练习题(isExercise)]的值:[${pobjQuestionTypeEN.isExercise}], 非法,应该为布尔型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(updDate)]的值:[${pobjQuestionTypeEN.updDate}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.updUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(updUser)]的值:[${pobjQuestionTypeEN.updUser}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQuestionTypeEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjQuestionTypeEN.memo}], 非法,应该为字符型(In 题目类型(QuestionType))!(clsQuestionTypeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
 ...
 * @returns 返回一个生成的对象列表
 */
export function QuestionType_GetObjLstByJSONObjLst(
  arrQuestionTypeObjLstS: Array<clsQuestionTypeEN>,
): Array<clsQuestionTypeEN> {
...
export function QuestionType_GetCombineCondition(objQuestionTypeCond: clsQuestionTypeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_QuestionTypeId,
    ) == true
  ) {
    const strComparisonOpQuestionTypeId: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_QuestionTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_QuestionTypeId,
      objQuestionTypeCond.questionTypeId,
      strComparisonOpQuestionTypeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpQuestionTypeName: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_QuestionTypeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_QuestionTypeName,
      objQuestionTypeCond.questionTypeName,
      strComparisonOpQuestionTypeName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_QuestionTypeENName,
    ) == true
  ) {
    const strComparisonOpQuestionTypeENName: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_QuestionTypeENName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_QuestionTypeENName,
      objQuestionTypeCond.questionTypeENName,
      strComparisonOpQuestionTypeENName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_DefaAnswerModeId,
    ) == true
  ) {
    const strComparisonOpDefaAnswerModeId: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_DefaAnswerModeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_DefaAnswerModeId,
      objQuestionTypeCond.defaAnswerModeId,
      strComparisonOpDefaAnswerModeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_DefaAnswerTypeId,
    ) == true
  ) {
    const strComparisonOpDefaAnswerTypeId: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_DefaAnswerTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_DefaAnswerTypeId,
      objQuestionTypeCond.defaAnswerTypeId,
      strComparisonOpDefaAnswerTypeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_OrderNum,
    ) == true
  ) {
    const strComparisonOpOrderNum: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_OrderNum];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsQuestionTypeEN.con_OrderNum,
      objQuestionTypeCond.orderNum,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_IsExercise,
    ) == true
  ) {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_UpdDate,
    ) == true
  ) {
    const strComparisonOpUpdDate: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_UpdDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_UpdDate,
      objQuestionTypeCond.updDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_UpdUser,
    ) == true
  ) {
    const strComparisonOpUpdUser: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_UpdUser];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_UpdUser,
      objQuestionTypeCond.updUser,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQuestionTypeCond.dicFldComparisonOp,
      clsQuestionTypeEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objQuestionTypeCond.dicFldComparisonOp[clsQuestionTypeEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQuestionTypeEN.con_Memo,
      objQuestionTypeCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function QuestionType_CopyObjTo(
  objQuestionTypeENS: clsQuestionTypeEN,
  objQuestionTypeENT: clsQuestionTypeEN,
): void {
 ...
 * @param objQuestionTypeENT:目标对象
 */
export function QuestionType_GetObjFromJsonObj(
  objQuestionTypeENS: clsQuestionTypeEN,
): clsQuestionTypeEN {
