 ...
 * @returns 对象
 **/
export async function RsAdminGrade_GetObjByIdAdminGradeAsync(
  strIdAdminGrade: string,
): Promise<clsRsAdminGradeEN | null> {
  const strThisFuncName = 'GetObjByIdAdminGradeAsync';

  if (IsNullOrEmpty(strIdAdminGrade) == true) {
    const strMsg = Format(
      '参数:[strIdAdminGrade]不能为空!(In clsRsAdminGradeWApi.GetObjByIdAdminGradeAsync)',
    );
  ...
  if (strIdAdminGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdAdminGrade]的长度:[{0}]不正确!(clsRsAdminGradeWApi.GetObjByIdAdminGradeAsync)',
      strIdAdminGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function RsAdminGrade_GetObjByIdAdminGradelocalStorage(strIdAdminGrade: string) {
  ...
  if (IsNullOrEmpty(strIdAdminGrade) == true) {
    const strMsg = Format(
      '参数:[strIdAdminGrade]不能为空!(In clsRsAdminGradeWApi.GetObjByIdAdminGradelocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdAdminGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdAdminGrade]的长度:[{0}]不正确!(clsRsAdminGradeWApi.GetObjByIdAdminGradelocalStorage)',
      strIdAdminGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function RsAdminGrade_GetObjByIdAdminGradeCache(
  strIdAdminGrade: string,
  ...
  if (IsNullOrEmpty(strIdAdminGrade) == true) {
    const strMsg = Format(
      '参数:[strIdAdminGrade]不能为空!(In clsRsAdminGradeWApi.GetObjByIdAdminGradeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdAdminGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdAdminGrade]的长度:[{0}]不正确!(clsRsAdminGradeWApi.GetObjByIdAdminGradeCache)',
      strIdAdminGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrRsAdminGradeSel = arrRsAdminGradeObjLstCache.filter(
      (x) => x.idAdminGrade == strIdAdminGrade,
    );
...
export async function RsAdminGrade_UpdateObjInLstCache(objRsAdminGrade: clsRsAdminGradeEN) {
  ...
  try {
    const arrRsAdminGradeObjLstCache = await RsAdminGrade_GetObjLstCache();
    const obj = arrRsAdminGradeObjLstCache.find(
      (x) => x.idAdminGrade == objRsAdminGrade.idAdminGrade,
    );
    if (obj != null) {
...
export async function RsAdminGrade_GetNameByIdAdminGradeCache(strIdAdminGrade: string) {
  if (IsNullOrEmpty(strIdAdminGrade) == true) {
    const strMsg = Format(
      '参数:[strIdAdminGrade]不能为空!(In clsRsAdminGradeWApi.GetNameByIdAdminGradeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdAdminGrade.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdAdminGrade]的长度:[{0}]不正确!(clsRsAdminGradeWApi.GetNameByIdAdminGradeCache)',
      strIdAdminGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function RsAdminGrade_func(
  strInFldName: string,
 ...
 * @returns 返回一个关键字值列表
 */
export async function RsAdminGrade_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrRsAdminGradeSel = arrRsAdminGradeSel.filter(
 ...
 **/
export async function RsAdminGrade_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function RsAdminGrade_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsRsAdminGradeEN | null> {
...
export async function RsAdminGrade_GetObjLstClientCache() {
  ...
  try {
    ...
    const strInfo = Format(
      ...
      strKey,
      arrRsAdminGradeExObjLst.length,
    );
    console.log(strInfo);
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsAdminGrade_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsRsAdminGradeEN>> {
...
export async function RsAdminGrade_GetSubObjLstCache(objRsAdminGradeCond: clsRsAdminGradeEN) {
  ...
  if (objRsAdminGradeCond.sfFldComparisonOp == null || objRsAdminGradeCond.sfFldComparisonOp == '')
    return arrRsAdminGradeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsAdminGradeCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objRsAdminGradeCond),
      rsAdminGrade_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function RsAdminGrade_GetObjLstByIdAdminGradeLstAsync(
  arrIdAdminGrade: Array<string>,
): Promise<Array<clsRsAdminGradeEN>> {
 ...
 * @returns 对象列表
 */
export async function RsAdminGrade_GetObjLstByIdAdminGradeLstCache(
  arrIdAdminGradeLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstByIdAdminGradeLstCache';
  try {
    const arrRsAdminGradeObjLstCache = await RsAdminGrade_GetObjLstCache();
    const arrRsAdminGradeSel = arrRsAdminGradeObjLstCache.filter(
      (x) => arrIdAdminGradeLst.indexOf(x.idAdminGrade) > -1,
    );
    return arrRsAdminGradeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsAdminGrade_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsAdminGrade_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsAdminGrade_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsAdminGrade_DelRsAdminGradesAsync(
  arrIdAdminGrade: Array<string>,
): Promise<number> {
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsAdminGrade_DelRsAdminGradesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsAdminGrade_AddNewRecordAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsAdminGrade_AddNewRecordWithMaxIdAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<string> {
 ...
 **/
export async function RsAdminGrade_AddNewObjSave(
  objRsAdminGradeEN: clsRsAdminGradeEN,
 ...
 **/
export async function RsAdminGrade_UpdateObjSave(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function RsAdminGrade_AddNewRecordWithReturnKeyAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsAdminGrade_UpdateRecordAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objRsAdminGradeEN.sfUpdFldSetStr === undefined ||
    objRsAdminGradeEN.sfUpdFldSetStr === null ||
    objRsAdminGradeEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsAdminGrade_EditRecordExAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function RsAdminGrade_UpdateWithConditionAsync(
  objRsAdminGradeEN: clsRsAdminGradeEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function RsAdminGrade_IsExistRecordCache(objRsAdminGradeCond: clsRsAdminGradeEN) {
  ...
  let arrRsAdminGradeSel = arrRsAdminGradeObjLstCache;
  if (objRsAdminGradeCond.sfFldComparisonOp == null || objRsAdminGradeCond.sfFldComparisonOp == '')
    return arrRsAdminGradeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsAdminGradeCond.sfFldComparisonOp,
  );
  //console.log("clsRsAdminGradeWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function RsAdminGrade_BindDdl_IdAdminGradeInDivCache(
...
export function RsAdminGrade_CheckPropertyNew(pobjRsAdminGradeEN: clsRsAdminGradeEN) {
  ...
  if (IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[行政职务代号]不能为空(In 职务)!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeDesc) === true) {
    throw new Error(
      `(errid:Watl000411)字段[行政职务描述]不能为空(In 职务)!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.idAdminGrade) == false &&
    GetStrLen(pobjRsAdminGradeEN.idAdminGrade) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[行政职务流水号(idAdminGrade)]的长度不能超过4(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.idAdminGrade}(clsRsAdminGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeId) == false &&
    GetStrLen(pobjRsAdminGradeEN.adminGradeId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[行政职务代号(adminGradeId)]的长度不能超过4(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.adminGradeId}(clsRsAdminGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeDesc) == false &&
    GetStrLen(pobjRsAdminGradeEN.adminGradeDesc) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[行政职务描述(adminGradeDesc)]的长度不能超过30(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.adminGradeDesc}(clsRsAdminGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyDate) == false &&
    GetStrLen(pobjRsAdminGradeEN.modifyDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(modifyDate)]的长度不能超过20(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.modifyDate}(clsRsAdminGradeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyUserId) == false &&
    GetStrLen(pobjRsAdminGradeEN.modifyUserId) > 18
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(modifyUserId)]的长度不能超过18(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.modifyUserId}(clsRsAdminGradeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.idAdminGrade) == false &&
    undefined !== pobjRsAdminGradeEN.idAdminGrade &&
    tzDataType.isString(pobjRsAdminGradeEN.idAdminGrade) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[行政职务流水号(idAdminGrade)]的值:[${pobjRsAdminGradeEN.idAdminGrade}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeId) == false &&
    undefined !== pobjRsAdminGradeEN.adminGradeId &&
    tzDataType.isString(pobjRsAdminGradeEN.adminGradeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[行政职务代号(adminGradeId)]的值:[${pobjRsAdminGradeEN.adminGradeId}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeDesc) == false &&
    undefined !== pobjRsAdminGradeEN.adminGradeDesc &&
    tzDataType.isString(pobjRsAdminGradeEN.adminGradeDesc) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[行政职务描述(adminGradeDesc)]的值:[${pobjRsAdminGradeEN.adminGradeDesc}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyDate) == false &&
    undefined !== pobjRsAdminGradeEN.modifyDate &&
    tzDataType.isString(pobjRsAdminGradeEN.modifyDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(modifyDate)]的值:[${pobjRsAdminGradeEN.modifyDate}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyUserId) == false &&
    undefined !== pobjRsAdminGradeEN.modifyUserId &&
    tzDataType.isString(pobjRsAdminGradeEN.modifyUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(modifyUserId)]的值:[${pobjRsAdminGradeEN.modifyUserId}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckPropertyNew0)`,
    );
  }
...
export function RsAdminGrade_CheckProperty4Update(pobjRsAdminGradeEN: clsRsAdminGradeEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[行政职务流水号(idAdminGrade)]的长度不能超过4(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.idAdminGrade}(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[行政职务代号(adminGradeId)]的长度不能超过4(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.adminGradeId}(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeDesc) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[行政职务描述(adminGradeDesc)]的长度不能超过30(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.adminGradeDesc}(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(modifyDate)]的长度不能超过20(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.modifyDate}(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(modifyUserId)]的长度不能超过18(In 职务(RsAdminGrade))!值:${pobjRsAdminGradeEN.modifyUserId}(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[行政职务流水号(idAdminGrade)]的值:[${pobjRsAdminGradeEN.idAdminGrade}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[行政职务代号(adminGradeId)]的值:[${pobjRsAdminGradeEN.adminGradeId}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.adminGradeDesc) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[行政职务描述(adminGradeDesc)]的值:[${pobjRsAdminGradeEN.adminGradeDesc}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(modifyDate)]的值:[${pobjRsAdminGradeEN.modifyDate}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsAdminGradeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(modifyUserId)]的值:[${pobjRsAdminGradeEN.modifyUserId}], 非法,应该为字符型(In 职务(RsAdminGrade))!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjRsAdminGradeEN.idAdminGrade) === true) {
    throw new Error(
      `(errid:Watl000064)字段[行政职务流水号]不能为空(In 职务)!(clsRsAdminGradeBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function RsAdminGrade_GetObjLstByJSONObjLst(
  arrRsAdminGradeObjLstS: Array<clsRsAdminGradeEN>,
): Array<clsRsAdminGradeEN> {
...
export function RsAdminGrade_GetCombineCondition(objRsAdminGradeCond: clsRsAdminGradeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsAdminGradeCond.dicFldComparisonOp,
      clsRsAdminGradeEN.con_IdAdminGrade,
    ) == true
  ) {
    const strComparisonOpIdAdminGrade: string =
      objRsAdminGradeCond.dicFldComparisonOp[clsRsAdminGradeEN.con_IdAdminGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsAdminGradeEN.con_IdAdminGrade,
      objRsAdminGradeCond.idAdminGrade,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsAdminGradeCond.dicFldComparisonOp,
      clsRsAdminGradeEN.con_AdminGradeId,
    ) == true
  ) {
    const strComparisonOpAdminGradeId: string =
      objRsAdminGradeCond.dicFldComparisonOp[clsRsAdminGradeEN.con_AdminGradeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsAdminGradeEN.con_AdminGradeId,
      objRsAdminGradeCond.adminGradeId,
      strComparisonOpAdminGradeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpAdminGradeDesc: string =
      objRsAdminGradeCond.dicFldComparisonOp[clsRsAdminGradeEN.con_AdminGradeDesc];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsAdminGradeEN.con_AdminGradeDesc,
      objRsAdminGradeCond.adminGradeDesc,
      strComparisonOpAdminGradeDesc,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objRsAdminGradeCond.dicFldComparisonOp,
      clsRsAdminGradeEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objRsAdminGradeCond.dicFldComparisonOp[clsRsAdminGradeEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsAdminGradeEN.con_ModifyDate,
      objRsAdminGradeCond.modifyDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsAdminGradeCond.dicFldComparisonOp,
      clsRsAdminGradeEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objRsAdminGradeCond.dicFldComparisonOp[clsRsAdminGradeEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsAdminGradeEN.con_ModifyUserId,
      objRsAdminGradeCond.modifyUserId,
 ...
 */
export function RsAdminGrade_CopyObjTo(
  objRsAdminGradeENS: clsRsAdminGradeEN,
  objRsAdminGradeENT: clsRsAdminGradeEN,
): void {
 ...
 * @param objRsAdminGradeENT:目标对象
 */
export function RsAdminGrade_GetObjFromJsonObj(
  objRsAdminGradeENS: clsRsAdminGradeEN,
): clsRsAdminGradeEN {
