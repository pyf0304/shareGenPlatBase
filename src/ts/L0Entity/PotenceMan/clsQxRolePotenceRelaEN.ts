...
public static readonly _CurrTabName: string = "QxRolePotenceRela"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "RoleId,PotenceId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 6;
public static readonly _AttributeName = ["roleId", "potenceId", "qxPrjId", "updDate", "updUser", "memo"];
//以下是属性变量
