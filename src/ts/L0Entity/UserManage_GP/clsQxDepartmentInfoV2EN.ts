...
public static AttributeName = ["departmentIdInt", "departmentName", "departmentAbbrName", "departmentTypeId", "parentDepId", "orderNum", "inUse", "memo", "createTime", "updateTime"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static get con_parentDepId(): string {return "parentDepId";}    //所属部门号
