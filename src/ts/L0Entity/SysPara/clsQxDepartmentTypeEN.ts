...
public static readonly _CurrTabName: string = "QxDepartmentType"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "DepartmentTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 3;
public static readonly _AttributeName = ["departmentTypeId", "departmentTypeName", "memo"];
//以下是属性变量
