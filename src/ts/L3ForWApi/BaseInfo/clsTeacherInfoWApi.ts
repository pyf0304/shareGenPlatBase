 ...
 **/
export  async function TeacherInfo_GetFldValueAsync(strFldName: string, strWhereCond: string): Promise<Array<string>>  
{
 ...
 **/
export  async function TeacherInfo_AddNewObjSave(objTeacherInfoEN: clsTeacherInfoEN): Promise<AddRecordResult>{
 ...
 **/
export  async function TeacherInfo_CheckUniCond4Add(objTeacherInfoEN: clsTeacherInfoEN): Promise<boolean>{
 ...
 **/
export  async function TeacherInfo_CheckUniCond4Update(objTeacherInfoEN: clsTeacherInfoEN): Promise<boolean>{
 ...
 **/
export  async function TeacherInfo_UpdateObjSave(objTeacherInfoEN: clsTeacherInfoEN): Promise<boolean>{
 ...
 * @returns 获取修改是否成功？
 **/
export  async function TeacherInfo_EditRecordExAsync(objTeacherInfoEN: clsTeacherInfoEN): Promise<boolean>  
{
...
BindDdl_ObjLstInDivObj(objDiv, strDdlName, arrObjLstSel, clsTeacherInfoEN.con_IdTeacher, clsTeacherInfoEN.con_TeacherName, "选教师...");
}
...
if (IsNullOrEmpty(pobjTeacherInfoEN.idSchool) == false && GetStrLen(pobjTeacherInfoEN.idSchool) > 4)
{
 throw new Error(`(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 教师(TeacherInfo))!值:${pobjTeacherInfoEN.idSchool}(clsTeacherInfoBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjTeacherInfoEN.password) == false && GetStrLen(pobjTeacherInfoEN.password) > 20)
{
 throw new Error(`(errid:Watl000413)字段[口令(password)]的长度不能超过20(In 教师(TeacherInfo))!值:${pobjTeacherInfoEN.password}(clsTeacherInfoBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjTeacherInfoEN.idSchool) == false && undefined !== pobjTeacherInfoEN.idSchool && tzDataType.isString(pobjTeacherInfoEN.idSchool) === false)
{
 throw new Error(`(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjTeacherInfoEN.idSchool}], 非法,应该为字符型(In 教师(TeacherInfo))!(clsTeacherInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjTeacherInfoEN.password) == false && undefined !== pobjTeacherInfoEN.password && tzDataType.isString(pobjTeacherInfoEN.password) === false)
{
 throw new Error(`(errid:Watl000414)字段[口令(password)]的值:[${pobjTeacherInfoEN.password}], 非法,应该为字符型(In 教师(TeacherInfo))!(clsTeacherInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjTeacherInfoEN.idSchool) == false && GetStrLen(pobjTeacherInfoEN.idSchool) > 4)
{
 throw new Error(`(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 教师(TeacherInfo))!值:${pobjTeacherInfoEN.idSchool}(clsTeacherInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjTeacherInfoEN.idDisciplinePs) == false && GetStrLen(pobjTeacherInfoEN.idDisciplinePs) > 4)
{
...
if (IsNullOrEmpty(pobjTeacherInfoEN.password) == false && GetStrLen(pobjTeacherInfoEN.password) > 20)
{
 throw new Error(`(errid:Watl000416)字段[口令(password)]的长度不能超过20(In 教师(TeacherInfo))!值:${pobjTeacherInfoEN.password}(clsTeacherInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjTeacherInfoEN.birthday) == false && GetStrLen(pobjTeacherInfoEN.birthday) > 8)
{
...
if (IsNullOrEmpty(pobjTeacherInfoEN.idSchool) == false && undefined !== pobjTeacherInfoEN.idSchool && tzDataType.isString(pobjTeacherInfoEN.idSchool) === false)
{
 throw new Error(`(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjTeacherInfoEN.idSchool}], 非法,应该为字符型(In 教师(TeacherInfo))!(clsTeacherInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjTeacherInfoEN.idDisciplinePs) == false && undefined !== pobjTeacherInfoEN.idDisciplinePs && tzDataType.isString(pobjTeacherInfoEN.idDisciplinePs) === false)
{
...
if (IsNullOrEmpty(pobjTeacherInfoEN.password) == false && undefined !== pobjTeacherInfoEN.password && tzDataType.isString(pobjTeacherInfoEN.password) === false)
{
 throw new Error(`(errid:Watl000417)字段[口令(password)]的值:[${pobjTeacherInfoEN.password}], 非法,应该为字符型(In 教师(TeacherInfo))!(clsTeacherInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjTeacherInfoEN.birthday) == false && undefined !== pobjTeacherInfoEN.birthday && tzDataType.isString(pobjTeacherInfoEN.birthday) === false)
{
...
if (Object.prototype.hasOwnProperty.call(objTeacherInfoCond.dicFldComparisonOp, clsTeacherInfoEN.con_IdSchool) == true)
{
const strComparisonOpIdSchool:string = objTeacherInfoCond.dicFldComparisonOp[clsTeacherInfoEN.con_IdSchool];
strWhereCond += Format(" And {0} {2} '{1}'", clsTeacherInfoEN.con_IdSchool, objTeacherInfoCond.idSchool, strComparisonOpIdSchool);
}
...
if (Object.prototype.hasOwnProperty.call(objTeacherInfoCond.dicFldComparisonOp, clsTeacherInfoEN.con_Password) == true)
{
const strComparisonOpPassword:string = objTeacherInfoCond.dicFldComparisonOp[clsTeacherInfoEN.con_Password];
strWhereCond += Format(" And {0} {2} '{1}'", clsTeacherInfoEN.con_Password, objTeacherInfoCond.password, strComparisonOpPassword);
}
