...
import {
  ...
  ge_DifficultyLevel_GetObjLstByPagerAsync,
...
export async function ge_DifficultyLevelEx_GetObjExLstByPagerAsync(
  ...
  const arrge_DifficultyLevelObjLst = await ge_DifficultyLevel_GetObjLstByPagerAsync(objPagerPara);
  ...
  let arrge_DifficultyLevelSel: Array<clsge_DifficultyLevelENEx> = arrge_DifficultyLevelExObjLst;
  try {
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrge_DifficultyLevelSel = arrge_DifficultyLevelSel.sort(
