...
export function Users_CheckPropertyNew(pobjUsersEN: clsUsersEN) {
  ...
  if (IsNullOrEmpty(pobjUsersEN.userName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[用户名]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.userStateId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[用户状态Id]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.identityId) === true || pobjUsersEN.identityId.toString() === '0') {
    throw new Error(
      `(errid:Watl000411)字段[身份Id]不能为空(In 用户)!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (IsNullOrEmpty(pobjUsersEN.userId) == false && GetStrLen(pobjUsersEN.userId) > 18) {
    throw new Error(
      `(errid:Watl000413)字段[用户ID(userId)]的长度不能超过18(In 用户(Users))!值:${pobjUsersEN.userId}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.userName) == false && GetStrLen(pobjUsersEN.userName) > 30) {
    throw new Error(
      `(errid:Watl000413)字段[用户名(userName)]的长度不能超过30(In 用户(Users))!值:${pobjUsersEN.userName}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.userStateId) == false && GetStrLen(pobjUsersEN.userStateId) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[用户状态Id(userStateId)]的长度不能超过2(In 用户(Users))!值:${pobjUsersEN.userStateId}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.password) == false && GetStrLen(pobjUsersEN.password) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[口令(password)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.password}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.id_School) == false && GetStrLen(pobjUsersEN.id_School) > 4) {
    throw new Error(
      `(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 用户(Users))!值:${pobjUsersEN.id_School}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.beginYearMonth) == false &&
    GetStrLen(pobjUsersEN.beginYearMonth) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[开始年月(beginYearMonth)]的长度不能超过8(In 用户(Users))!值:${pobjUsersEN.beginYearMonth}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  ...
  if (IsNullOrEmpty(pobjUsersEN.id_XzMajor) == false && GetStrLen(pobjUsersEN.id_XzMajor) > 8) {
    throw new Error(
      `(errid:Watl000413)字段[专业流水号(idXzMajor)]的长度不能超过8(In 用户(Users))!值:${pobjUsersEN.id_XzMajor}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.stuIdTeacherId) == false &&
    GetStrLen(pobjUsersEN.stuIdTeacherId) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学工号(stuIdTeacherId)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.stuIdTeacherId}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.email) == false && GetStrLen(pobjUsersEN.email) > 100) {
    throw new Error(
      `(errid:Watl000413)字段[电子邮箱(email)]的长度不能超过100(In 用户(Users))!值:${pobjUsersEN.email}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.phoneNumber) == false && GetStrLen(pobjUsersEN.phoneNumber) > 15) {
    throw new Error(
      `(errid:Watl000413)字段[电话(phoneNumber)]的长度不能超过15(In 用户(Users))!值:${pobjUsersEN.phoneNumber}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.avatarsPicture) == false &&
    GetStrLen(pobjUsersEN.avatarsPicture) > 100
  ) {
    throw new Error(
      `(errid:Watl000413)字段[虚拟头像(avatarsPicture)]的长度不能超过100(In 用户(Users))!值:${pobjUsersEN.avatarsPicture}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.identityId) == false && GetStrLen(pobjUsersEN.identityId) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[身份Id(identityId)]的长度不能超过2(In 用户(Users))!值:${pobjUsersEN.identityId}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.auditDate) == false && GetStrLen(pobjUsersEN.auditDate) > 14) {
    throw new Error(
      `(errid:Watl000413)字段[AuditDate(auditDate)]的长度不能超过14(In 用户(Users))!值:${pobjUsersEN.auditDate}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.auditUser) == false && GetStrLen(pobjUsersEN.auditUser) > 18) {
    throw new Error(
      `(errid:Watl000413)字段[AuditUser(auditUser)]的长度不能超过18(In 用户(Users))!值:${pobjUsersEN.auditUser}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000413)字段[RegisterDate(registerDate)]的长度不能超过14(In 用户(Users))!值:${pobjUsersEN.registerDate}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.mobilePhone) == false && GetStrLen(pobjUsersEN.mobilePhone) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[手机(mobilePhone)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.mobilePhone}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.openId) == false && GetStrLen(pobjUsersEN.openId) > 50) {
    throw new Error(
      `(errid:Watl000413)字段[微信OpenId(openId)]的长度不能超过50(In 用户(Users))!值:${pobjUsersEN.openId}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.updDate) == false && GetStrLen(pobjUsersEN.updDate) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.updDate}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.updUser) == false && GetStrLen(pobjUsersEN.updUser) > 20) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(updUser)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.updUser}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.memo) == false && GetStrLen(pobjUsersEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 用户(Users))!值:${pobjUsersEN.memo}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.headPic) == false && GetStrLen(pobjUsersEN.headPic) > 500) {
    throw new Error(
      `(errid:Watl000413)字段[头像(headPic)]的长度不能超过500(In 用户(Users))!值:${pobjUsersEN.headPic}(clsUsersBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[用户ID(userId)]的值:[${pobjUsersEN.userId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[用户名(userName)]的值:[${pobjUsersEN.userName}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[用户状态Id(userStateId)]的值:[${pobjUsersEN.userStateId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[口令(password)]的值:[${pobjUsersEN.password}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[是否Gp用户(isGpUser)]的值:[${pobjUsersEN.isGpUser}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.id_School) == false &&
    undefined !== pobjUsersEN.id_School &&
    tzDataType.isString(pobjUsersEN.id_School) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjUsersEN.id_School}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.beginYearMonth) == false &&
    ...
    throw new Error(
      `(errid:Watl000414)字段[开始年月(beginYearMonth)]的值:[${pobjUsersEN.beginYearMonth}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.endYearMonth) == false &&
    undefined !== pobjUsersEN.endYearMonth &&
    tzDataType.isString(pobjUsersEN.endYearMonth) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[结束年月(endYearMonth)]的值:[${pobjUsersEN.endYearMonth}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjUsersEN.idGrade) == false &&
    undefined !== pobjUsersEN.idGrade &&
    tzDataType.isString(pobjUsersEN.idGrade) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级流水号(idGrade)]的值:[${pobjUsersEN.idGrade}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjUsersEN.id_XzMajor) == false &&
    undefined !== pobjUsersEN.id_XzMajor &&
    tzDataType.isString(pobjUsersEN.id_XzMajor) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业流水号(idXzMajor)]的值:[${pobjUsersEN.id_XzMajor}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[是否离开(isLeaved)]的值:[${pobjUsersEN.isLeaved}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.stuIdTeacherId) == false &&
    ...
    throw new Error(
      `(errid:Watl000414)字段[学工号(stuIdTeacherId)]的值:[${pobjUsersEN.stuIdTeacherId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[电子邮箱(email)]的值:[${pobjUsersEN.email}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.phoneNumber) == false &&
    undefined !== pobjUsersEN.phoneNumber &&
    tzDataType.isString(pobjUsersEN.phoneNumber) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[电话(phoneNumber)]的值:[${pobjUsersEN.phoneNumber}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.avatarsPicture) == false &&
    ...
    throw new Error(
      `(errid:Watl000414)字段[虚拟头像(avatarsPicture)]的值:[${pobjUsersEN.avatarsPicture}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[身份Id(identityId)]的值:[${pobjUsersEN.identityId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[AuditDate(auditDate)]的值:[${pobjUsersEN.auditDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[AuditUser(auditUser)]的值:[${pobjUsersEN.auditUser}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[是否审核(isAudit)]的值:[${pobjUsersEN.isAudit}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[IsRegister(isRegister)]的值:[${pobjUsersEN.isRegister}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.registerDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000414)字段[RegisterDate(registerDate)]的值:[${pobjUsersEN.registerDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.mobilePhone) == false &&
    undefined !== pobjUsersEN.mobilePhone &&
    tzDataType.isString(pobjUsersEN.mobilePhone) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[手机(mobilePhone)]的值:[${pobjUsersEN.mobilePhone}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.openId) == false &&
    undefined !== pobjUsersEN.openId &&
    tzDataType.isString(pobjUsersEN.openId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[微信OpenId(openId)]的值:[${pobjUsersEN.openId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjUsersEN.updDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[修改人(updUser)]的值:[${pobjUsersEN.updUser}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjUsersEN.memo}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.headPic) == false &&
    undefined !== pobjUsersEN.headPic &&
    tzDataType.isString(pobjUsersEN.headPic) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[头像(headPic)]的值:[${pobjUsersEN.headPic}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[是否GS用户(isGSuser)]的值:[${pobjUsersEN.isGSuser}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckPropertyNew0)`,
    );
  }
...
export function Users_CheckProperty4Update(pobjUsersEN: clsUsersEN) {
  ...
  if (IsNullOrEmpty(pobjUsersEN.userId) == false && GetStrLen(pobjUsersEN.userId) > 18) {
    throw new Error(
      `(errid:Watl000416)字段[用户ID(userId)]的长度不能超过18(In 用户(Users))!值:${pobjUsersEN.userId}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.userName) == false && GetStrLen(pobjUsersEN.userName) > 30) {
    throw new Error(
      `(errid:Watl000416)字段[用户名(userName)]的长度不能超过30(In 用户(Users))!值:${pobjUsersEN.userName}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.userStateId) == false && GetStrLen(pobjUsersEN.userStateId) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[用户状态Id(userStateId)]的长度不能超过2(In 用户(Users))!值:${pobjUsersEN.userStateId}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.password) == false && GetStrLen(pobjUsersEN.password) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[口令(password)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.password}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.id_School) == false && GetStrLen(pobjUsersEN.id_School) > 4) {
    throw new Error(
      `(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 用户(Users))!值:${pobjUsersEN.id_School}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.beginYearMonth) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[开始年月(beginYearMonth)]的长度不能超过8(In 用户(Users))!值:${pobjUsersEN.beginYearMonth}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.endYearMonth) == false && GetStrLen(pobjUsersEN.endYearMonth) > 8) {
    throw new Error(
  ...
  if (IsNullOrEmpty(pobjUsersEN.id_XzMajor) == false && GetStrLen(pobjUsersEN.id_XzMajor) > 8) {
    throw new Error(
      `(errid:Watl000416)字段[专业流水号(idXzMajor)]的长度不能超过8(In 用户(Users))!值:${pobjUsersEN.id_XzMajor}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.stuIdTeacherId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[学工号(stuIdTeacherId)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.stuIdTeacherId}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.email) == false && GetStrLen(pobjUsersEN.email) > 100) {
    throw new Error(
      `(errid:Watl000416)字段[电子邮箱(email)]的长度不能超过100(In 用户(Users))!值:${pobjUsersEN.email}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.phoneNumber) == false && GetStrLen(pobjUsersEN.phoneNumber) > 15) {
    throw new Error(
      `(errid:Watl000416)字段[电话(phoneNumber)]的长度不能超过15(In 用户(Users))!值:${pobjUsersEN.phoneNumber}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.avatarsPicture) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[虚拟头像(avatarsPicture)]的长度不能超过100(In 用户(Users))!值:${pobjUsersEN.avatarsPicture}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.identityId) == false && GetStrLen(pobjUsersEN.identityId) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[身份Id(identityId)]的长度不能超过2(In 用户(Users))!值:${pobjUsersEN.identityId}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.auditDate) == false && GetStrLen(pobjUsersEN.auditDate) > 14) {
    throw new Error(
      `(errid:Watl000416)字段[AuditDate(auditDate)]的长度不能超过14(In 用户(Users))!值:${pobjUsersEN.auditDate}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.auditUser) == false && GetStrLen(pobjUsersEN.auditUser) > 18) {
    throw new Error(
      `(errid:Watl000416)字段[AuditUser(auditUser)]的长度不能超过18(In 用户(Users))!值:${pobjUsersEN.auditUser}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.registerDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[RegisterDate(registerDate)]的长度不能超过14(In 用户(Users))!值:${pobjUsersEN.registerDate}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.mobilePhone) == false && GetStrLen(pobjUsersEN.mobilePhone) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[手机(mobilePhone)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.mobilePhone}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.openId) == false && GetStrLen(pobjUsersEN.openId) > 50) {
    throw new Error(
      `(errid:Watl000416)字段[微信OpenId(openId)]的长度不能超过50(In 用户(Users))!值:${pobjUsersEN.openId}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.updDate) == false && GetStrLen(pobjUsersEN.updDate) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.updDate}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.updUser) == false && GetStrLen(pobjUsersEN.updUser) > 20) {
    throw new Error(
      `(errid:Watl000416)字段[修改人(updUser)]的长度不能超过20(In 用户(Users))!值:${pobjUsersEN.updUser}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.memo) == false && GetStrLen(pobjUsersEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 用户(Users))!值:${pobjUsersEN.memo}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjUsersEN.headPic) == false && GetStrLen(pobjUsersEN.headPic) > 500) {
    throw new Error(
      `(errid:Watl000416)字段[头像(headPic)]的长度不能超过500(In 用户(Users))!值:${pobjUsersEN.headPic}(clsUsersBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[用户ID(userId)]的值:[${pobjUsersEN.userId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.userName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[用户名(userName)]的值:[${pobjUsersEN.userName}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.userStateId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[用户状态Id(userStateId)]的值:[${pobjUsersEN.userStateId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.password) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[口令(password)]的值:[${pobjUsersEN.password}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjUsersEN.isGpUser &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否Gp用户(isGpUser)]的值:[${pobjUsersEN.isGpUser}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.id_School) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjUsersEN.id_School}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.beginYearMonth) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[开始年月(beginYearMonth)]的值:[${pobjUsersEN.beginYearMonth}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.endYearMonth) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[结束年月(endYearMonth)]的值:[${pobjUsersEN.endYearMonth}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.idGradeBase) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级流水号(idGrade)]的值:[${pobjUsersEN.idGrade}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.idXzCollege) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业流水号(idXzMajor)]的值:[${pobjUsersEN.id_XzMajor}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjUsersEN.isLeaved &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否离开(isLeaved)]的值:[${pobjUsersEN.isLeaved}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.stuIdTeacherId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学工号(stuIdTeacherId)]的值:[${pobjUsersEN.stuIdTeacherId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.email) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[电子邮箱(email)]的值:[${pobjUsersEN.email}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.phoneNumber) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[电话(phoneNumber)]的值:[${pobjUsersEN.phoneNumber}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.avatarsPicture) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[虚拟头像(avatarsPicture)]的值:[${pobjUsersEN.avatarsPicture}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.identityId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[身份Id(identityId)]的值:[${pobjUsersEN.identityId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.auditDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[AuditDate(auditDate)]的值:[${pobjUsersEN.auditDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.auditUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[AuditUser(auditUser)]的值:[${pobjUsersEN.auditUser}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjUsersEN.isAudit &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否审核(isAudit)]的值:[${pobjUsersEN.isAudit}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjUsersEN.isRegister &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[IsRegister(isRegister)]的值:[${pobjUsersEN.isRegister}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.registerDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[RegisterDate(registerDate)]的值:[${pobjUsersEN.registerDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.mobilePhone) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[手机(mobilePhone)]的值:[${pobjUsersEN.mobilePhone}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.openId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[微信OpenId(openId)]的值:[${pobjUsersEN.openId}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(updDate)]的值:[${pobjUsersEN.updDate}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.updUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(updUser)]的值:[${pobjUsersEN.updUser}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjUsersEN.memo}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjUsersEN.headPic) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[头像(headPic)]的值:[${pobjUsersEN.headPic}], 非法,应该为字符型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjUsersEN.isGSuser &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否GS用户(isGSuser)]的值:[${pobjUsersEN.isGSuser}], 非法,应该为布尔型(In 用户(Users))!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjUsersEN.userId) === true) {
    throw new Error(
      `(errid:Watl000064)字段[用户ID]不能为空(In 用户)!(clsUsersBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
...
export function Users_GetCombineCondition(objUsersCond: clsUsersEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_IdSchool,
    ) == true
  ) {
    const strComparisonOpIdSchool: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_IdSchool];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_IdSchool,
      objUsersCond.id_School,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_BeginYearMonth,
    ) == true
  ) {
    const strComparisonOpBeginYearMonth: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_BeginYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_BeginYearMonth,
      objUsersCond.beginYearMonth,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_EndYearMonth,
    ) == true
  ) {
    const strComparisonOpEndYearMonth: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_EndYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_EndYearMonth,
      objUsersCond.endYearMonth,
  ...
  if (
    ...
    const strComparisonOpIdGradeBase: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_IdGradeBase];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_IdGradeBase,
  ...
  if (
    Object.prototype.hasOwnProperty.call(objUsersCond.dicFldComparisonOp, clsUsersEN.con_IdGrade) ==
    true
  ) {
    const strComparisonOpIdGrade: string = objUsersCond.dicFldComparisonOp[clsUsersEN.con_IdGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_IdGrade,
      objUsersCond.idGrade,
  ...
  if (
    ...
    const strComparisonOpIdXzCollege: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_Id_XzCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_IdXzMajor,
    ) == true
  ) {
    const strComparisonOpIdXzMajor: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_IdXzMajor];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_IdXzMajor,
      objUsersCond.id_XzMajor,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_StuIdTeacherId,
    ) == true
  ) {
    const strComparisonOpStuIdTeacherId: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_StuIdTeacherId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_StuIdTeacherId,
      objUsersCond.stuIdTeacherId,
      strComparisonOpStuIdTeacherId,
    );
  }
  if (
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_PhoneNumber,
    ) == true
  ) {
    const strComparisonOpPhoneNumber: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_PhoneNumber];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_PhoneNumber,
      objUsersCond.phoneNumber,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_AvatarsPicture,
    ) == true
  ) {
    const strComparisonOpAvatarsPicture: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_AvatarsPicture];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_AvatarsPicture,
      objUsersCond.avatarsPicture,
      strComparisonOpAvatarsPicture,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objUsersCond.dicFldComparisonOp,
      clsUsersEN.con_MobilePhone,
    ) == true
  ) {
    const strComparisonOpMobilePhone: string =
      objUsersCond.dicFldComparisonOp[clsUsersEN.con_MobilePhone];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_MobilePhone,
      objUsersCond.mobilePhone,
      strComparisonOpMobilePhone,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(objUsersCond.dicFldComparisonOp, clsUsersEN.con_OpenId) ==
    true
  ) {
    const strComparisonOpOpenId: string = objUsersCond.dicFldComparisonOp[clsUsersEN.con_OpenId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_OpenId,
      objUsersCond.openId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(objUsersCond.dicFldComparisonOp, clsUsersEN.con_HeadPic) ==
    true
  ) {
    const strComparisonOpHeadPic: string = objUsersCond.dicFldComparisonOp[clsUsersEN.con_HeadPic];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsUsersEN.con_HeadPic,
      objUsersCond.headPic,
