...
import {
  QxPrjId_Local,
  CombineQxPrjPotenceConditionObj4ExportExcel,
  CombineQxPrjPotenceConditionObj,
  QxPrjPotence_DeleteKeyIdCache,
  divVarSet,
  viewVarSet,
  dataColumn,
  BindTabByList,
...
import {
  ...
  QxPrjPotence_FuncMapByFldName,
  QxPrjPotence_GetObjExLstByPagerCache,
...
export abstract class QxPrjPotenceCRUD implements clsOperateList {
  ...
  public async PageLoadCache() {
    ...
    try {
      ...
      if (viewVarSet.sortQxPrjPotenceBy == '')
        viewVarSet.sortQxPrjPotenceBy = `${clsQxPrjPotenceEN.con_PotenceId} Asc`;
  ...
  public async ExportExcel_QxPrjPotence4Func(): Promise<ExportExcelData> {
    ...
    try {
      ...
      const arrQxPrjPotenceObjLst = await QxPrjPotence_GetSubObjLstCache(
        objQxPrjPotenceCond,
        QxPrjId_Local.value,
      );
  ...
  public async BindGv_QxPrjPotence4Func(divList: HTMLDivElement) {
    ...
    try {
      ...
      arrQxPrjPotenceExObjLst = await QxPrjPotence_GetObjExLstByPagerCache(
        objPagerPara,
        QxPrjId_Local.value,
      );
    } catch (e) {
