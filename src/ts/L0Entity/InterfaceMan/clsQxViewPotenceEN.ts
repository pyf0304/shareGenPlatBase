...
public static readonly _CurrTabName: string = "QxViewPotence"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 6;
public static readonly _AttributeName = ["mId", "viewId", "qxPrjId", "potenceId", "level", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_Level = "level";    //等级
