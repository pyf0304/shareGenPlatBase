...
private mstrUserTypeName = "";    //用户类型名
private mstrUserTypeNameSim = "";    //用户类型简称
private mstrUserTypeENName = "";    //用户类型英文名
private mstrMemo = "";    //备注
...
/**
 * 用户类型名(说明:;字段类型:varchar;字段长度:20;是否可空:False)
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
...
/**
 * 用户类型简称(说明:;字段类型:varchar;字段长度:20;是否可空:True)
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
...
/**
 * 用户类型英文名(说明:;字段类型:varchar;字段长度:50;是否可空:True)
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
