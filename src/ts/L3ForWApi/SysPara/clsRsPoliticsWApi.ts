 ...
 * @returns 对象
 **/
export async function RsPolitics_GetObjByIdPoliticsAsync(
  strIdPolitics: string,
): Promise<clsRsPoliticsEN | null> {
  const strThisFuncName = 'GetObjByIdPoliticsAsync';

  if (IsNullOrEmpty(strIdPolitics) == true) {
    const strMsg = Format(
      '参数:[strIdPolitics]不能为空!(In clsRsPoliticsWApi.GetObjByIdPoliticsAsync)',
    );
  ...
  if (strIdPolitics.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdPolitics]的长度:[{0}]不正确!(clsRsPoliticsWApi.GetObjByIdPoliticsAsync)',
      strIdPolitics.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function RsPolitics_GetObjByIdPoliticslocalStorage(strIdPolitics: string) {
  ...
  if (IsNullOrEmpty(strIdPolitics) == true) {
    const strMsg = Format(
      '参数:[strIdPolitics]不能为空!(In clsRsPoliticsWApi.GetObjByIdPoliticslocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdPolitics.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdPolitics]的长度:[{0}]不正确!(clsRsPoliticsWApi.GetObjByIdPoliticslocalStorage)',
      strIdPolitics.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function RsPolitics_GetObjByIdPoliticsCache(
  strIdPolitics: string,
  ...
  if (IsNullOrEmpty(strIdPolitics) == true) {
    const strMsg = Format(
      '参数:[strIdPolitics]不能为空!(In clsRsPoliticsWApi.GetObjByIdPoliticsCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdPolitics.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdPolitics]的长度:[{0}]不正确!(clsRsPoliticsWApi.GetObjByIdPoliticsCache)',
      strIdPolitics.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function RsPolitics_UpdateObjInLstCache(objRsPolitics: clsRsPoliticsEN) {
  ...
  try {
    const arrRsPoliticsObjLstCache = await RsPolitics_GetObjLstCache();
    const obj = arrRsPoliticsObjLstCache.find((x) => x.idPolitics == objRsPolitics.idPolitics);
    if (obj != null) {
...
export async function RsPolitics_GetNameByIdPoliticsCache(strIdPolitics: string) {
  if (IsNullOrEmpty(strIdPolitics) == true) {
    const strMsg = Format(
      '参数:[strIdPolitics]不能为空!(In clsRsPoliticsWApi.GetNameByIdPoliticsCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdPolitics.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdPolitics]的长度:[{0}]不正确!(clsRsPoliticsWApi.GetNameByIdPoliticsCache)',
      strIdPolitics.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function RsPolitics_func(
  strInFldName: string,
  ...
  if (clsRsPoliticsEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsRsPoliticsEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function RsPolitics_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrRsPoliticsSel = arrRsPoliticsSel.filter(
 ...
 **/
export async function RsPolitics_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function RsPolitics_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsRsPoliticsEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsPolitics_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsRsPoliticsEN>> {
...
export async function RsPolitics_GetSubObjLstCache(objRsPoliticsCond: clsRsPoliticsEN) {
  ...
  if (objRsPoliticsCond.sfFldComparisonOp == null || objRsPoliticsCond.sfFldComparisonOp == '')
    return arrRsPoliticsSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsPoliticsCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objRsPoliticsCond),
      rsPolitics_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function RsPolitics_GetObjLstByIdPoliticsLstAsync(
  arrIdPolitics: Array<string>,
): Promise<Array<clsRsPoliticsEN>> {
...
export async function RsPolitics_GetObjLstByIdPoliticsLstCache(arrIdPoliticsLst: Array<string>) {
  ...
  try {
    const arrRsPoliticsObjLstCache = await RsPolitics_GetObjLstCache();
    const arrRsPoliticsSel = arrRsPoliticsObjLstCache.filter(
      (x) => arrIdPoliticsLst.indexOf(x.idPolitics) > -1,
    );
    return arrRsPoliticsSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsPolitics_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsPolitics_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsPolitics_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsPolitics_DelRsPoliticssAsync(
  arrIdPolitics: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsPolitics_AddNewRecordAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsPolitics_AddNewRecordWithMaxIdAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
): Promise<string> {
 ...
 **/
export async function RsPolitics_AddNewObjSave(
  objRsPoliticsEN: clsRsPoliticsEN,
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function RsPolitics_AddNewRecordWithReturnKeyAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsPolitics_UpdateRecordAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objRsPoliticsEN.sfUpdFldSetStr === undefined ||
    objRsPoliticsEN.sfUpdFldSetStr === null ||
    objRsPoliticsEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsPolitics_EditRecordExAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function RsPolitics_UpdateWithConditionAsync(
  objRsPoliticsEN: clsRsPoliticsEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function RsPolitics_IsExistRecordCache(objRsPoliticsCond: clsRsPoliticsEN) {
  ...
  let arrRsPoliticsSel = arrRsPoliticsObjLstCache;
  if (objRsPoliticsCond.sfFldComparisonOp == null || objRsPoliticsCond.sfFldComparisonOp == '')
    return arrRsPoliticsSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsPoliticsCond.sfFldComparisonOp,
  );
  //console.log("clsRsPoliticsWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function RsPolitics_BindDdl_IdPoliticsInDivCache(
...
export function RsPolitics_CheckPropertyNew(pobjRsPoliticsEN: clsRsPoliticsEN) {
  ...
  if (IsNullOrEmpty(pobjRsPoliticsEN.politicsId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[政治面貌Id]不能为空(In 政治面貌)!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjRsPoliticsEN.politicsName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[政治面貌]不能为空(In 政治面貌)!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.idPolitics) == false &&
    GetStrLen(pobjRsPoliticsEN.idPolitics) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[政治面貌流水号(idPolitics)]的长度不能超过4(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.idPolitics}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsId) == false &&
    GetStrLen(pobjRsPoliticsEN.politicsId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[政治面貌Id(politicsId)]的长度不能超过4(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsId}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsName) == false &&
    GetStrLen(pobjRsPoliticsEN.politicsName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[政治面貌(politicsName)]的长度不能超过30(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsName}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsIdNgb) == false &&
    GetStrLen(pobjRsPoliticsEN.politicsIdNgb) > 10
  ) {
    throw new Error(
      `(errid:Watl000413)字段[PoliticsId_NGB(politicsIdNgb)]的长度不能超过10(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsIdNgb}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsRecruitId) == false &&
    GetStrLen(pobjRsPoliticsEN.politicsRecruitId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[PoliticsRecruitId(politicsRecruitId)]的长度不能超过2(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsRecruitId}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyDate) == false &&
    GetStrLen(pobjRsPoliticsEN.modifyDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(modifyDate)]的长度不能超过20(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.modifyDate}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyUserId) == false &&
    GetStrLen(pobjRsPoliticsEN.modifyUserId) > 18
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(modifyUserId)]的长度不能超过18(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.modifyUserId}(clsRsPoliticsBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.idPolitics) == false &&
    undefined !== pobjRsPoliticsEN.idPolitics &&
    tzDataType.isString(pobjRsPoliticsEN.idPolitics) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[政治面貌流水号(idPolitics)]的值:[${pobjRsPoliticsEN.idPolitics}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsId) == false &&
    undefined !== pobjRsPoliticsEN.politicsId &&
    tzDataType.isString(pobjRsPoliticsEN.politicsId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[政治面貌Id(politicsId)]的值:[${pobjRsPoliticsEN.politicsId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsName) == false &&
    undefined !== pobjRsPoliticsEN.politicsName &&
    tzDataType.isString(pobjRsPoliticsEN.politicsName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[政治面貌(politicsName)]的值:[${pobjRsPoliticsEN.politicsName}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsIdNgb) == false &&
    undefined !== pobjRsPoliticsEN.politicsIdNgb &&
    tzDataType.isString(pobjRsPoliticsEN.politicsIdNgb) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[PoliticsId_NGB(politicsIdNgb)]的值:[${pobjRsPoliticsEN.politicsIdNgb}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsRecruitId) == false &&
    undefined !== pobjRsPoliticsEN.politicsRecruitId &&
    tzDataType.isString(pobjRsPoliticsEN.politicsRecruitId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[PoliticsRecruitId(politicsRecruitId)]的值:[${pobjRsPoliticsEN.politicsRecruitId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyDate) == false &&
    undefined !== pobjRsPoliticsEN.modifyDate &&
    tzDataType.isString(pobjRsPoliticsEN.modifyDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(modifyDate)]的值:[${pobjRsPoliticsEN.modifyDate}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyUserId) == false &&
    undefined !== pobjRsPoliticsEN.modifyUserId &&
    tzDataType.isString(pobjRsPoliticsEN.modifyUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(modifyUserId)]的值:[${pobjRsPoliticsEN.modifyUserId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckPropertyNew0)`,
    );
  }
...
export function RsPolitics_CheckProperty4Update(pobjRsPoliticsEN: clsRsPoliticsEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[政治面貌流水号(idPolitics)]的长度不能超过4(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.idPolitics}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[政治面貌Id(politicsId)]的长度不能超过4(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsId}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[政治面貌(politicsName)]的长度不能超过30(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsName}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsIdNgb) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[PoliticsId_NGB(politicsIdNgb)]的长度不能超过10(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsIdNgb}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsRecruitId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[PoliticsRecruitId(politicsRecruitId)]的长度不能超过2(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.politicsRecruitId}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(modifyDate)]的长度不能超过20(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.modifyDate}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(modifyUserId)]的长度不能超过18(In 政治面貌(RsPolitics))!值:${pobjRsPoliticsEN.modifyUserId}(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[政治面貌流水号(idPolitics)]的值:[${pobjRsPoliticsEN.idPolitics}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[政治面貌Id(politicsId)]的值:[${pobjRsPoliticsEN.politicsId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[政治面貌(politicsName)]的值:[${pobjRsPoliticsEN.politicsName}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsIdNgb) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[PoliticsId_NGB(politicsIdNgb)]的值:[${pobjRsPoliticsEN.politicsIdNgb}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.politicsRecruitId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[PoliticsRecruitId(politicsRecruitId)]的值:[${pobjRsPoliticsEN.politicsRecruitId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(modifyDate)]的值:[${pobjRsPoliticsEN.modifyDate}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsPoliticsEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(modifyUserId)]的值:[${pobjRsPoliticsEN.modifyUserId}], 非法,应该为字符型(In 政治面貌(RsPolitics))!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjRsPoliticsEN.idPolitics) === true) {
    throw new Error(
      `(errid:Watl000064)字段[政治面貌流水号]不能为空(In 政治面貌)!(clsRsPoliticsBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function RsPolitics_GetObjLstByJSONObjLst(
  arrRsPoliticsObjLstS: Array<clsRsPoliticsEN>,
): Array<clsRsPoliticsEN> {
...
export function RsPolitics_GetCombineCondition(objRsPoliticsCond: clsRsPoliticsEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_IdPolitics,
    ) == true
  ) {
    const strComparisonOpIdPolitics: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_IdPolitics];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_IdPolitics,
      objRsPoliticsCond.idPolitics,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_PoliticsId,
    ) == true
  ) {
    const strComparisonOpPoliticsId: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_PoliticsId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_PoliticsId,
      objRsPoliticsCond.politicsId,
  ...
  if (
    ...
    const strComparisonOpPoliticsName: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_PoliticsName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_PoliticsName,
      objRsPoliticsCond.politicsName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_PoliticsIdNgb,
    ) == true
  ) {
    const strComparisonOpPoliticsIdNgb: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_PoliticsIdNgb];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_PoliticsIdNgb,
      objRsPoliticsCond.politicsIdNgb,
      strComparisonOpPoliticsIdNgb,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_PoliticsRecruitId,
    ) == true
  ) {
    const strComparisonOpPoliticsRecruitId: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_PoliticsRecruitId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_PoliticsRecruitId,
      objRsPoliticsCond.politicsRecruitId,
      strComparisonOpPoliticsRecruitId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_ModifyDate,
      objRsPoliticsCond.modifyDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsPoliticsCond.dicFldComparisonOp,
      clsRsPoliticsEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objRsPoliticsCond.dicFldComparisonOp[clsRsPoliticsEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsPoliticsEN.con_ModifyUserId,
      objRsPoliticsCond.modifyUserId,
 ...
 */
export function RsPolitics_CopyObjTo(
  objRsPoliticsENS: clsRsPoliticsEN,
  objRsPoliticsENT: clsRsPoliticsEN,
): void {
