 ...
 * @returns 对象列表子集
*/
export  async function vStudentInfo_Sim_GetSubObjLstCache(objvStudentInfo_SimCond: clsvStudentInfo_SimEN ,strIdCurrEduCls: string) {
const strThisFuncName = "GetSubObjLstCache";
const arrvStudentInfo_SimObjLstCache = await vStudentInfo_Sim_GetObjLstCache(strIdCurrEduCls);
let arrvStudentInfo_SimSel = arrvStudentInfo_SimObjLstCache;
if (objvStudentInfo_SimCond.sfFldComparisonOp == null || objvStudentInfo_SimCond.sfFldComparisonOp == "") return arrvStudentInfo_SimSel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objvStudentInfo_SimCond.sfFldComparisonOp);
 ...
 * @returns 对象列表
*/
export  async function vStudentInfo_Sim_GetObjLstByPagerCache(objPagerPara: stuPagerPara ,strIdCurrEduCls: string) {
...
arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.sort(vStudentInfo_Sim_SortFunByKey(strSortFld, strSortType));
}
else {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, vStudentInfo_Sim_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsvStudentInfo_SimEN>();
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function vStudentInfo_Sim_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsvStudentInfo_SimEN>>  
{
 ...
 * @returns 对象列表子集
*/
export  async function vStudentInfo_Sim_IsExistRecordCache(objvStudentInfo_SimCond: clsvStudentInfo_SimEN,strIdCurrEduCls: string) {
const strThisFuncName = "IsExistRecordCache";
const arrvStudentInfo_SimObjLstCache = await vStudentInfo_Sim_GetObjLstCache(strIdCurrEduCls);
if (arrvStudentInfo_SimObjLstCache == null) return false;
let arrvStudentInfo_SimSel = arrvStudentInfo_SimObjLstCache;
if (objvStudentInfo_SimCond.sfFldComparisonOp == null || objvStudentInfo_SimCond.sfFldComparisonOp == "") return arrvStudentInfo_SimSel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objvStudentInfo_SimCond.sfFldComparisonOp);
//console.log("clsvStudentInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
 ...
 * @returns 对象列表记录数
*/
export  async function vStudentInfo_Sim_GetRecCountByCondCache(objvStudentInfo_SimCond: clsvStudentInfo_SimEN ,strIdCurrEduCls: string) {
const strThisFuncName = "GetRecCountByCondCache";
const arrvStudentInfo_SimObjLstCache = await vStudentInfo_Sim_GetObjLstCache(strIdCurrEduCls);
if (arrvStudentInfo_SimObjLstCache == null) return 0;
let arrvStudentInfo_SimSel = arrvStudentInfo_SimObjLstCache;
if (objvStudentInfo_SimCond.sfFldComparisonOp == null || objvStudentInfo_SimCond.sfFldComparisonOp == "") return arrvStudentInfo_SimSel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objvStudentInfo_SimCond.sfFldComparisonOp);
//console.log("clsvStudentInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
