...
import {
  XzSchool_CheckPropertyNew,
  XzSchool_IsExistAsync,
  XzSchool_AddNewRecordAsync,
  XzSchool_ReFreshCache,
  XzSchool_AddNewRecordWithMaxIdAsync,
  XzSchool_GetObjByIdSchoolAsync,
  XzSchool_CheckProperty4Update,
          ...
          if (['02', '03', '06'].indexOf(clsXzSchoolEN.PrimaryTypeId) > -1) {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGvCache(clsXzSchoolEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              if (this.iShowList != null)
                this.iShowList.BindGvCache(clsXzSchoolEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
