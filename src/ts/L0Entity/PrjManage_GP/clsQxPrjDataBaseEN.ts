...
public static readonly _CurrTabName: string = "QxPrjDataBase"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "QxPrjDataBaseId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 13;
public static readonly _AttributeName = ["qxPrjDataBaseId", "prjDataBaseName", "dataBaseName", "databaseOwner", "dataBasePwd", "dataBaseTypeId", "dataBaseUserId", "ipAddress", "sID", "tableSpace", "userId", "updDate", "memo"];
//以下是属性变量
 ...
 */
 public static readonly con_QxPrjDataBaseId = "qxPrjDataBaseId";    //项目数据库Id
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DataBasePwd = "dataBasePwd";    //数据库用户口令
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_DataBaseUserId = "dataBaseUserId";    //数据库用户Id
