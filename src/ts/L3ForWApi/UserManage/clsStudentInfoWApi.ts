 ...
 **/
export  async function StudentInfo_AddNewObjSave(objStudentInfoEN: clsStudentInfoEN): Promise<AddRecordResult>{
 ...
 **/
export  async function StudentInfo_CheckUniCond4Add(objStudentInfoEN: clsStudentInfoEN): Promise<boolean>{
 ...
 **/
export  async function StudentInfo_CheckUniCond4Update(objStudentInfoEN: clsStudentInfoEN): Promise<boolean>{
 ...
 **/
export  async function StudentInfo_UpdateObjSave(objStudentInfoEN: clsStudentInfoEN): Promise<boolean>{
 ...
 * @returns 获取修改是否成功？
 **/
export  async function StudentInfo_EditRecordExAsync(objStudentInfoEN: clsStudentInfoEN): Promise<boolean>  
{
...
{
 throw new Error(`(errid:Watl000413)字段[入学年级流水号(idGradeBase)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idGradeBase}(clsStudentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false && GetStrLen(pobjStudentInfoEN.idGrade) > 2)
{
 throw new Error(`(errid:Watl000413)字段[年级流水号(idGrade)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idGrade}(clsStudentInfoBL:CheckPropertyNew)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idXsStatus) == false && GetStrLen(pobjStudentInfoEN.idXsStatus) > 2)
{
 throw new Error(`(errid:Watl000413)字段[学生状态流水号(idXsStatus)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idXsStatus}(clsStudentInfoBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.studentNumber) == false && GetStrLen(pobjStudentInfoEN.studentNumber) > 20)
{
 throw new Error(`(errid:Watl000413)字段[学籍号(studentNumber)]的长度不能超过20(In 学生(StudentInfo))!值:${pobjStudentInfoEN.studentNumber}(clsStudentInfoBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.idSchool) == false && GetStrLen(pobjStudentInfoEN.idSchool) > 4)
{
 throw new Error(`(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idSchool}(clsStudentInfoBL:CheckPropertyNew)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.userTypeId) == false && GetStrLen(pobjStudentInfoEN.userTypeId) > 2)
{
 throw new Error(`(errid:Watl000413)字段[用户类型Id(userTypeId)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.userTypeId}(clsStudentInfoBL:CheckPropertyNew)`);
}
...
{
 throw new Error(`(errid:Watl000414)字段[入学年级流水号(idGradeBase)]的值:[${pobjStudentInfoEN.idGradeBase}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.idXsStatus) == false && undefined !== pobjStudentInfoEN.idXsStatus && tzDataType.isString(pobjStudentInfoEN.idXsStatus) === false)
{
 throw new Error(`(errid:Watl000414)字段[学生状态流水号(idXsStatus)]的值:[${pobjStudentInfoEN.idXsStatus}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.studentNumber) == false && undefined !== pobjStudentInfoEN.studentNumber && tzDataType.isString(pobjStudentInfoEN.studentNumber) === false)
{
 throw new Error(`(errid:Watl000414)字段[学籍号(studentNumber)]的值:[${pobjStudentInfoEN.studentNumber}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.idSchool) == false && undefined !== pobjStudentInfoEN.idSchool && tzDataType.isString(pobjStudentInfoEN.idSchool) === false)
{
 throw new Error(`(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjStudentInfoEN.idSchool}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.userTypeId) == false && undefined !== pobjStudentInfoEN.userTypeId && tzDataType.isString(pobjStudentInfoEN.userTypeId) === false)
{
 throw new Error(`(errid:Watl000414)字段[用户类型Id(userTypeId)]的值:[${pobjStudentInfoEN.userTypeId}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`);
}
...
if (IsNullOrEmpty(pobjStudentInfoEN.idGradeBase) == false && GetStrLen(pobjStudentInfoEN.idGradeBase) > 4)
{
 throw new Error(`(errid:Watl000416)字段[入学年级流水号(idGradeBase)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idGradeBase}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false && GetStrLen(pobjStudentInfoEN.idGrade) > 2)
{
 throw new Error(`(errid:Watl000416)字段[年级流水号(idGrade)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idGrade}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idXsStatus) == false && GetStrLen(pobjStudentInfoEN.idXsStatus) > 2)
{
 throw new Error(`(errid:Watl000416)字段[学生状态流水号(idXsStatus)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idXsStatus}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idAdminCls) == false && GetStrLen(pobjStudentInfoEN.idAdminCls) > 8)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.studentNumber) == false && GetStrLen(pobjStudentInfoEN.studentNumber) > 20)
{
 throw new Error(`(errid:Watl000416)字段[学籍号(studentNumber)]的长度不能超过20(In 学生(StudentInfo))!值:${pobjStudentInfoEN.studentNumber}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.cardNo) == false && GetStrLen(pobjStudentInfoEN.cardNo) > 18)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.idSchool) == false && GetStrLen(pobjStudentInfoEN.idSchool) > 4)
{
 throw new Error(`(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.idSchool}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.userId) == false && GetStrLen(pobjStudentInfoEN.userId) > 18)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.userTypeId) == false && GetStrLen(pobjStudentInfoEN.userTypeId) > 2)
{
 throw new Error(`(errid:Watl000416)字段[用户类型Id(userTypeId)]的长度不能超过2(In 学生(StudentInfo))!值:${pobjStudentInfoEN.userTypeId}(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.userType) == false && GetStrLen(pobjStudentInfoEN.userType) > 50)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.idGradeBase) == false && undefined !== pobjStudentInfoEN.idGradeBase && tzDataType.isString(pobjStudentInfoEN.idGradeBase) === false)
{
 throw new Error(`(errid:Watl000417)字段[入学年级流水号(idGradeBase)]的值:[${pobjStudentInfoEN.idGradeBase}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false && undefined !== pobjStudentInfoEN.idGrade && tzDataType.isString(pobjStudentInfoEN.idGrade) === false)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.idXsStatus) == false && undefined !== pobjStudentInfoEN.idXsStatus && tzDataType.isString(pobjStudentInfoEN.idXsStatus) === false)
{
 throw new Error(`(errid:Watl000417)字段[学生状态流水号(idXsStatus)]的值:[${pobjStudentInfoEN.idXsStatus}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.idAdminCls) == false && undefined !== pobjStudentInfoEN.idAdminCls && tzDataType.isString(pobjStudentInfoEN.idAdminCls) === false)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.studentNumber) == false && undefined !== pobjStudentInfoEN.studentNumber && tzDataType.isString(pobjStudentInfoEN.studentNumber) === false)
{
 throw new Error(`(errid:Watl000417)字段[学籍号(studentNumber)]的值:[${pobjStudentInfoEN.studentNumber}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.cardNo) == false && undefined !== pobjStudentInfoEN.cardNo && tzDataType.isString(pobjStudentInfoEN.cardNo) === false)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.idSchool) == false && undefined !== pobjStudentInfoEN.idSchool && tzDataType.isString(pobjStudentInfoEN.idSchool) === false)
{
 throw new Error(`(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjStudentInfoEN.idSchool}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.userId) == false && undefined !== pobjStudentInfoEN.userId && tzDataType.isString(pobjStudentInfoEN.userId) === false)
{
...
if (IsNullOrEmpty(pobjStudentInfoEN.userTypeId) == false && undefined !== pobjStudentInfoEN.userTypeId && tzDataType.isString(pobjStudentInfoEN.userTypeId) === false)
{
 throw new Error(`(errid:Watl000417)字段[用户类型Id(userTypeId)]的值:[${pobjStudentInfoEN.userTypeId}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`);
}
if (IsNullOrEmpty(pobjStudentInfoEN.userType) == false && undefined !== pobjStudentInfoEN.userType && tzDataType.isString(pobjStudentInfoEN.userType) === false)
{
...
if (Object.prototype.hasOwnProperty.call(objStudentInfoCond.dicFldComparisonOp, clsStudentInfoEN.con_IdXsStatus) == true)
{
const strComparisonOpIdXsStatus:string = objStudentInfoCond.dicFldComparisonOp[clsStudentInfoEN.con_IdXsStatus];
strWhereCond += Format(" And {0} {2} '{1}'", clsStudentInfoEN.con_IdXsStatus, objStudentInfoCond.idXsStatus, strComparisonOpIdXsStatus);
}
...
if (Object.prototype.hasOwnProperty.call(objStudentInfoCond.dicFldComparisonOp, clsStudentInfoEN.con_StudentNumber) == true)
{
const strComparisonOpStudentNumber:string = objStudentInfoCond.dicFldComparisonOp[clsStudentInfoEN.con_StudentNumber];
strWhereCond += Format(" And {0} {2} '{1}'", clsStudentInfoEN.con_StudentNumber, objStudentInfoCond.studentNumber, strComparisonOpStudentNumber);
}
...
if (Object.prototype.hasOwnProperty.call(objStudentInfoCond.dicFldComparisonOp, clsStudentInfoEN.con_IdSchool) == true)
{
const strComparisonOpIdSchool:string = objStudentInfoCond.dicFldComparisonOp[clsStudentInfoEN.con_IdSchool];
strWhereCond += Format(" And {0} {2} '{1}'", clsStudentInfoEN.con_IdSchool, objStudentInfoCond.idSchool, strComparisonOpIdSchool);
}
...
if (Object.prototype.hasOwnProperty.call(objStudentInfoCond.dicFldComparisonOp, clsStudentInfoEN.con_UserTypeId) == true)
{
const strComparisonOpUserTypeId:string = objStudentInfoCond.dicFldComparisonOp[clsStudentInfoEN.con_UserTypeId];
strWhereCond += Format(" And {0} {2} '{1}'", clsStudentInfoEN.con_UserTypeId, objStudentInfoCond.userTypeId, strComparisonOpUserTypeId);
}
