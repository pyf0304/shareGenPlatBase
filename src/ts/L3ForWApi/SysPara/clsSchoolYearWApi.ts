...
if (objSchoolYearCond.sfFldComparisonOp == null || objSchoolYearCond.sfFldComparisonOp == "") return arrSchoolYearSel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolYearCond.sfFldComparisonOp);
...
let arrSchoolYearSel = arrSchoolYearObjLstCache;
if (objSchoolYearCond.sfFldComparisonOp == null || objSchoolYearCond.sfFldComparisonOp == "") return arrSchoolYearSel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolYearCond.sfFldComparisonOp);
//console.log("clsSchoolYearWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
let arrSchoolYearSel = arrSchoolYearObjLstCache;
if (objSchoolYearCond.sfFldComparisonOp == null || objSchoolYearCond.sfFldComparisonOp == "") return arrSchoolYearSel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolYearCond.sfFldComparisonOp);
//console.log("clsSchoolYearWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
