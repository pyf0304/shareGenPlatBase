 ...
 * @returns 对象
 **/
export async function vStudentInfo_Sim_GetObjByIdStudentInfoAsync(
  strIdStudentInfo: string,
): Promise<clsvStudentInfo_SimEN | null> {
  const strThisFuncName = 'GetObjByIdStudentInfoAsync';

  if (IsNullOrEmpty(strIdStudentInfo) == true) {
    const strMsg = Format(
      '参数:[strIdStudentInfo]不能为空!(In clsvStudentInfo_SimWApi.GetObjByIdStudentInfoAsync)',
    );
  ...
  if (strIdStudentInfo.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdStudentInfo]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.GetObjByIdStudentInfoAsync)',
  ...
  try {
    ...
    if (error.statusText == 'error') {
      const strInfo = Format(
        ...
        strUrl,
        vStudentInfo_Sim_ConstructorName,
        strThisFuncName,
      );
...
export async function vStudentInfo_Sim_GetObjByIdStudentInfolocalStorage(strIdStudentInfo: string) {
  ...
  if (IsNullOrEmpty(strIdStudentInfo) == true) {
    const strMsg = Format(
      '参数:[strIdStudentInfo]不能为空!(In clsvStudentInfo_SimWApi.GetObjByIdStudentInfolocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStudentInfo.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdStudentInfo]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.GetObjByIdStudentInfolocalStorage)',
      strIdStudentInfo.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function vStudentInfo_Sim_GetObjByIdStudentInfoCache(
  strIdStudentInfo: string,
  ...
  if (IsNullOrEmpty(strIdStudentInfo) == true) {
    const strMsg = Format(
      '参数:[strIdStudentInfo]不能为空!(In clsvStudentInfo_SimWApi.GetObjByIdStudentInfoCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStudentInfo.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdStudentInfo]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.GetObjByIdStudentInfoCache)',
      strIdStudentInfo.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrvStudentInfo_SimSel = arrvStudentInfo_SimObjLstCache.filter(
    ...
    if (arrvStudentInfo_SimSel.length > 0) {
      ...
      if (bolTryAsyncOnce == true) {
        const objvStudentInfo_SimConst =
          await vStudentInfo_Sim_GetObjByIdStudentInfoAsync(strIdStudentInfo);
 ...
 * @returns 返回两个对象比较的结果
 */
export function vStudentInfo_Sim_SortFunDefa(
  a: clsvStudentInfo_SimEN,
  b: clsvStudentInfo_SimEN,
): number {
 ...
 * @returns 返回两个对象比较的结果
 */
export function vStudentInfo_Sim_SortFunDefa2Fld(
  a: clsvStudentInfo_SimEN,
  b: clsvStudentInfo_SimEN,
): number {
 ...
 * @returns 对象
 */
export async function vStudentInfo_Sim_GetNameByIdStudentInfoCache(
  strIdStudentInfo: string,
  strIdCurrEduCls: string,
) {
  if (IsNullOrEmpty(strIdStudentInfo) == true) {
    const strMsg = Format(
      '参数:[strIdStudentInfo]不能为空!(In clsvStudentInfo_SimWApi.GetNameByIdStudentInfoCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStudentInfo.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdStudentInfo]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.GetNameByIdStudentInfoCache)',
      strIdStudentInfo.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
*/
export async function vStudentInfo_Sim_func(
  strInFldName: string,
  ...
  if (IsNullOrEmpty(strIdCurrEduClsClassfy) == true) {
    const strMsg = Format(
      '参数:[strIdCurrEduClsClassfy]不能为空!(In clsvStudentInfo_SimWApi.func)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdCurrEduClsClassfy.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdCurrEduClsClassfy]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.func)',
  ...
  if (clsvStudentInfo_SimEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsvStudentInfo_SimEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
  ...
  const objvStudentInfo_Sim = await vStudentInfo_Sim_GetObjByIdStudentInfoCache(
    strIdStudentInfo,
 ...
 * @returns 返回一个关键字值列表
*/
export async function vStudentInfo_Sim_funcKey(
  strInFldName: string,
  strInValue: any,
  ...
  if (IsNullOrEmpty(strIdCurrEduClsClassfy) == true) {
    const strMsg = Format(
      '参数:[strIdCurrEduClsClassfy]不能为空!(In clsvStudentInfo_SimWApi.funcKey)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdCurrEduClsClassfy.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdCurrEduClsClassfy]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.funcKey)',
      strIdCurrEduClsClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.filter(
 ...
 **/
export async function vStudentInfo_Sim_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function vStudentInfo_Sim_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsvStudentInfo_SimEN | null> {
...
export async function vStudentInfo_Sim_GetObjLstClientCache(strIdCurrEduCls: string) {
  ...
  if (CacheHelper.Exsits(strKey)) {
    ...
    const arrvStudentInfo_SimObjLstT = vStudentInfo_Sim_GetObjLstByJSONObjLst(
      arrvStudentInfo_SimExObjLstCache,
    );
  ...
  try {
    ...
    const strInfo = Format(
      ...
      strKey,
      arrvStudentInfo_SimExObjLst.length,
    );
    console.log(strInfo);
...
export async function vStudentInfo_Sim_GetObjLstlocalStorage(strIdCurrEduCls: string) {
  ...
  if (Object.prototype.hasOwnProperty.call(localStorage, strKey)) {
    ...
    const arrvStudentInfo_SimExObjLstCache: Array<clsvStudentInfo_SimEN> =
 ...
 * @returns 获取的相应对象列表
 **/
export async function vStudentInfo_Sim_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsvStudentInfo_SimEN>> {
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vStudentInfo_Sim_GetObjLstCache(
  strIdCurrEduCls: string,
): Promise<Array<clsvStudentInfo_SimEN>> {
  ...
  if (IsNullOrEmpty(strIdCurrEduCls) == true) {
    const strMsg = Format(
      '参数:[strIdCurrEduCls]不能为空！(In clsvStudentInfo_SimWApi.vStudentInfo_Sim_GetObjLstCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdCurrEduCls.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdCurrEduCls]的长度:[{0}]不正确！(clsvStudentInfo_SimWApi.vStudentInfo_Sim_GetObjLstCache)',
  ...
  switch (clsvStudentInfo_SimEN.CacheModeId) {
    case '04': //sessionStorage
      arrvStudentInfo_SimObjLstCache =
        await vStudentInfo_Sim_GetObjLstsessionStorage(strIdCurrEduCls);
      break;
    case '03': //localStorage
      arrvStudentInfo_SimObjLstCache =
        await vStudentInfo_Sim_GetObjLstlocalStorage(strIdCurrEduCls);
      break;
    case '02': //ClientCache
...
export async function vStudentInfo_Sim_GetObjLstPureCache(strIdCurrEduCls: string) {
  ...
  switch (clsvStudentInfo_SimEN.CacheModeId) {
    case '04': //sessionStorage
      arrvStudentInfo_SimObjLstCache =
        await vStudentInfo_Sim_GetObjLstsessionStoragePureCache(strIdCurrEduCls);
      break;
    case '03': //localStorage
      arrvStudentInfo_SimObjLstCache =
        await vStudentInfo_Sim_GetObjLstlocalStoragePureCache(strIdCurrEduCls);
      break;
    case '02': //ClientCache
 ...
 * @returns 对象列表子集
 */
export async function vStudentInfo_Sim_GetSubObjLstCache(
  objvStudentInfo_SimCond: clsvStudentInfo_SimEN,
  strIdCurrEduCls: string,
) {
  ...
  if (
    objvStudentInfo_SimCond.sfFldComparisonOp == null ||
    objvStudentInfo_SimCond.sfFldComparisonOp == ''
  )
    return arrvStudentInfo_SimSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvStudentInfo_SimCond.sfFldComparisonOp,
  );
  //console.log("clsvStudentInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    const sstrKeys = GetObjKeys(objvStudentInfo_SimCond);
    //console.log(sstrKeys);
    for (const strKey of sstrKeys) {
      if (Object.prototype.hasOwnProperty.call(dicFldComparisonOp, strKey) == false) continue;
      arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.filter((x) => x.GetFldValue(strKey) != null);
      const strComparisonOp = dicFldComparisonOp[strKey];
      const strValue = objvStudentInfo_SimCond.GetFldValue(strKey);
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objvStudentInfo_SimCond),
      vStudentInfo_Sim_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function vStudentInfo_Sim_GetObjLstByIdStudentInfoLstAsync(
 ...
 * @returns 对象列表
 */
export async function vStudentInfo_Sim_GetObjLstByIdStudentInfoLstCache(
 ...
 * @returns 获取的相应对象列表
 **/
export async function vStudentInfo_Sim_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vStudentInfo_Sim_GetObjLstByRangeAsync(
 ...
 * @returns 对象列表
 */
export async function vStudentInfo_Sim_GetObjLstByPagerCache(
  objPagerPara: stuPagerPara,
  strIdCurrEduCls: string,
) {
  const strThisFuncName = 'GetObjLstByPagerCache';
  if (objPagerPara.pageIndex == 0) return new Array<clsvStudentInfo_SimEN>();
  const arrvStudentInfo_SimObjLstCache = await vStudentInfo_Sim_GetObjLstCache(strIdCurrEduCls);
  if (arrvStudentInfo_SimObjLstCache.length == 0) return arrvStudentInfo_SimObjLstCache;
  let arrvStudentInfo_SimSel = arrvStudentInfo_SimObjLstCache;
  const objCond = JSON.parse(objPagerPara.whereCond);
  const objvStudentInfo_SimCond = new clsvStudentInfo_SimEN();
  ObjectAssign(objvStudentInfo_SimCond, objCond);
  let dicFldComparisonOp: { [index: string]: string } = {};
  if (objCond.sfFldComparisonOp != '') {
    dicFldComparisonOp = JSON.parse(objCond.sfFldComparisonOp);
  }
  //console.log("clsvStudentInfo_SimWApi->GetObjLstByPagerCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    ...
    if (arrvStudentInfo_SimSel.length == 0) return arrvStudentInfo_SimSel;
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.sort(
        vStudentInfo_Sim_SortFunByKey(strSortFld, strSortType),
      );
    } else {
      //如果排序字段名[OrderBy]为空,就调用排序函数
      arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.sort(objPagerPara.sortFun);
    }
    arrvStudentInfo_SimSel = arrvStudentInfo_SimSel.slice(intStart, intEnd);
    return arrvStudentInfo_SimSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vStudentInfo_Sim_GetObjLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsvStudentInfo_SimEN>> {
 ...
 * @returns 对象列表子集
 */
export async function vStudentInfo_Sim_IsExistRecordCache(
  objvStudentInfo_SimCond: clsvStudentInfo_SimEN,
  strIdCurrEduCls: string,
) {
  ...
  if (
    ...
    return arrvStudentInfo_SimSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvStudentInfo_SimCond.sfFldComparisonOp,
  );
  //console.log("clsvStudentInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @returns 对象
 */
export async function vStudentInfo_Sim_IsExistCache(
  strIdStudentInfo: string,
  strIdCurrEduCls: string,
) {
 ...
 * @returns 获取某一条件的记录数
 **/
export async function vStudentInfo_Sim_GetRecCountByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 对象列表记录数
 */
export async function vStudentInfo_Sim_GetRecCountByCondCache(
  objvStudentInfo_SimCond: clsvStudentInfo_SimEN,
  strIdCurrEduCls: string,
) {
...
export function vStudentInfo_Sim_ReFreshThisCache(strIdCurrEduCls: string): void {
  if (IsNullOrEmpty(strIdCurrEduCls) == true) {
    const strMsg = Format(
      '参数:[strIdCurrEduCls]不能为空!(In clsvStudentInfo_SimWApi.vStudentInfo_Sim_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdCurrEduCls.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdCurrEduCls]的长度:[{0}]不正确!(clsvStudentInfo_SimWApi.vStudentInfo_Sim_ReFreshThisCache)',
      strIdCurrEduCls.length,
    );
    console.error(strMsg);
    throw strMsg;
...
*/
export async function vStudentInfo_Sim_BindDdl_IdStudentInfoInDivCache(
  ...
  if (IsNullOrEmpty(strIdCurrEduCls) == true) {
    const strMsg = Format(
      '参数:[strIdCurrEduCls]不能为空！(In clsvStudentInfo_SimWApi.BindDdl_IdStudentInfoInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdCurrEduCls.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdCurrEduCls]的长度:[{0}]不正确！(clsvStudentInfo_SimWApi.BindDdl_IdStudentInfoInDiv)',
      strIdCurrEduCls.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个生成的对象
 */
export function vStudentInfo_Sim_GetJSONStrByObj(
  pobjvStudentInfo_SimEN: clsvStudentInfo_SimEN,
): string {
  let strJson = '';
  try {
 ...
 * @returns 返回一个生成的对象列表
 */
export function vStudentInfo_Sim_GetObjLstByJSONObjLst(
  arrvStudentInfo_SimObjLstS: Array<clsvStudentInfo_SimEN>,
): Array<clsvStudentInfo_SimEN> {
 ...
 */
export function vStudentInfo_Sim_GetCombineCondition(
  objvStudentInfo_SimCond: clsvStudentInfo_SimEN,
): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_IdStudentInfo,
    ) == true
  ) {
    const strComparisonOpIdStudentInfo: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdStudentInfo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdStudentInfo,
      objvStudentInfo_SimCond.idStudentInfo,
  ...
  if (
    ...
    const strComparisonOpStuId: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_StuId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_StuId,
      objvStudentInfo_SimCond.stuId,
  ...
  if (
    ...
    const strComparisonOpStuName: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_StuName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_StuName,
      objvStudentInfo_SimCond.stuName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_IdSex,
    ) == true
  ) {
    const strComparisonOpIdSex: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdSex];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdSex,
      objvStudentInfo_SimCond.idSex,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_IdPolitics,
    ) == true
  ) {
    const strComparisonOpIdPolitics: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdPolitics];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdPolitics,
      objvStudentInfo_SimCond.idPolitics,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_IdStuType,
    ) == true
  ) {
    const strComparisonOpIdStuType: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdStuType];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdStuType,
      objvStudentInfo_SimCond.idStuType,
  ...
  if (
    ...
    const strComparisonOpIdGrade: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdGrade,
      objvStudentInfo_SimCond.idGrade,
  ...
  if (
    ...
    const strComparisonOpIdGradeBase: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdGradeBase];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdGradeBase,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_IdXzMajor,
    ) == true
  ) {
    const strComparisonOpIdXzMajor: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdXzMajor];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdXzMajor,
      objvStudentInfo_SimCond.id_XzMajor,
  ...
  if (
    ...
    const strComparisonOpIdXzCollege: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_Id_XzCollege,
  ...
  if (
    ...
    const strComparisonOpIdAdminCls: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_IdAdminCls];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_IdAdminCls,
      objvStudentInfo_SimCond.idAdminCls,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvStudentInfo_SimCond.dicFldComparisonOp,
      clsvStudentInfo_SimEN.con_UserId,
    ) == true
  ) {
    const strComparisonOpUserId: string =
      objvStudentInfo_SimCond.dicFldComparisonOp[clsvStudentInfo_SimEN.con_UserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvStudentInfo_SimEN.con_UserId,
      objvStudentInfo_SimCond.userId,
 ...
 */
export function vStudentInfo_Sim_CopyObjTo(
  objvStudentInfo_SimENS: clsvStudentInfo_SimEN,
  objvStudentInfo_SimENT: clsvStudentInfo_SimEN,
): void {
 ...
 * @param objvStudentInfo_SimENT:目标对象
 */
export function vStudentInfo_Sim_GetObjFromJsonObj(
  objvStudentInfo_SimENS: clsvStudentInfo_SimEN,
): clsvStudentInfo_SimEN {
