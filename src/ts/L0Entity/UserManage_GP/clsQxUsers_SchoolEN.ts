...
public static readonly _CurrTabName: string = "QxUsers_School"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "UserId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 10;
public static readonly _AttributeName = ["userId", "identityId", "cardNo", "stuTeacherId", "cardState", "id_GradeBase", "isLeaved", "updDate", "updUser", "memo"];
//以下是属性变量
