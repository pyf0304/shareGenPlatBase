...
if (objXzUniZoneCond.sfFldComparisonOp == null || objXzUniZoneCond.sfFldComparisonOp == "") return arrXzUniZoneSel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objXzUniZoneCond.sfFldComparisonOp);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, xzUniZone_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsXzUniZoneEN>();
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function XzUniZone_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsXzUniZoneEN>>  
{
...
let arrXzUniZoneSel = arrXzUniZoneObjLstCache;
if (objXzUniZoneCond.sfFldComparisonOp == null || objXzUniZoneCond.sfFldComparisonOp == "") return arrXzUniZoneSel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objXzUniZoneCond.sfFldComparisonOp);
//console.log("clsXzUniZoneWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
let arrXzUniZoneSel = arrXzUniZoneObjLstCache;
if (objXzUniZoneCond.sfFldComparisonOp == null || objXzUniZoneCond.sfFldComparisonOp == "") return arrXzUniZoneSel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objXzUniZoneCond.sfFldComparisonOp);
//console.log("clsXzUniZoneWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
