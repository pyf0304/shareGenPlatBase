 ...
 **/
export async function XzGradeBase_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 **/
export async function XzGradeBase_AddNewObjSave(
  objXzGradeBaseEN: clsXzGradeBaseEN,
 ...
 **/
export async function XzGradeBase_UpdateObjSave(
  objXzGradeBaseEN: clsXzGradeBaseEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function XzGradeBase_EditRecordExAsync(
  objXzGradeBaseEN: clsXzGradeBaseEN,
): Promise<boolean> {
 ...
 * @param bolIsVisible:
*/
export async function XzGradeBase_BindDdl_IdGradeBaseByIsVisibleInDivCache(
  ...
  if (objDdl == null) {
    const strMsg = Format(
      '下拉框：{0} 不存在!(In BindDdl_IdGradeBaseByIsVisibleInDiv)',
      strDdlName,
    );
    alert(strMsg);
    console.error(strMsg);
...
export function XzGradeBase_CheckPropertyNew(pobjXzGradeBaseEN: clsXzGradeBaseEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000413)字段[学段流水号(idStudyLevel)]的长度不能超过4(In 年级(XzGradeBase))!值:${pobjXzGradeBaseEN.idStudyLevel}(clsXzGradeBaseBL:CheckPropertyNew)`,
    );
  }
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000414)字段[学段流水号(idStudyLevel)]的值:[${pobjXzGradeBaseEN.idStudyLevel}], 非法,应该为字符型(In 年级(XzGradeBase))!(clsXzGradeBaseBL:CheckPropertyNew0)`,
    );
  }
  if (
...
export function XzGradeBase_CheckProperty4Update(pobjXzGradeBaseEN: clsXzGradeBaseEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学段流水号(idStudyLevel)]的长度不能超过4(In 年级(XzGradeBase))!值:${pobjXzGradeBaseEN.idStudyLevel}(clsXzGradeBaseBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjXzGradeBaseEN.memo) == false && GetStrLen(pobjXzGradeBaseEN.memo) > 1000) {
    throw new Error(
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学段流水号(idStudyLevel)]的值:[${pobjXzGradeBaseEN.idStudyLevel}], 非法,应该为字符型(In 年级(XzGradeBase))!(clsXzGradeBaseBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjXzGradeBaseEN.isVisible &&
