...
if (objSchoolTypeCond.sfFldComparisonOp == null || objSchoolTypeCond.sfFldComparisonOp == "") return arrSchoolTypeSel;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTypeCond.sfFldComparisonOp);
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, schoolType_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return new Array<clsSchoolTypeEN>();
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function SchoolType_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsSchoolTypeEN>>  
{
...
let arrSchoolTypeSel = arrSchoolTypeObjLstCache;
if (objSchoolTypeCond.sfFldComparisonOp == null || objSchoolTypeCond.sfFldComparisonOp == "") return arrSchoolTypeSel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTypeCond.sfFldComparisonOp);
//console.log("clsSchoolTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
let arrSchoolTypeSel = arrSchoolTypeObjLstCache;
if (objSchoolTypeCond.sfFldComparisonOp == null || objSchoolTypeCond.sfFldComparisonOp == "") return arrSchoolTypeSel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSchoolTypeCond.sfFldComparisonOp);
//console.log("clsSchoolTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
