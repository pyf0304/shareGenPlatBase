<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
    ...
    <template #footer>
      <el-button id="btnCancelQxRolesV2" @click="dialogVisible = false">{{
        strCancelButtonText
      }}</el-button>
      <el-button id="btnSubmitQxRolesV2" type="primary" @click="btnSubmit_Click">{{
        strSubmitButtonText
      }}</el-button>
    </template>
  </el-dialog>
              ...
              if (['02', '03', '06'].indexOf(clsQxRolesV2EN._PrimaryTypeId) > -1) {
                ...
                if (returnKeyId != 0) {
                  ...
                  if (objPage_Edit.value.iShowList != null)
                    objPage_Edit.value.iShowList.BindGvCache(clsQxRolesV2EN._CurrTabName, '');
                }
              } else {
