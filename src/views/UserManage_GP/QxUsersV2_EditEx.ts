/**
 * 类名:QxUsersV2_EditEx(界面:QxUsersV2CRUD,00140038)
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: QxUsersV2_EditEx = <QxUsersV2_EditEx>(
      QxUsersV2_Edit.GetPageEditObj('QxUsersV2_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[QxUsersV2_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
