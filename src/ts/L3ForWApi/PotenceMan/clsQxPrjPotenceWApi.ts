...
import { qxPrjPotenceCache, isFuncMapCache } from '@/viewsShare/PotenceMan/QxPrjPotenceVueShare';
...
import { QxFuncModule_func } from '@/ts/L3ForWApi/PrjManage_GP/clsQxFuncModuleWApi';
import { clsQxFuncModuleEN } from '@/ts/L0Entity/PrjManage_GP/clsQxFuncModuleEN';
import { QxPotenceType_func } from '@/ts/L3ForWApi/PotenceMan/clsQxPotenceTypeWApi';
 ...
 * @returns 对象
 **/
export async function QxPrjPotence_GetObjByPotenceIdAsync(
  strPotenceId: string,
): Promise<clsQxPrjPotenceEN | null> {
  const strThisFuncName = 'GetObjByPotenceIdAsync';

  if (IsNullOrEmpty(strPotenceId) == true) {
    const strMsg = Format(
      '参数:[strPotenceId]不能为空!(In clsQxPrjPotenceWApi.GetObjByPotenceIdAsync)',
    );
  ...
  if (strPotenceId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strPotenceId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.GetObjByPotenceIdAsync)',
      strPotenceId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function QxPrjPotence_GetObjByPotenceIdlocalStorage(strPotenceId: string) {
  ...
  if (IsNullOrEmpty(strPotenceId) == true) {
    const strMsg = Format(
      '参数:[strPotenceId]不能为空!(In clsQxPrjPotenceWApi.GetObjByPotenceIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strPotenceId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strPotenceId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.GetObjByPotenceIdlocalStorage)',
      strPotenceId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function QxPrjPotence_GetObjByPotenceIdCache(
  strPotenceId: string,
  strQxPrjId: string,
  ...
  if (IsNullOrEmpty(strPotenceId) == true) {
    const strMsg = Format(
      '参数:[strPotenceId]不能为空!(In clsQxPrjPotenceWApi.GetObjByPotenceIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strPotenceId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strPotenceId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.GetObjByPotenceIdCache)',
      strPotenceId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrQxPrjPotenceSel = arrQxPrjPotenceObjLstCache.filter(
      (x) => x.potenceId == strPotenceId,
    );
 ...
 * @returns 对象
 */
export async function QxPrjPotence_UpdateObjInLstCache(
  objQxPrjPotence: clsQxPrjPotenceEN,
  strQxPrjId: string,
) {
  const strThisFuncName = 'UpdateObjInLstCache';
  try {
    const arrQxPrjPotenceObjLstCache = await QxPrjPotence_GetObjLstCache(strQxPrjId);
    const obj = arrQxPrjPotenceObjLstCache.find(
      (x) =>
        x.potenceTypeId == objQxPrjPotence.potenceTypeId &&
        x.potenceName == objQxPrjPotence.potenceName,
    );
    if (obj != null) {
 ...
 * @returns 对象
 */
export async function QxPrjPotence_GetNameByPotenceIdCache(
  strPotenceId: string,
  strQxPrjId: string,
) {
  if (IsNullOrEmpty(strPotenceId) == true) {
    const strMsg = Format(
      '参数:[strPotenceId]不能为空!(In clsQxPrjPotenceWApi.GetNameByPotenceIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strPotenceId.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strPotenceId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.GetNameByPotenceIdCache)',
      strPotenceId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
*/
export async function QxPrjPotence_func(
  strInFldName: string,
  ...
  if (strQxPrjIdClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjIdClassfy]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.func)',
  ...
  if (clsQxPrjPotenceEN.AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      ...
      strOutFldName,
      clsQxPrjPotenceEN.AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
  ...
  const objQxPrjPotence = await QxPrjPotence_GetObjByPotenceIdCache(
    strPotenceId,
    strQxPrjIdClassfy,
  );
 ...
 * @returns 返回一个关键字值列表
*/
export async function QxPrjPotence_funcKey(
  strInFldName: string,
  strInValue: any,
  ...
  if (strQxPrjIdClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjIdClassfy]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.funcKey)',
      strQxPrjIdClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 **/
export async function QxPrjPotence_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function QxPrjPotence_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsQxPrjPotenceEN | null> {
...
export async function QxPrjPotence_GetObjLstClientCache(strQxPrjId: string) {
  ...
  try {
    ...
    const strInfo = Format(
      ...
      strKey,
      arrQxPrjPotenceExObjLst.length,
    );
    console.log(strInfo);
 ...
 * @returns 获取的相应对象列表
 **/
export async function QxPrjPotence_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsQxPrjPotenceEN>> {
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function QxPrjPotence_GetObjLstCache(
  strQxPrjId: string,
): Promise<Array<clsQxPrjPotenceEN>> {
  ...
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空！(In clsQxPrjPotenceWApi.QxPrjPotence_GetObjLstCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxPrjPotenceWApi.QxPrjPotence_GetObjLstCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象列表子集
 */
export async function QxPrjPotence_GetSubObjLstCache(
  objQxPrjPotenceCond: ConditionCollection,
  strQxPrjId: string,
) {
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objQxPrjPotenceCond),
      qxPrjPotence_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function QxPrjPotence_GetObjLstByPotenceIdLstAsync(
  arrPotenceId: Array<string>,
): Promise<Array<clsQxPrjPotenceEN>> {
 ...
 * @returns 对象列表
 */
export async function QxPrjPotence_GetObjLstByPotenceIdLstCache(
  arrPotenceIdLst: Array<string>,
  strQxPrjId: string,
) {
  ...
  try {
    const arrQxPrjPotenceObjLstCache = await QxPrjPotence_GetObjLstCache(strQxPrjId);
    const arrQxPrjPotenceSel = arrQxPrjPotenceObjLstCache.filter(
      (x) => arrPotenceIdLst.indexOf(x.potenceId) > -1,
    );
    return arrQxPrjPotenceSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function QxPrjPotence_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QxPrjPotence_GetObjLstByRangeAsync(
 ...
 * @returns 对象列表
 */
export async function QxPrjPotence_GetObjLstByPagerCache(
  ...
  try {
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrQxPrjPotenceSel = arrQxPrjPotenceSel.sort(
        QxPrjPotence_SortFunByKey(strSortFld, strSortType),
      );
    } else {
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function QxPrjPotence_GetObjLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsQxPrjPotenceEN>> {
 ...
 * @returns 实际删除记录的个数
 **/
export async function QxPrjPotence_DelQxPrjPotencesAsync(
  arrPotenceId: Array<string>,
): Promise<number> {
 ...
 * @returns 对象列表
 */
export async function QxPrjPotence_GetObjExLstByPagerCache(
  objPagerPara: stuPagerPara,
  strQxPrjId: string,
  ...
  const arrNewObj = new Array<clsQxPrjPotenceENEx>();
  const arrQxPrjPotenceExObjLst = arrQxPrjPotenceObjLst.map((obj) => {
    const cacheKey = `${obj.potenceId}_${obj.qxPrjId}`;
    if (qxPrjPotenceCache[cacheKey]) {
      const oldObj = qxPrjPotenceCache[cacheKey];
      return oldObj;
    } else {
      const newObj = QxPrjPotence_CopyToEx(obj);
      arrNewObj.push(newObj);
      qxPrjPotenceCache[cacheKey] = newObj;
      return newObj;
    }
  });
  for (const newObj of arrNewObj) {
    for (const strFldName of Object.keys(isFuncMapCache)) {
      await QxPrjPotence_FuncMapByFldName(strFldName, newObj);
    }
  }
  ...
  if (
    ...
    for (const newObj of arrQxPrjPotenceExObjLst) {
      await QxPrjPotence_FuncMapByFldName(objSortInfo.SortFld, newObj);
      const cacheKey = `${newObj.potenceId}_${newObj.qxPrjId}`;
      qxPrjPotenceCache[cacheKey] = newObj;
    }
  ...
  try {
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      arrQxPrjPotenceSel = arrQxPrjPotenceSel.sort(
        QxPrjPotence_SortFunByExKey(objSortInfo.SortFld, objSortInfo.SortType),
      );
    } else {
      //如果排序字段名[OrderBy]为空,就调用排序函数
      arrQxPrjPotenceSel = arrQxPrjPotenceSel.sort(objPagerPara.sortFun);
 ...
 **/
export function QxPrjPotence_CopyToEx(objQxPrjPotenceENS: clsQxPrjPotenceEN): clsQxPrjPotenceENEx {
  const strThisFuncName = QxPrjPotence_CopyToEx.name;
 ...
 */
export function QxPrjPotence_FuncMapByFldName(
  strFldName: string,
  objQxPrjPotenceEx: clsQxPrjPotenceENEx,
) {
  const strThisFuncName = QxPrjPotence_FuncMapByFldName.name;
  ...
  switch (strFldName) {
    case clsQxPrjPotenceENEx.con_FuncModuleName:
      return QxPrjPotence_FuncMapFuncModuleName(objQxPrjPotenceEx);
    case clsQxPrjPotenceENEx.con_PotenceTypeName:
      return QxPrjPotence_FuncMapPotenceTypeName(objQxPrjPotenceEx);
    case clsQxPrjPotenceENEx.con_DateTimeSim:
      return QxPrjPotence_FuncMapDateTimeSim(objQxPrjPotenceEx);
    case clsQxPrjPotenceENEx.con_MenuName:
      return QxPrjPotence_FuncMapMenuName(objQxPrjPotenceEx);
    default:
      strMsg = Format(
 ...
 * @returns 返回两个对象比较的结果
 */
export function QxPrjPotence_SortFunByExKey(strKey: string, AscOrDesc: string) {
  strKey = strKey.replace('|Ex', '');
  if (AscOrDesc == 'Asc' || AscOrDesc == '') {
    switch (strKey) {
      case clsQxPrjPotenceENEx.con_FuncModuleName:
        return (a: clsQxPrjPotenceENEx, b: clsQxPrjPotenceENEx) => {
          if (a.funcModuleName === null && b.funcModuleName === null) return 0;
 ...
 **/
export async function QxPrjPotence_FuncMapFuncModuleName(objQxPrjPotence: clsQxPrjPotenceENEx) {
  const strThisFuncName = QxPrjPotence_FuncMapFuncModuleName.name;
  try {
 ...
 * @param objQxPrjPotenceS:源对象
 **/
export async function QxPrjPotence_FuncMapPotenceTypeName(objQxPrjPotence: clsQxPrjPotenceENEx) {
  const strThisFuncName = QxPrjPotence_FuncMapPotenceTypeName.name;
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001495)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxPrjPotence_ConstructorName,
      strThisFuncName,
    );
 ...
 * @param objQxPrjPotenceS:源对象
 **/
export async function QxPrjPotence_FuncMapDateTimeSim(objQxPrjPotence: clsQxPrjPotenceENEx) {
  const strThisFuncName = QxPrjPotence_FuncMapDateTimeSim.name;
  try {
 ...
 * @param objQxPrjPotenceS:源对象
 **/
export async function QxPrjPotence_FuncMapMenuName(objQxPrjPotence: clsQxPrjPotenceENEx) {
  const strThisFuncName = QxPrjPotence_FuncMapMenuName.name;
  try {
    ...
    const strMsg = Format(
      '(errid:Watl001494)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxPrjPotence_ConstructorName,
      strThisFuncName,
    );
 ...
 * @returns 实际删除记录的个数
 **/
export async function QxPrjPotence_DelQxPrjPotencesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function QxPrjPotence_AddNewRecordAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function QxPrjPotence_AddNewRecordWithMaxIdAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<string> {
 ...
 **/
export async function QxPrjPotence_AddNewObjSave(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
 ...
 **/
export async function QxPrjPotence_CheckUniCond4Add(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
 ...
 **/
export async function QxPrjPotence_CheckUniCond4Update(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
 ...
 **/
export async function QxPrjPotence_UpdateObjSave(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function QxPrjPotence_AddNewRecordWithReturnKeyAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function QxPrjPotence_UpdateRecordAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objQxPrjPotenceEN.sfUpdFldSetStr === undefined ||
    objQxPrjPotenceEN.sfUpdFldSetStr === null ||
    objQxPrjPotenceEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function QxPrjPotence_EditRecordExAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function QxPrjPotence_UpdateWithConditionAsync(
  objQxPrjPotenceEN: clsQxPrjPotenceEN,
  strWhereCond: string,
): Promise<boolean> {
 ...
 * @returns 对象列表子集
 */
export async function QxPrjPotence_IsExistRecordCache(
  objQxPrjPotenceCond: ConditionCollection,
  strQxPrjId: string,
) {
  ...
  let arrQxPrjPotenceSel = arrQxPrjPotenceObjLstCache;
  if (objQxPrjPotenceCond.GetConditions().length == 0)
    return arrQxPrjPotenceSel.length > 0 ? true : false;
  try {
    for (const objCondition of objQxPrjPotenceCond.GetConditions()) {
      if (objCondition == null) continue;
      const strKey = objCondition.fldName;
 ...
 * @returns 对象列表记录数
 */
export async function QxPrjPotence_GetRecCountByCondCache(
  objQxPrjPotenceCond: ConditionCollection,
  strQxPrjId: string,
) {
...
export function QxPrjPotence_ReFreshCache(strQxPrjId: string): void {
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空!(In clsQxPrjPotenceWApi.clsQxPrjPotenceWApi.ReFreshCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.clsQxPrjPotenceWApi.ReFreshCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export function QxPrjPotence_ReFreshThisCache(strQxPrjId: string): void {
  if (IsNullOrEmpty(strQxPrjId) == true) {
    const strMsg = Format(
      '参数:[strQxPrjId]不能为空!(In clsQxPrjPotenceWApi.QxPrjPotence_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确!(clsQxPrjPotenceWApi.QxPrjPotence_ReFreshThisCache)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @param strQxPrjId:
*/
export async function QxPrjPotence_Cache(
  ...
  if (strQxPrjId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strQxPrjId]的长度:[{0}]不正确！(clsQxPrjPotenceWApi.)',
      strQxPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export function QxPrjPotence_CheckPropertyNew(pobjQxPrjPotenceEN: clsQxPrjPotenceEN) {
  ...
  if (IsNullOrEmpty(pobjQxPrjPotenceEN.potenceName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[权限名称]不能为空(In 工程权限)!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) === true ||
    pobjQxPrjPotenceEN.qxPrjId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000411)字段[项目Id]不能为空(In 工程权限)!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) === true ||
    pobjQxPrjPotenceEN.potenceTypeId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000411)字段[权限类型Id]不能为空(In 工程权限)!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjQxPrjPotenceEN.updUserId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[修改用户Id]不能为空(In 工程权限)!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.potenceId) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[权限ID(potenceId)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceName) == false &&
    GetStrLen(pobjQxPrjPotenceEN.potenceName) > 200
  ) {
    throw new Error(
      `(errid:Watl000413)字段[权限名称(potenceName)]的长度不能超过200(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceName}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.qxPrjId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[项目Id(qxPrjId)]的长度不能超过4(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.qxPrjId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.funcModuleId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.funcModuleId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[模块Id(funcModuleId)]的长度不能超过4(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.funcModuleId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.potenceTypeId) > 6
  ) {
    throw new Error(
      `(errid:Watl000413)字段[权限类型Id(potenceTypeId)]的长度不能超过6(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceTypeId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.menuId) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[菜单Id(menuId)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.menuId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId4Win) == false &&
    GetStrLen(pobjQxPrjPotenceEN.menuId4Win) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[菜单Id4Win(menuId4Win)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.menuId4Win}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updDate) == false &&
    GetStrLen(pobjQxPrjPotenceEN.updDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.updDate}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updUserId) == false &&
    GetStrLen(pobjQxPrjPotenceEN.updUserId) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改用户Id(updUserId)]的长度不能超过20(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.updUserId}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.memo) == false &&
    GetStrLen(pobjQxPrjPotenceEN.memo) > 1000
  ) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.memo}(clsQxPrjPotenceBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceId) == false &&
    undefined !== pobjQxPrjPotenceEN.potenceId &&
    tzDataType.isString(pobjQxPrjPotenceEN.potenceId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[权限ID(potenceId)]的值:[${pobjQxPrjPotenceEN.potenceId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceName) == false &&
    undefined !== pobjQxPrjPotenceEN.potenceName &&
    tzDataType.isString(pobjQxPrjPotenceEN.potenceName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[权限名称(potenceName)]的值:[${pobjQxPrjPotenceEN.potenceName}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) == false &&
    undefined !== pobjQxPrjPotenceEN.qxPrjId &&
    tzDataType.isString(pobjQxPrjPotenceEN.qxPrjId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[项目Id(qxPrjId)]的值:[${pobjQxPrjPotenceEN.qxPrjId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.funcModuleId) == false &&
    undefined !== pobjQxPrjPotenceEN.funcModuleId &&
    tzDataType.isString(pobjQxPrjPotenceEN.funcModuleId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[模块Id(funcModuleId)]的值:[${pobjQxPrjPotenceEN.funcModuleId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) == false &&
    undefined !== pobjQxPrjPotenceEN.potenceTypeId &&
    tzDataType.isString(pobjQxPrjPotenceEN.potenceTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[权限类型Id(potenceTypeId)]的值:[${pobjQxPrjPotenceEN.potenceTypeId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId) == false &&
    undefined !== pobjQxPrjPotenceEN.menuId &&
    tzDataType.isString(pobjQxPrjPotenceEN.menuId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[菜单Id(menuId)]的值:[${pobjQxPrjPotenceEN.menuId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId4Win) == false &&
    undefined !== pobjQxPrjPotenceEN.menuId4Win &&
    tzDataType.isString(pobjQxPrjPotenceEN.menuId4Win) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[菜单Id4Win(menuId4Win)]的值:[${pobjQxPrjPotenceEN.menuId4Win}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updDate) == false &&
    undefined !== pobjQxPrjPotenceEN.updDate &&
    tzDataType.isString(pobjQxPrjPotenceEN.updDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjQxPrjPotenceEN.updDate}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updUserId) == false &&
    undefined !== pobjQxPrjPotenceEN.updUserId &&
    tzDataType.isString(pobjQxPrjPotenceEN.updUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改用户Id(updUserId)]的值:[${pobjQxPrjPotenceEN.updUserId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.memo) == false &&
    undefined !== pobjQxPrjPotenceEN.memo &&
    tzDataType.isString(pobjQxPrjPotenceEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjQxPrjPotenceEN.memo}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckPropertyNew0)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) == false &&
    pobjQxPrjPotenceEN.qxPrjId != '[nuull]' &&
    GetStrLen(pobjQxPrjPotenceEN.qxPrjId) != 4
  ) {
  ...
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) == false &&
    pobjQxPrjPotenceEN.potenceTypeId != '[nuull]' &&
    GetStrLen(pobjQxPrjPotenceEN.potenceTypeId) != 6
  ) {
...
export function QxPrjPotence_CheckProperty4Update(pobjQxPrjPotenceEN: clsQxPrjPotenceEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[权限ID(potenceId)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[权限名称(potenceName)]的长度不能超过200(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceName}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[项目Id(qxPrjId)]的长度不能超过4(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.qxPrjId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.funcModuleId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[模块Id(funcModuleId)]的长度不能超过4(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.funcModuleId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[权限类型Id(potenceTypeId)]的长度不能超过6(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.potenceTypeId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[菜单Id(menuId)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.menuId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId4Win) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[菜单Id4Win(menuId4Win)]的长度不能超过8(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.menuId4Win}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.updDate}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改用户Id(updUserId)]的长度不能超过20(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.updUserId}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 工程权限(QxPrjPotence))!值:${pobjQxPrjPotenceEN.memo}(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[权限ID(potenceId)]的值:[${pobjQxPrjPotenceEN.potenceId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[权限名称(potenceName)]的值:[${pobjQxPrjPotenceEN.potenceName}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.qxPrjId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[项目Id(qxPrjId)]的值:[${pobjQxPrjPotenceEN.qxPrjId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.funcModuleId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[模块Id(funcModuleId)]的值:[${pobjQxPrjPotenceEN.funcModuleId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[权限类型Id(potenceTypeId)]的值:[${pobjQxPrjPotenceEN.potenceTypeId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[菜单Id(menuId)]的值:[${pobjQxPrjPotenceEN.menuId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.menuId4Win) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[菜单Id4Win(menuId4Win)]的值:[${pobjQxPrjPotenceEN.menuId4Win}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(updDate)]的值:[${pobjQxPrjPotenceEN.updDate}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.updUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改用户Id(updUserId)]的值:[${pobjQxPrjPotenceEN.updUserId}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjQxPrjPotenceEN.memo}], 非法,应该为字符型(In 工程权限(QxPrjPotence))!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    IsNullOrEmpty(pobjQxPrjPotenceEN.potenceId) === true ||
    pobjQxPrjPotenceEN.potenceId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000064)字段[权限ID]不能为空(In 工程权限)!(clsQxPrjPotenceBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
  if (
 ...
 * @returns 返回一个生成的对象列表
 */
export function QxPrjPotence_GetObjLstByJSONObjLst(
  arrQxPrjPotenceObjLstS: Array<clsQxPrjPotenceEN>,
): Array<clsQxPrjPotenceEN> {
...
export function QxPrjPotence_GetCombineCondition(objQxPrjPotenceCond: clsQxPrjPotenceEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_PotenceId,
    ) == true
  ) {
    const strComparisonOpPotenceId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_PotenceId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_PotenceId,
      objQxPrjPotenceCond.potenceId,
      strComparisonOpPotenceId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpPotenceName: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_PotenceName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_PotenceName,
      objQxPrjPotenceCond.potenceName,
      strComparisonOpPotenceName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpQxPrjId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_QxPrjId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_QxPrjId,
      objQxPrjPotenceCond.qxPrjId,
  ...
  if (
    ...
    const strComparisonOpFuncModuleId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_FuncModuleId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_FuncModuleId,
      objQxPrjPotenceCond.funcModuleId,
      strComparisonOpFuncModuleId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpPotenceTypeId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_PotenceTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_PotenceTypeId,
      objQxPrjPotenceCond.potenceTypeId,
      strComparisonOpPotenceTypeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_MenuId,
    ) == true
  ) {
    const strComparisonOpMenuId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_MenuId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_MenuId,
      objQxPrjPotenceCond.menuId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_MenuId4Win,
    ) == true
  ) {
    const strComparisonOpMenuId4Win: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_MenuId4Win];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_MenuId4Win,
      objQxPrjPotenceCond.menuId4Win,
      strComparisonOpMenuId4Win,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_UpdDate,
    ) == true
  ) {
    const strComparisonOpUpdDate: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_UpdDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_UpdDate,
      objQxPrjPotenceCond.updDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_UpdUserId,
    ) == true
  ) {
    const strComparisonOpUpdUserId: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_UpdUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_UpdUserId,
      objQxPrjPotenceCond.updUserId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxPrjPotenceCond.dicFldComparisonOp,
      clsQxPrjPotenceEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objQxPrjPotenceCond.dicFldComparisonOp[clsQxPrjPotenceEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxPrjPotenceEN.con_Memo,
      objQxPrjPotenceCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function QxPrjPotence_GetObjFromJsonObj(
