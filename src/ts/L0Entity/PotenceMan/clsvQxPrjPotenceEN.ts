...
public static readonly _CurrTabName: string = "vQxPrjPotence"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "PotenceId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 20;
public static readonly _AttributeName = ["potenceId", "potenceName", "qxPrjId", "prjName", "funcModuleId", "potenceTypeId", "potenceTypeName", "funcModuleName", "funcModuleNameSim", "inUse", "isVisible", "menuId", "menuName", "upMenuId", "isLeafNode", "upMenuName", "updDate", "updUserId", "memo", "symbolNum"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_SymbolNum = "symbolNum";    //标志数
