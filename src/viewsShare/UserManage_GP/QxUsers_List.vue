      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('roleNames|Ex')">
              角色s
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleNames|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('effitiveEndDate')">
              有效结束日期
              <span>
                <i
                  :class="
                    sortColumnKey === 'effitiveEndDate'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('departmentName|Ex')">
              部门名
              <span>
                <i
                  :class="
                    sortColumnKey === 'departmentName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('departmentTypeName|Ex')">
              部门类型名
              <span>
                <i
                  :class="
                    sortColumnKey === 'departmentTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.departmentName"></td>

            <td v-html="item.departmentTypeName"></td>
