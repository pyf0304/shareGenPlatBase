 ...
 **/
export async function vUsers_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
 ...
 * @returns 对象列表
 **/
export async function vUsers_GetObjLstByUserIdLstAsync(
  arrUserId: Array<string>,
): Promise<Array<clsvUsersEN>> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function vUsers_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vUsers_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vUsers_GetObjLstByPagerAsync(
 ...
 * @returns 返回一个生成的对象列表
 */
export function vUsers_GetObjLstByJSONObjLst(
  arrvUsersObjLstS: Array<clsvUsersEN>,
): Array<clsvUsersEN> {
...
export function vUsers_GetCombineCondition(objvUsersCond: clsvUsersEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UserId,
    ) == true
  ) {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UserName,
    ) == true
  ) {
    const strComparisonOpUserName: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UserName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UserName,
      objvUsersCond.userName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UserStateId,
    ) == true
  ) {
    const strComparisonOpUserStateId: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UserStateId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UserStateId,
      objvUsersCond.userStateId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UserStateName,
    ) == true
  ) {
    const strComparisonOpUserStateName: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UserStateName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UserStateName,
      objvUsersCond.userStateName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_Password,
    ) == true
  ) {
    const strComparisonOpPassword: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_Password];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_Password,
      objvUsersCond.password,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_BeginYearMonth,
    ) == true
  ) {
    const strComparisonOpBeginYearMonth: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_BeginYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_BeginYearMonth,
      objvUsersCond.beginYearMonth,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_EndYearMonth,
    ) == true
  ) {
    const strComparisonOpEndYearMonth: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_EndYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_EndYearMonth,
      objvUsersCond.endYearMonth,
  ...
  if (
    ...
    const strComparisonOpIdGradeBase: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_IdGradeBase];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_IdGradeBase,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_GradeBaseName,
    ) == true
  ) {
    const strComparisonOpGradeBaseName: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_GradeBaseName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_GradeBaseName,
      objvUsersCond.gradeBaseName,
  ...
  if (
    ...
    const strComparisonOpIdXzCollege: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_Id_XzCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_CollegeId,
    ) == true
  ) {
    const strComparisonOpCollegeId: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_CollegeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_CollegeId,
      objvUsersCond.collegeId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_CollegeName,
    ) == true
  ) {
    const strComparisonOpCollegeName: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_CollegeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_CollegeName,
      objvUsersCond.collegeName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_CollegeNameA,
    ) == true
  ) {
    const strComparisonOpCollegeNameA: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_CollegeNameA];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_CollegeNameA,
      objvUsersCond.collegeNameA,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_IdXzMajor,
    ) == true
  ) {
    const strComparisonOpIdXzMajor: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_IdXzMajor];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_IdXzMajor,
      objvUsersCond.id_XzMajor,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_MajorName,
    ) == true
  ) {
    const strComparisonOpMajorName: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_MajorName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_MajorName,
      objvUsersCond.majorName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_StuIdTeacherId,
    ) == true
  ) {
    const strComparisonOpStuIdTeacherId: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_StuIdTeacherId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_StuIdTeacherId,
      objvUsersCond.stuIdTeacherId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_IdentityId,
    ) == true
  ) {
    const strComparisonOpIdentityId: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_IdentityId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_IdentityId,
      objvUsersCond.identityId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_IdentityDesc,
    ) == true
  ) {
    const strComparisonOpIdentityDesc: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_IdentityDesc];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_IdentityDesc,
      objvUsersCond.identityDesc,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_AuditDate,
    ) == true
  ) {
    const strComparisonOpAuditDate: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_AuditDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_AuditDate,
      objvUsersCond.auditDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_AuditUser,
    ) == true
  ) {
    const strComparisonOpAuditUser: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_AuditUser];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_AuditUser,
      objvUsersCond.auditUser,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_RegisterDate,
    ) == true
  ) {
    const strComparisonOpRegisterDate: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_RegisterDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_RegisterDate,
      objvUsersCond.registerDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_MobilePhone,
    ) == true
  ) {
    const strComparisonOpMobilePhone: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_MobilePhone];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_MobilePhone,
      objvUsersCond.mobilePhone,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UpdDate,
    ) == true
  ) {
    const strComparisonOpUpdDate: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UpdDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UpdDate,
      objvUsersCond.updDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UpdUser,
    ) == true
  ) {
    const strComparisonOpUpdUser: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UpdUser];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UpdUser,
      objvUsersCond.updUser,
      strComparisonOpUpdUser,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(objvUsersCond.dicFldComparisonOp, clsvUsersEN.con_Memo) ==
    true
  ) {
    const strComparisonOpMemo: string = objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_Memo,
      objvUsersCond.memo,
      strComparisonOpMemo,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_UserNameWithUserId,
    ) == true
  ) {
    const strComparisonOpUserNameWithUserId: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_UserNameWithUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_UserNameWithUserId,
      objvUsersCond.userNameWithUserId,
      strComparisonOpUserNameWithUserId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_OpenId,
    ) == true
  ) {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_AvatarsPicture,
    ) == true
  ) {
    const strComparisonOpAvatarsPicture: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_AvatarsPicture];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_AvatarsPicture,
      objvUsersCond.avatarsPicture,
      strComparisonOpAvatarsPicture,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(objvUsersCond.dicFldComparisonOp, clsvUsersEN.con_Email) ==
    true
  ) {
    const strComparisonOpEmail: string = objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_Email];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_Email,
      objvUsersCond.email,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_PhoneNumber,
    ) == true
  ) {
    const strComparisonOpPhoneNumber: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_PhoneNumber];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_PhoneNumber,
      objvUsersCond.phoneNumber,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersCond.dicFldComparisonOp,
      clsvUsersEN.con_HeadPic,
    ) == true
  ) {
    const strComparisonOpHeadPic: string =
      objvUsersCond.dicFldComparisonOp[clsvUsersEN.con_HeadPic];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersEN.con_HeadPic,
      objvUsersCond.headPic,
