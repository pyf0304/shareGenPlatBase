...
import {
  ...
  QxPotenceType_EditRecordExAsync,
...
export abstract class QxPotenceType_Edit {
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      ...
      if (['02', '03', '06'].indexOf(clsQxPotenceTypeEN._PrimaryTypeId) > -1) {
  ...
  public async ShowData(strPotenceTypeId: string) {
    ...
    try {
      const objQxPotenceTypeENConst =
        await QxPotenceType_GetObjByPotenceTypeIdAsync(strPotenceTypeId);
