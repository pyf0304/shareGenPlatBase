      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('roleIndex')">
              角色序号
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleIndex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('roleId')">
              角色Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('roleENName')">
              角色英文名
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleENName'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('roleTypeName|Ex')">
              角色类型名
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('isInUse')">
              使用?
              <span>
                <i
                  :class="
                    sortColumnKey === 'isInUse'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.roleTypeName"></td>
