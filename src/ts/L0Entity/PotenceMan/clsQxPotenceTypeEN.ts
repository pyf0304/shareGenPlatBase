...
public static readonly _CurrTabName: string = "QxPotenceType"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "PotenceTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 10;
public static readonly _AttributeName = ["potenceTypeId", "potenceTypeName", "qxPrjId", "funcModuleId", "menuId", "viewId", "isVisible", "updDate", "updUserId", "memo"];
//以下是属性变量
