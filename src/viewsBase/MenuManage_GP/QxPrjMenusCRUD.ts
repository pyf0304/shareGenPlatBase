 ...
 /**
 * 类名:QxPrjMenusCRUD(界面:QxPrjMenusCRUD,00140040)
 * 表名:QxPrjMenus(00140004)
 * 版本:2025.06.10.1(服务器:WIN-SRV103-116)
 * 日期:2025/06/13 16:04:13
 * 生成者:
 工程名称:统一平台(0014)
...
import { CombineQxPrjMenusCondition,QxPrjId_Local,divVarSet,viewVarSet,dataColumn,BindTabByList,refQxPrjMenus_List } from "@/viewsShare/MenuManage_GP/QxPrjMenusVueShare";
import { QxPrjMenus_GetRecCountByCondAsync,QxPrjMenus_GetObjLstAsync,QxPrjMenus_DelRecordAsync,QxPrjMenus_GetObjByMenuIdAsync,QxPrjMenus_FuncMapByFldName,QxPrjMenus_GetObjLstByMenuIdLstAsync,QxPrjMenus_GetMaxStrIdByPrefixAsync,QxPrjMenus_AddNewRecordAsync,QxPrjMenus_UpdateRecordAsync,QxPrjMenus_DelQxPrjMenussAsync } from "@/ts/L3ForWApi/MenuManage_GP/clsQxPrjMenusWApi";
...
import { QxPrjMenusEx_GetObjExLstByPagerAsync } from "@/ts/L3ForWApiExShare/MenuManage_GP/clsQxPrjMenusExWApi";
...
if (viewVarSet.sortQxPrjMenusBy == '') viewVarSet.sortQxPrjMenusBy = `${ clsQxPrjMenusEN.con_MenuId } Asc`;
 ...
 **/
public CombineData(arrQxPrjMenusObjLst: Array<clsQxPrjMenusEN>, arrDataColumn: Array<clsDataColumn>): ExportExcelData 
{
...
const strFileName = Format("工程菜单({0})导出.xlsx",
 clsQxPrjMenusEN._CurrTabName);
const strSheetName = "工程菜单列表";
 ...
 **/
public async ExportExcel_QxPrjMenus(): Promise<ExportExcelData> 
{
const strThisFuncName = this.ExportExcel_QxPrjMenus.name;
if (viewVarSet.sortQxPrjMenusBy == null)
{
const strMsg = Format("在显示列表时,排序字段(sortQxPrjMenusBy)为空,请检查!(In BindGv_QxPrjMenusCache)");
console.error(strMsg);
alert(strMsg);
return { arrObjLst: [], sheetName: '', fileName: '' };
}

const strWhereCond = await CombineQxPrjMenusCondition();
...
arrQxPrjMenusObjLst = arrQxPrjMenusObjLst.sort(this.SortFunExportExcel);
  return this.CombineData(arrQxPrjMenusObjLst, arrDataColumn); 
...
{
const strMsg = Format("缓存分类变量:[strCmPrjId]的长度:[{0}]不正确!(.SetDdl_MenuSetIdInDivInFeature)", strCmPrjId.length);
console.error(strMsg);
throw (strMsg);
}

await QxPrjMenuSet_BindDdl_MenuSetIdByCmPrjIdInDivCache(divVarSet.refDivFunction, "ddlMenuSetId" , strCmPrjId);//
}
...
const strMenuSetId = GetSelectValueInDivObj(divVarSet.refDivFunction, "ddlMenuSetId_SetFldValue");
if (strMenuSetId == "")
{
...
{
await this.ExportExcel_QxPrjMenus();
}
 ...
 **/
public async BindTab_QxPrjMenus(divContainer: HTMLDivElement, arrQxPrjMenusExObjLst: Array<clsQxPrjMenusENEx>) 
{
...
{
fldName: clsQxPrjMenusENEx.con_PageDispModeName,
...
if (refQxPrjMenus_List.value != null){
dataColumn.value = arrDataColumn;
await BindTabByList(arrQxPrjMenusExObjLst, this.dispAllErrMsg_q); 
}
else {
const divDataLst = GetDivObjInDivObj(divContainer, 'divDataLst');
if (divDataLst == null)
{
alert("在BindTab_QxPrjMenus函数中，divDataLst不存在!");
return;
}
await BindTab(divDataLst, arrQxPrjMenusExObjLst, arrDataColumn,  clsQxPrjMenusEN.con_MenuId, this); 
}
 ...
 **/
public async BindTab_QxPrjMenus4Func(divContainer: HTMLDivElement, arrQxPrjMenusExObjLst: Array<clsQxPrjMenusENEx>) 
{
...
if (divDataLst == null)
{
alert("在BindTab_QxPrjMenus4Func函数中，divDataLst不存在!");
return;
}
await BindTab(divDataLst, arrQxPrjMenusExObjLst, arrDataColumn,  clsQxPrjMenusEN.con_MenuId, this); 
}
 ...
 **/
public async ExtendFldFuncMap(arrQxPrjMenusExObjLst: Array<clsQxPrjMenusENEx>, arrDataColumn: Array<clsDataColumn>) {
...
await QxPrjMenus_FuncMapByFldName(objDataColumn.fldName, objInFor);
}
}
}
...
await this.BindGv_QxPrjMenus4Func(this.listPara.listDiv);
}
...
//console.trace();
alert(strMsg);
BindTabByList(arrQxPrjMenusExObjLst, true);
return;
}
...
orderBy: viewVarSet.sortQxPrjMenusBy,//如果该字段为空,就使用下面的排序函数
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, viewVarSet.ascOrDesc4SortFun, viewVarSet.sortQxPrjMenusBy, strSortExpress);
// 将 sortBy 按空格分成两部分
const [sortColumnKey, sortDirection] = sortBy.split(' ');
if (Object.prototype.hasOwnProperty.call(clsQxPrjMenusENEx, sortColumnKey))
{
// 调用 SortColumn 函数
this.SortColumn(sortColumnKey, sortDirection);
return;
}
viewVarSet.sortQxPrjMenusBy = sortBy;
...
{
const qxPrjMenusStore = useQxPrjMenusStore();
arrMenuId.forEach(async (strMenuId) => {
await qxPrjMenusStore.delObj(strMenuId);
});
}
}
...
ObjectAssign(objQxPrjMenusEN, objInFor);
objQxPrjMenusEN.SetMenuId(objInFor.menuId);
//objQxPrjMenusEN.SetMenuSetId(strMenuSetId);
let returnBool = false;
try
{
    objQxPrjMenusEN.sfUpdFldSetStr = objQxPrjMenusEN.updFldString;//设置哪些字段被修改(脏字段)
