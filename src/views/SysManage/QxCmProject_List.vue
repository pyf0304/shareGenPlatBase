      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('cmPrjId')">
              Cm项目Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'cmPrjId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const tdFieldNames = ['cmPrjId', 'cmPrjName', 'useStateName', 'updDate', 'memo'];
      watchEffect(() => {
