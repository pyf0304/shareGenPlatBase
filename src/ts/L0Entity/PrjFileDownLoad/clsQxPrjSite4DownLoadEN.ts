...
public static readonly _CurrTabName: string = "QxPrjSite4DownLoad"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "PrjSiteId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 9;
public static readonly _AttributeName = ["prjSiteId", "prjSiteName", "qxPrjId", "ftpServer", "ftpUserId", "ftpUserPassword", "updDate", "updUserId", "memo"];
//以下是属性变量
 ...
 */
 public static readonly con_PrjSiteId = "prjSiteId";    //工程站点Id

 /**
 * 常量:"PrjSiteName"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_PrjSiteName = "prjSiteName";    //工程站点名
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FtpServer = "ftpServer";    //Ftp服务器

 /**
 * 常量:"FtpUserId"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FtpUserId = "ftpUserId";    //Ftp用户Id

 /**
 * 常量:"FtpUserPassword"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_FtpUserPassword = "ftpUserPassword";    //Ftp用户口令
