...
export abstract class QxPrjMenusCRUD implements clsOperateList {
  ...
  public async PageLoad() {
    ...
    try {
      ...
      if (viewVarSet.sortQxPrjMenusBy == '')
        viewVarSet.sortQxPrjMenusBy = `${clsQxPrjMenusEN.con_MenuId} Asc`;
