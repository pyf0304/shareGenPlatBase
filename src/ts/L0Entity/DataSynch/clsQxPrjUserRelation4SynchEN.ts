...
export class  clsQxPrjUserRelation4SynchEN extends clsGeneralTab
{
...
public static readonly _CurrTabName: string = "QxPrjUserRelation4Synch"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 7;
public static readonly _AttributeName = ["mId", "ipAddress", "qxPrjId", "userId", "updDate", "updUserId", "memo"];
//以下是属性变量
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxPrjUserRelation4Synch]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxPrjUserRelation4Synch]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsQxPrjUserRelation4SynchEN();
const instance = new clsQxPrjUserRelation4SynchEN();
