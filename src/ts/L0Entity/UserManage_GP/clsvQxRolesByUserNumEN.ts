 ...
 /**
 * 类名:clsvQxRolesByUserNumEN
 * 表名:vQxRolesByUserNum(00140081)
 * 版本:2026.04.01.1(服务器:WIN-SRV103-116)
 * 日期:2026/04/01 02:04:33
 * 生成者:pyf
 工程名称:统一平台(0014)
...
export class  clsvQxRolesByUserNumEN extends clsGeneralTabV
{
...
public static readonly _CurrTabName: string = "vQxRolesByUserNum"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "RoleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 11;
public static readonly _AttributeName = ["roleId", "roleName", "roleENName", "roleIndex", "qxPrjId", "prjName", "isInUse", "updDate", "updUserId", "memo", "userNum"];
//以下是属性变量
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[vQxRolesByUserNum]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[vQxRolesByUserNum]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsvQxRolesByUserNumEN();
const instance = new clsvQxRolesByUserNumEN();
