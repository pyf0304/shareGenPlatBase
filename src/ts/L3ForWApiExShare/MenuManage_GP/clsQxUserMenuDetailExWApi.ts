 ...
 **/
export function QxUserMenuDetailEx_CopyToEx(
  objQxUserMenuDetailENS: clsQxUserMenuDetailEN,
): clsQxUserMenuDetailENEx {
 ...
 */
export function QxUserMenuDetailEx_FuncMapByFldName(
  strFldName: string,
  objQxUserMenuDetailEx: clsQxUserMenuDetailENEx,
) {
  ...
  let strMsg = '';
  //如果是本表中字段,不需要映射
  const arrFldName = clsQxUserMenuDetailEN._AttributeName;
