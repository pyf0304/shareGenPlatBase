 ...
 **/
export function vQxDepartmentInfoByUserNumEx_GetWebApiUrl(
 ...
 **/
export function vQxDepartmentInfoByUserNumEx_CopyToEx(
  objvQxDepartmentInfoByUserNumENS: clsvQxDepartmentInfoByUserNumEN,
): clsvQxDepartmentInfoByUserNumENEx {
 ...
 */
export function vQxDepartmentInfoByUserNumEx_FuncMapByFldName(
  strFldName: string,
  objvQxDepartmentInfoByUserNumEx: clsvQxDepartmentInfoByUserNumENEx,
) {
  ...
  let strMsg = '';
  //如果是本表中字段,不需要映射
  const arrFldName = clsvQxDepartmentInfoByUserNumEN._AttributeName;
