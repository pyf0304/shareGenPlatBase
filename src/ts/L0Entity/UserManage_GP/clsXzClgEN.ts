...
export class clsXzClgEN extends clsGeneralTab {
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_CollegeId = 'collegeId'; //学院ID

  /**
   * 常量:"CollegeName"
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_CollegeName = 'collegeName'; //学院名称
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_CollegeNameA = 'collegeNameA'; //学院名称简写
   ...
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_PhoneNumber = 'phoneNumber'; //电话

  /**
   * 常量:"WebSite"
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_WebSite = 'webSite'; //个人主页

  /**
   * 常量:"IdSchool"
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_IdSchool = 'idSchool'; //学校流水号

  /**
   * 常量:"IdUni"
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_IdUni = 'idUni'; //id_Uni

  /**
   * 常量:"IsVisible4Tea"
   * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
   */
  public static readonly con_IsVisible4Tea = 'isVisible4Tea'; //IsVisible4Tea
