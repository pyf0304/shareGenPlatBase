 ...
 * @returns 对象
 **/
export async function RsStaffType_GetObjByIdStaffTypeAsync(
  strIdStaffType: string,
): Promise<clsRsStaffTypeEN | null> {
  const strThisFuncName = 'GetObjByIdStaffTypeAsync';

  if (IsNullOrEmpty(strIdStaffType) == true) {
    const strMsg = Format(
      '参数:[strIdStaffType]不能为空!(In clsRsStaffTypeWApi.GetObjByIdStaffTypeAsync)',
    );
  ...
  if (strIdStaffType.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdStaffType]的长度:[{0}]不正确!(clsRsStaffTypeWApi.GetObjByIdStaffTypeAsync)',
      strIdStaffType.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function RsStaffType_GetObjByIdStaffTypelocalStorage(strIdStaffType: string) {
  ...
  if (IsNullOrEmpty(strIdStaffType) == true) {
    const strMsg = Format(
      '参数:[strIdStaffType]不能为空!(In clsRsStaffTypeWApi.GetObjByIdStaffTypelocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStaffType.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdStaffType]的长度:[{0}]不正确!(clsRsStaffTypeWApi.GetObjByIdStaffTypelocalStorage)',
      strIdStaffType.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function RsStaffType_GetObjByIdStaffTypeCache(
  strIdStaffType: string,
  ...
  if (IsNullOrEmpty(strIdStaffType) == true) {
    const strMsg = Format(
      '参数:[strIdStaffType]不能为空!(In clsRsStaffTypeWApi.GetObjByIdStaffTypeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStaffType.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdStaffType]的长度:[{0}]不正确!(clsRsStaffTypeWApi.GetObjByIdStaffTypeCache)',
      strIdStaffType.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrRsStaffTypeSel = arrRsStaffTypeObjLstCache.filter(
      (x) => x.idStaffType == strIdStaffType,
    );
...
export async function RsStaffType_UpdateObjInLstCache(objRsStaffType: clsRsStaffTypeEN) {
  ...
  try {
    const arrRsStaffTypeObjLstCache = await RsStaffType_GetObjLstCache();
    const obj = arrRsStaffTypeObjLstCache.find((x) => x.idStaffType == objRsStaffType.idStaffType);
    if (obj != null) {
...
export async function RsStaffType_GetNameByIdStaffTypeCache(strIdStaffType: string) {
  if (IsNullOrEmpty(strIdStaffType) == true) {
    const strMsg = Format(
      '参数:[strIdStaffType]不能为空!(In clsRsStaffTypeWApi.GetNameByIdStaffTypeCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdStaffType.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdStaffType]的长度:[{0}]不正确!(clsRsStaffTypeWApi.GetNameByIdStaffTypeCache)',
      strIdStaffType.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function RsStaffType_func(
  strInFldName: string,
 ...
 * @returns 返回一个关键字值列表
 */
export async function RsStaffType_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrRsStaffTypeSel = arrRsStaffTypeSel.filter(
 ...
 **/
export async function RsStaffType_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function RsStaffType_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsRsStaffTypeEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsStaffType_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsRsStaffTypeEN>> {
...
export async function RsStaffType_GetSubObjLstCache(objRsStaffTypeCond: clsRsStaffTypeEN) {
  ...
  if (objRsStaffTypeCond.sfFldComparisonOp == null || objRsStaffTypeCond.sfFldComparisonOp == '')
    return arrRsStaffTypeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsStaffTypeCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objRsStaffTypeCond),
      rsStaffType_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function RsStaffType_GetObjLstByIdStaffTypeLstAsync(
  arrIdStaffType: Array<string>,
): Promise<Array<clsRsStaffTypeEN>> {
...
export async function RsStaffType_GetObjLstByIdStaffTypeLstCache(arrIdStaffTypeLst: Array<string>) {
  ...
  try {
    const arrRsStaffTypeObjLstCache = await RsStaffType_GetObjLstCache();
    const arrRsStaffTypeSel = arrRsStaffTypeObjLstCache.filter(
      (x) => arrIdStaffTypeLst.indexOf(x.idStaffType) > -1,
    );
    return arrRsStaffTypeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function RsStaffType_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsStaffType_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function RsStaffType_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsStaffType_DelRsStaffTypesAsync(
  arrIdStaffType: Array<string>,
): Promise<number> {
 ...
 * @returns 实际删除记录的个数
 **/
export async function RsStaffType_DelRsStaffTypesByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsStaffType_AddNewRecordAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function RsStaffType_AddNewRecordWithMaxIdAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<string> {
 ...
 **/
export async function RsStaffType_AddNewObjSave(
  objRsStaffTypeEN: clsRsStaffTypeEN,
 ...
 **/
export async function RsStaffType_UpdateObjSave(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<boolean> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function RsStaffType_AddNewRecordWithReturnKeyAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsStaffType_UpdateRecordAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objRsStaffTypeEN.sfUpdFldSetStr === undefined ||
    objRsStaffTypeEN.sfUpdFldSetStr === null ||
    objRsStaffTypeEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function RsStaffType_EditRecordExAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function RsStaffType_UpdateWithConditionAsync(
  objRsStaffTypeEN: clsRsStaffTypeEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function RsStaffType_IsExistRecordCache(objRsStaffTypeCond: clsRsStaffTypeEN) {
  ...
  let arrRsStaffTypeSel = arrRsStaffTypeObjLstCache;
  if (objRsStaffTypeCond.sfFldComparisonOp == null || objRsStaffTypeCond.sfFldComparisonOp == '')
    return arrRsStaffTypeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objRsStaffTypeCond.sfFldComparisonOp,
  );
  //console.log("clsRsStaffTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function RsStaffType_BindDdl_IdStaffTypeInDivCache(
...
export function RsStaffType_CheckPropertyNew(pobjRsStaffTypeEN: clsRsStaffTypeEN) {
  ...
  if (IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[职工类型Id]不能为空(In 职工类型)!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[职工类型名称]不能为空(In 职工类型)!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.idStaffType) == false &&
    GetStrLen(pobjRsStaffTypeEN.idStaffType) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[职工类型流水号(idStaffType)]的长度不能超过4(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.idStaffType}(clsRsStaffTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeId) == false &&
    GetStrLen(pobjRsStaffTypeEN.staffTypeId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[职工类型Id(staffTypeId)]的长度不能超过4(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.staffTypeId}(clsRsStaffTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeName) == false &&
    GetStrLen(pobjRsStaffTypeEN.staffTypeName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[职工类型名称(staffTypeName)]的长度不能超过30(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.staffTypeName}(clsRsStaffTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyDate) == false &&
    GetStrLen(pobjRsStaffTypeEN.modifyDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(modifyDate)]的长度不能超过20(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.modifyDate}(clsRsStaffTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyUserId) == false &&
    GetStrLen(pobjRsStaffTypeEN.modifyUserId) > 18
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(modifyUserId)]的长度不能超过18(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.modifyUserId}(clsRsStaffTypeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.idStaffType) == false &&
    undefined !== pobjRsStaffTypeEN.idStaffType &&
    tzDataType.isString(pobjRsStaffTypeEN.idStaffType) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[职工类型流水号(idStaffType)]的值:[${pobjRsStaffTypeEN.idStaffType}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeId) == false &&
    undefined !== pobjRsStaffTypeEN.staffTypeId &&
    tzDataType.isString(pobjRsStaffTypeEN.staffTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[职工类型Id(staffTypeId)]的值:[${pobjRsStaffTypeEN.staffTypeId}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeName) == false &&
    undefined !== pobjRsStaffTypeEN.staffTypeName &&
    tzDataType.isString(pobjRsStaffTypeEN.staffTypeName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[职工类型名称(staffTypeName)]的值:[${pobjRsStaffTypeEN.staffTypeName}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyDate) == false &&
    undefined !== pobjRsStaffTypeEN.modifyDate &&
    tzDataType.isString(pobjRsStaffTypeEN.modifyDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(modifyDate)]的值:[${pobjRsStaffTypeEN.modifyDate}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyUserId) == false &&
    undefined !== pobjRsStaffTypeEN.modifyUserId &&
    tzDataType.isString(pobjRsStaffTypeEN.modifyUserId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(modifyUserId)]的值:[${pobjRsStaffTypeEN.modifyUserId}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckPropertyNew0)`,
    );
  }
...
export function RsStaffType_CheckProperty4Update(pobjRsStaffTypeEN: clsRsStaffTypeEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[职工类型流水号(idStaffType)]的长度不能超过4(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.idStaffType}(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[职工类型Id(staffTypeId)]的长度不能超过4(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.staffTypeId}(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[职工类型名称(staffTypeName)]的长度不能超过30(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.staffTypeName}(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(modifyDate)]的长度不能超过20(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.modifyDate}(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(modifyUserId)]的长度不能超过18(In 职工类型(RsStaffType))!值:${pobjRsStaffTypeEN.modifyUserId}(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[职工类型流水号(idStaffType)]的值:[${pobjRsStaffTypeEN.idStaffType}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[职工类型Id(staffTypeId)]的值:[${pobjRsStaffTypeEN.staffTypeId}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.staffTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[职工类型名称(staffTypeName)]的值:[${pobjRsStaffTypeEN.staffTypeName}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(modifyDate)]的值:[${pobjRsStaffTypeEN.modifyDate}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjRsStaffTypeEN.modifyUserId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(modifyUserId)]的值:[${pobjRsStaffTypeEN.modifyUserId}], 非法,应该为字符型(In 职工类型(RsStaffType))!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (IsNullOrEmpty(pobjRsStaffTypeEN.idStaffType) === true) {
    throw new Error(
      `(errid:Watl000064)字段[职工类型流水号]不能为空(In 职工类型)!(clsRsStaffTypeBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function RsStaffType_GetObjLstByJSONObjLst(
  arrRsStaffTypeObjLstS: Array<clsRsStaffTypeEN>,
): Array<clsRsStaffTypeEN> {
...
export function RsStaffType_GetCombineCondition(objRsStaffTypeCond: clsRsStaffTypeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsStaffTypeCond.dicFldComparisonOp,
      clsRsStaffTypeEN.con_IdStaffType,
    ) == true
  ) {
    const strComparisonOpIdStaffType: string =
      objRsStaffTypeCond.dicFldComparisonOp[clsRsStaffTypeEN.con_IdStaffType];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsStaffTypeEN.con_IdStaffType,
      objRsStaffTypeCond.idStaffType,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsStaffTypeCond.dicFldComparisonOp,
      clsRsStaffTypeEN.con_StaffTypeId,
    ) == true
  ) {
    const strComparisonOpStaffTypeId: string =
      objRsStaffTypeCond.dicFldComparisonOp[clsRsStaffTypeEN.con_StaffTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsStaffTypeEN.con_StaffTypeId,
      objRsStaffTypeCond.staffTypeId,
      strComparisonOpStaffTypeId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpStaffTypeName: string =
      objRsStaffTypeCond.dicFldComparisonOp[clsRsStaffTypeEN.con_StaffTypeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsStaffTypeEN.con_StaffTypeName,
      objRsStaffTypeCond.staffTypeName,
      strComparisonOpStaffTypeName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objRsStaffTypeCond.dicFldComparisonOp,
      clsRsStaffTypeEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objRsStaffTypeCond.dicFldComparisonOp[clsRsStaffTypeEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsStaffTypeEN.con_ModifyDate,
      objRsStaffTypeCond.modifyDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objRsStaffTypeCond.dicFldComparisonOp,
      clsRsStaffTypeEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objRsStaffTypeCond.dicFldComparisonOp[clsRsStaffTypeEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsRsStaffTypeEN.con_ModifyUserId,
      objRsStaffTypeCond.modifyUserId,
 ...
 */
export function RsStaffType_CopyObjTo(
  objRsStaffTypeENS: clsRsStaffTypeEN,
  objRsStaffTypeENT: clsRsStaffTypeEN,
): void {
 ...
 * @param objRsStaffTypeENT:目标对象
 */
export function RsStaffType_GetObjFromJsonObj(
  objRsStaffTypeENS: clsRsStaffTypeEN,
): clsRsStaffTypeEN {
