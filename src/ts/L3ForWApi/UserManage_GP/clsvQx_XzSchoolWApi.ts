 ...
 * @returns 对象
 **/
export  async function vQx_XzSchool_GetObjById_SchoolAsync(strId_School: string): Promise<clsvQx_XzSchoolEN|null>  
{
const strThisFuncName = "GetObjById_SchoolAsync";

if (IsNullOrEmpty(strId_School) == true)
{
  const strMsg = Format("参数:[strId_School]不能为空!(In clsvQx_XzSchoolWApi.GetObjById_SchoolAsync)");
console.error(strMsg);
 throw (strMsg);
}
if (strId_School.length != 4)
{
const strMsg = Format("缓存分类变量:[strId_School]的长度:[{0}]不正确!(clsvQx_XzSchoolWApi.GetObjById_SchoolAsync)", strId_School.length);
console.error(strMsg);
throw (strMsg);
}
...
{
const strInfo = Format("网络错误!访问地址:{0}不成功!(in {1}.{2})", strUrl, vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else if (error.statusText == "Not Found")
{
const strInfo = Format("网络错误!访问地址:{0}可能不存在!(in {1}.{2})", strUrl, vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strInfo);
throw(strInfo);
}
else
...
if (IsNullOrEmpty(strId_School) == true)
{
  const strMsg = Format("参数:[strId_School]不能为空!(In clsvQx_XzSchoolWApi.GetObjById_SchoollocalStorage)");
console.error(strMsg);
 throw (strMsg);
}
if (strId_School.length != 4)
{
const strMsg = Format("缓存分类变量:[strId_School]的长度:[{0}]不正确!(clsvQx_XzSchoolWApi.GetObjById_SchoollocalStorage)", strId_School.length);
console.error(strMsg);
throw (strMsg);
}
...
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取相应的对象不成功!(in {2}.{3})", e, strId_School, vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
return;
}
 ...
 * @returns 对象
*/
export  async function vQx_XzSchool_GetObjById_SchoolCache(strId_School: string, bolTryAsyncOnce = true) {
const strThisFuncName = "GetObjById_SchoolCache";

if (IsNullOrEmpty(strId_School) == true)
{
  const strMsg = Format("参数:[strId_School]不能为空!(In clsvQx_XzSchoolWApi.GetObjById_SchoolCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strId_School.length != 4)
{
const strMsg = Format("缓存分类变量:[strId_School]的长度:[{0}]不正确!(clsvQx_XzSchoolWApi.GetObjById_SchoolCache)", strId_School.length);
console.error(strMsg);
throw (strMsg);
}
...
try
{
const arrvQx_XzSchoolSel = arrvQx_XzSchoolObjLstCache.filter(x => 
 x.id_School == strId_School );
...
if (IsNullOrEmpty(strId_School) == true)
{
  const strMsg = Format("参数:[strId_School]不能为空!(In clsvQx_XzSchoolWApi.GetNameById_SchoolCache)");
console.error(strMsg);
 throw (strMsg);
}
if (strId_School.length != 4)
{
const strMsg = Format("缓存分类变量:[strId_School]的长度:[{0}]不正确!(clsvQx_XzSchoolWApi.GetNameById_SchoolCache)", strId_School.length);
console.error(strMsg);
throw (strMsg);
}
const arrvQx_XzSchoolObjLstCache = await vQx_XzSchool_GetObjLstCache();
 ...
 * @returns 返回一个输出字段值
*/
export  async function vQx_XzSchool_func(strInFldName:string , strOutFldName:string , strInValue:string )
{
...
strOutFldName, clsvQx_XzSchoolEN._AttributeName.join(','));
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 返回一个关键字值列表
*/
export  async function vQx_XzSchool_funcKey(strInFldName:string, strInValue: any, strComparisonOp:string): Promise<Array<string>> 
{
...
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strInFldName).toString() == strInValue.toString());
break;
case enumComparisonOp.Like_03:
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strInFldName).toString().indexOf(strInValue.toString()) != -1);
break;
case enumComparisonOp.In_04:
arrValues = strInValue.split(',');
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => arrValues.indexOf(x.GetFldValue(strInFldName).toString()) != -1);
break;
}
break;
case "boolean":
...
{
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strInFldName) == strInValue);
}
break;
case "number":
 ...
 **/
export  async function vQx_XzSchool_GetFldValueAsync(strFldName: string, strWhereCond: string): Promise<Array<string>>  
{
 ...
 * @returns 第一条记录对象
 **/
export  async function vQx_XzSchool_GetFirstObjAsync(strWhereCond: string): Promise<clsvQx_XzSchoolEN|null>  
{
...
const strInfo = Format("[ClientCache]Key:[{0}]的缓存已经建立,对象列表数：{1}!", strKey, arrvQx_XzSchoolExObjLst.length);
console.log(strInfo);
return arrvQx_XzSchoolExObjLst;
}
catch (e)
{
const strMsg = Format("从本地缓存中获取所有对象列表出错. \n服务器错误：{0}.(in {1}.{2})", e, vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
throw (strMsg);
}
}
...
const strInfo = Format("[localStorage]Key:[{0}]的缓存已经建立,对象列表数：{1}!", strKey, arrvQx_XzSchoolExObjLst.length);
console.log(strInfo);
return arrvQx_XzSchoolExObjLst;
}
catch (e)
 ...
 * @returns 获取的相应对象列表
 **/
export  async function vQx_XzSchool_GetObjLstAsync(strWhereCond: string): Promise<Array<clsvQx_XzSchoolEN>>  
{
...
{
const strNullInfo = Format("获取数据为null, 请注意!(in {0}.{1})", vQx_XzSchool_ConstructorName, strThisFuncName);
...
const strInfo = Format("[sessionStorage]Key:[{0}]的缓存已经建立,对象列表数：{1}!", strKey, arrvQx_XzSchoolExObjLst.length);
console.log(strInfo);
return arrvQx_XzSchoolExObjLst;
}
catch (e)
...
if (strComparisonOp == "=") {
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strKey).toString() == strValue.toString());
}
else if (strComparisonOp == "like") {
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strKey).toString().indexOf(strValue.toString()) != -1);
}
else if (strComparisonOp == "length greater") {
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => x.GetFldValue(strKey).toString().length > Number(strValue.toString()));
}
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]缓存对象列表中获取子集对象不成功!(in {2}.{3})", e, JSON.stringify( objvQx_XzSchoolCond), vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
 ...
 * @returns 对象列表
 **/
export  async function vQx_XzSchool_GetObjLstById_SchoolLstAsync(arrId_School: Array<string>): Promise<Array<clsvQx_XzSchoolEN>>  
{
...
{
const arrvQx_XzSchoolObjLstCache = await vQx_XzSchool_GetObjLstCache();
const arrvQx_XzSchoolSel = arrvQx_XzSchoolObjLstCache.filter(x => arrId_SchoolLst.indexOf(x.id_School)>-1);
return arrvQx_XzSchoolSel;
}
catch (e)
{
const strMsg = Format("错误:[{0}]. \n根据关键字:[{1}]获取对象列表不成功!(in {2}.{3})", e, arrId_SchoolLst.join(","), vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
}
 ...
 * @returns 获取的相应对象列表
 **/
export  async function vQx_XzSchool_GetTopObjLstAsync(objTopPara: stuTopPara): Promise<Array<clsvQx_XzSchoolEN>>  
{
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function vQx_XzSchool_GetObjLstByRangeAsync(objRangePara: stuRangePara): Promise<Array<clsvQx_XzSchoolEN>>  
{
...
let arrvQx_XzSchoolSel = arrvQx_XzSchoolObjLstCache;
if (objvQx_XzSchoolCond.GetConditions().length == 0) return arrvQx_XzSchoolSel.length>0?true:false;
try {
for (const objCondition of objvQx_XzSchoolCond.GetConditions()) {
if (objCondition == null) continue; 
const strKey = objCondition.fldName;
...
const strMsg = Format("根据条件:[{0}]判断是否存在不成功!(in {1}.{2})", JSON.stringify( objvQx_XzSchoolCond), vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return false;
...
try
{
const arrvQx_XzSchoolSel = arrvQx_XzSchoolObjLstCache.filter(x => x.id_School == strId_School);
if (arrvQx_XzSchoolSel.length > 0)
{
return true;
}
...
{
const strMsg = Format("根据关键字:[{0}]判断是否存在不成功!(in {1}.{2})", strId_School, vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
return false;
 ...
 * @returns 对象列表记录数
*/
export  async function vQx_XzSchool_GetRecCountByCondCache(objvQx_XzSchoolCond: ConditionCollection ) {
...
arrvQx_XzSchoolSel = arrvQx_XzSchoolSel.filter(x => arrValues.indexOf(x.GetFldValue(strKey).toString()) != -1);
}
break;
case "boolean":
if (strValue == null) continue;
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]从缓存对象列表中获取记录数不成功!(in {2}.{3})", e, JSON.stringify( objvQx_XzSchoolCond), vQx_XzSchool_ConstructorName, strThisFuncName);
console.error(strMsg);
throw new Error(strMsg);
}
return 0;
...
*/
export  async function vQx_XzSchool_BindDdl_Id_SchoolInDivCache(objDiv: HTMLDivElement, strDdlName: string )
{
...
BindDdl_ObjLstInDivObj_V(objDiv, strDdlName, arrObjLstSel, clsvQx_XzSchoolEN.con_Id_School, clsvQx_XzSchoolEN.con_SchoolName, "选vQx_XzSchool...");
}
 ...
 * @returns 返回一个生成的对象列表
*/
export  function vQx_XzSchool_GetObjLstByJSONObjLst (arrvQx_XzSchoolObjLstS: Array<clsvQx_XzSchoolEN>): Array<clsvQx_XzSchoolEN>
{
...
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_Id_School) == true)
{
const strComparisonOpId_School:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_Id_School];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_Id_School, objvQx_XzSchoolCond.id_School, strComparisonOpId_School);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_SchoolId) == true)
{
const strComparisonOpSchoolId:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_SchoolId];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_SchoolId, objvQx_XzSchoolCond.schoolId, strComparisonOpSchoolId);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_SchoolName) == true)
{
const strComparisonOpSchoolName:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_SchoolName];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_SchoolName, objvQx_XzSchoolCond.schoolName, strComparisonOpSchoolName);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_SchoolTypeId) == true)
{
const strComparisonOpSchoolTypeId:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_SchoolTypeId];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_SchoolTypeId, objvQx_XzSchoolCond.schoolTypeId, strComparisonOpSchoolTypeId);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_SchoolTypeName) == true)
{
const strComparisonOpSchoolTypeName:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_SchoolTypeName];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_SchoolTypeName, objvQx_XzSchoolCond.schoolTypeName, strComparisonOpSchoolTypeName);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_Memo) == true)
{
const strComparisonOpMemo:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_Memo, objvQx_XzSchoolCond.memo, strComparisonOpMemo);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_IsCurrentUse) == true)
{
...
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_SchoolNameA) == true)
{
const strComparisonOpSchoolNameA:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_SchoolNameA];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_SchoolNameA, objvQx_XzSchoolCond.schoolNameA, strComparisonOpSchoolNameA);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_UpdDate) == true)
{
const strComparisonOpUpdDate:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_UpdDate, objvQx_XzSchoolCond.updDate, strComparisonOpUpdDate);
}
if (Object.prototype.hasOwnProperty.call(objvQx_XzSchoolCond.dicFldComparisonOp, clsvQx_XzSchoolEN.con_UpdUserId) == true)
{
const strComparisonOpUpdUserId:string = objvQx_XzSchoolCond.dicFldComparisonOp[clsvQx_XzSchoolEN.con_UpdUserId];
strWhereCond += Format(" And {0} {2} '{1}'", clsvQx_XzSchoolEN.con_UpdUserId, objvQx_XzSchoolCond.updUserId, strComparisonOpUpdUserId);
}
 return strWhereCond;
}
...
*/
export  function vQx_XzSchool_GetObjFromJsonObj(objvQx_XzSchoolENS: clsvQx_XzSchoolEN): clsvQx_XzSchoolEN 
{
