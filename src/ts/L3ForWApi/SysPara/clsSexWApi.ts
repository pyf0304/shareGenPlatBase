...
let arrSexSel = arrSexObjLstCache;
if (objSexCond.sfFldComparisonOp == null || objSexCond.sfFldComparisonOp == "") return arrSexSel.length>0?true:false;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSexCond.sfFldComparisonOp);
//console.log("clsSexWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
...
let arrSexSel = arrSexObjLstCache;
if (objSexCond.sfFldComparisonOp == null || objSexCond.sfFldComparisonOp == "") return arrSexSel.length;
const dicFldComparisonOp: { [index: string]: string } = JSON.parse(objSexCond.sfFldComparisonOp);
//console.log("clsSexWApi->GetSubObjLstCache->dicFldComparisonOp:");
//console.log(dicFldComparisonOp);
try {
