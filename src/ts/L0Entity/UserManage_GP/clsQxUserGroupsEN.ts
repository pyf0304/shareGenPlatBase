...
public static _CurrTabName= "QxUserGroups"; //当前表名,与该类相关的表名
public static _KeyFldName= "GroupId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 4;
public static AttributeName = ["groupId", "groupName", "qxPrjId", "memo"];
//以下是属性变量
