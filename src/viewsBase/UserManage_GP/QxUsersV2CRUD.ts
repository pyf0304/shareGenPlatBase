...
import { CombineQxUsersV2Condition,divVarSet,viewVarSet,dataColumn,BindTabByList,refQxUsersV2_List } from "@/views/UserManage_GP/QxUsersV2VueShare";
import { QxUsersV2_GetRecCountByCondAsync,QxUsersV2_GetObjLstAsync,QxUsersV2_DelRecordAsync,QxUsersV2_GetObjByidAsync,QxUsersV2_FuncMapByFldName,QxUsersV2_GetObjLstByidLstAsync,QxUsersV2_AddNewRecordAsync,QxUsersV2_DelQxUsersV2sAsync } from "@/ts/L3ForWApi/UserManage_GP/clsQxUsersV2WApi";
...
if (viewVarSet.sortQxUsersV2By == '') viewVarSet.sortQxUsersV2By = `${ clsQxUsersV2EN.con_CreateTime } Asc`;
 ...
 **/
public CombineData(arrQxUsersV2ObjLst: Array<clsQxUsersV2EN>, arrDataColumn: Array<clsDataColumn>): ExportExcelData 
{
...
const strFileName = Format("用户V2({0})导出.xlsx",
 clsQxUsersV2EN._CurrTabName);
...
{
const strMsg = Format("在显示列表时,排序字段(sortQxUsersV2By)为空,请检查!(In BindGv_QxUsersV2Cache)");
 ...
 **/
public async BindTab_QxUsersV2(divContainer: HTMLDivElement, arrQxUsersV2ExObjLst: Array<clsQxUsersV2ENEx>) 
{
 ...
 **/
public async ExtendFldFuncMap(arrQxUsersV2ExObjLst: Array<clsQxUsersV2ENEx>, arrDataColumn: Array<clsDataColumn>) {
...
if (viewVarSet.sortQxUsersV2By == null)
{
const strMsg = Format("在显示列表时,排序字段(sortQxUsersV2By)为空,请检查!(In BindGv_QxUsersV2)");
console.error(strMsg);
alert(strMsg);
return;
}
...
const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(objAnchorElement, viewVarSet.ascOrDesc4SortFun, viewVarSet.sortQxUsersV2By, strSortExpress);
// 将 sortBy 按空格分成两部分
