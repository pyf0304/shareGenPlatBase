 ...
 **/
export  function PageDispModeEx_CopyToEx(objPageDispModeENS:clsPageDispModeEN ): clsPageDispModeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, pageDispModeEx_ConstructorName, strThisFuncName);
...
*/
export  function PageDispModeEx_FuncMapByFldName(strFldName: string, objPageDispModeEx: clsPageDispModeENEx)
{
