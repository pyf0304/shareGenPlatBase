...
export const CombineXzSchoolCondition = async (): Promise<string> => {
  ...
  try {
    ...
    const strMsg: string = Format(
      '在组合查询条件(CombineXzSchoolCondition)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
...
export const CombineXzSchoolConditionObj = async (): Promise<ConditionCollection> => {
  ...
  try {
    ...
    const strMsg: string = Format(
      '在组合查询条件对象(CombineXzSchoolConditionObj)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
...
export const CombineXzSchoolConditionObj4ExportExcel = async (): Promise<ConditionCollection> => {
  ...
  try {
    ...
    const strMsg: string = Format(
      '在组合导出Excel条件对象(CombineXzSchoolConditionObj4ExportExcel)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
...
export function XzSchool_DeleteKeyIdCache(strIdSchool: string): void {
  if (IsNullOrEmpty(strIdSchool) == false) {
    // 使用 delete 删除特定的键
