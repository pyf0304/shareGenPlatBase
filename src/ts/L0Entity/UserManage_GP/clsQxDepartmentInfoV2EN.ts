...
public static readonly _CurrTabName: string = "QxDepartmentInfoV2"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "DepartmentIdInt"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 10;
public static readonly _AttributeName = ["departmentIdInt", "departmentName", "departmentAbbrName", "departmentTypeId", "parentDepId", "orderNum", "inUse", "memo", "createTime", "updateTime"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_parentDepId = "parentDepId";    //所属部门号
...
//return propName in new clsQxDepartmentInfoV2EN();
const instance = new clsQxDepartmentInfoV2EN();
