 ...
 * @returns 对象
 **/
export async function FuncModule_GetObjByFuncModuleIdAsync(
  strFuncModuleId: string,
): Promise<clsFuncModuleEN | null> {
  const strThisFuncName = 'GetObjByFuncModuleIdAsync';

  if (IsNullOrEmpty(strFuncModuleId) == true) {
    const strMsg = Format(
      '参数:[strFuncModuleId]不能为空!(In clsFuncModuleWApi.GetObjByFuncModuleIdAsync)',
    );
  ...
  if (strFuncModuleId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strFuncModuleId]的长度:[{0}]不正确!(clsFuncModuleWApi.GetObjByFuncModuleIdAsync)',
      strFuncModuleId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function FuncModule_GetObjByFuncModuleIdlocalStorage(strFuncModuleId: string) {
  ...
  if (IsNullOrEmpty(strFuncModuleId) == true) {
    const strMsg = Format(
      '参数:[strFuncModuleId]不能为空!(In clsFuncModuleWApi.GetObjByFuncModuleIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strFuncModuleId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strFuncModuleId]的长度:[{0}]不正确!(clsFuncModuleWApi.GetObjByFuncModuleIdlocalStorage)',
      strFuncModuleId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function FuncModule_GetObjByFuncModuleIdCache(
  strFuncModuleId: string,
  ...
  if (IsNullOrEmpty(strFuncModuleId) == true) {
    const strMsg = Format(
      '参数:[strFuncModuleId]不能为空!(In clsFuncModuleWApi.GetObjByFuncModuleIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strFuncModuleId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strFuncModuleId]的长度:[{0}]不正确!(clsFuncModuleWApi.GetObjByFuncModuleIdCache)',
      strFuncModuleId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrFuncModuleSel = arrFuncModuleObjLstCache.filter(
      (x) => x.funcModuleId == strFuncModuleId,
    );
...
export async function FuncModule_UpdateObjInLstCache(objFuncModule: clsFuncModuleEN) {
  ...
  try {
    const arrFuncModuleObjLstCache = await FuncModule_GetObjLstCache();
    const obj = arrFuncModuleObjLstCache.find((x) => x.funcModuleId == objFuncModule.funcModuleId);
    if (obj != null) {
...
export async function FuncModule_GetNameByFuncModuleIdCache(strFuncModuleId: string) {
  if (IsNullOrEmpty(strFuncModuleId) == true) {
    const strMsg = Format(
      '参数:[strFuncModuleId]不能为空!(In clsFuncModuleWApi.GetNameByFuncModuleIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strFuncModuleId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strFuncModuleId]的长度:[{0}]不正确!(clsFuncModuleWApi.GetNameByFuncModuleIdCache)',
      strFuncModuleId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function FuncModule_func(
  strInFldName: string,
  ...
  if (clsFuncModuleEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsFuncModuleEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function FuncModule_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrFuncModuleSel = arrFuncModuleSel.filter(
 ...
 **/
export async function FuncModule_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function FuncModule_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsFuncModuleEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function FuncModule_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsFuncModuleEN>> {
...
export async function FuncModule_GetSubObjLstCache(objFuncModuleCond: clsFuncModuleEN) {
  ...
  if (objFuncModuleCond.sfFldComparisonOp == null || objFuncModuleCond.sfFldComparisonOp == '')
    return arrFuncModuleSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objFuncModuleCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objFuncModuleCond),
      funcModule_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function FuncModule_GetObjLstByFuncModuleIdLstAsync(
  arrFuncModuleId: Array<string>,
): Promise<Array<clsFuncModuleEN>> {
 ...
 * @returns 对象列表
 */
export async function FuncModule_GetObjLstByFuncModuleIdLstCache(
  arrFuncModuleIdLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstByFuncModuleIdLstCache';
  try {
    const arrFuncModuleObjLstCache = await FuncModule_GetObjLstCache();
    const arrFuncModuleSel = arrFuncModuleObjLstCache.filter(
      (x) => arrFuncModuleIdLst.indexOf(x.funcModuleId) > -1,
    );
    return arrFuncModuleSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function FuncModule_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function FuncModule_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function FuncModule_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function FuncModule_DelFuncModulesAsync(
  arrFuncModuleId: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function FuncModule_AddNewRecordAsync(
  objFuncModuleEN: clsFuncModuleEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function FuncModule_AddNewRecordWithMaxIdAsync(
  objFuncModuleEN: clsFuncModuleEN,
): Promise<string> {
 ...
 **/
export async function FuncModule_AddNewObjSave(
  objFuncModuleEN: clsFuncModuleEN,
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function FuncModule_AddNewRecordWithReturnKeyAsync(
  objFuncModuleEN: clsFuncModuleEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function FuncModule_UpdateRecordAsync(
  objFuncModuleEN: clsFuncModuleEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objFuncModuleEN.sfUpdFldSetStr === undefined ||
    objFuncModuleEN.sfUpdFldSetStr === null ||
    objFuncModuleEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function FuncModule_EditRecordExAsync(
  objFuncModuleEN: clsFuncModuleEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function FuncModule_UpdateWithConditionAsync(
  objFuncModuleEN: clsFuncModuleEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function FuncModule_IsExistRecordCache(objFuncModuleCond: clsFuncModuleEN) {
  ...
  let arrFuncModuleSel = arrFuncModuleObjLstCache;
  if (objFuncModuleCond.sfFldComparisonOp == null || objFuncModuleCond.sfFldComparisonOp == '')
    return arrFuncModuleSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objFuncModuleCond.sfFldComparisonOp,
  );
  //console.log("clsFuncModuleWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
*/
export async function FuncModule_BindDdl_FuncModuleIdInDivCache(
  ...
  BindDdl_ObjLstInDivObj(
    ...
    strDdlName,
    arrObjLstSel,
    clsFuncModuleEN.con_FuncModuleId,
    clsFuncModuleEN.con_FuncModuleName,
    '选模块...',
  );
}
...
export function FuncModule_CheckPropertyNew(pobjFuncModuleEN: clsFuncModuleEN) {
  ...
  if (IsNullOrEmpty(pobjFuncModuleEN.funcModuleName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[功能模块名称]不能为空(In 功能模块)!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    null === pobjFuncModuleEN.orderNum ||
    (pobjFuncModuleEN.orderNum != null && pobjFuncModuleEN.orderNum.toString() === '')
  ) {
    throw new Error(
      `(errid:Watl000411)字段[序号]不能为空(In 功能模块)!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (IsNullOrEmpty(pobjFuncModuleEN.useStateId) === true) {
    throw new Error(
      `(errid:Watl000411)字段[UseStateId]不能为空(In 功能模块)!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleId) == false &&
    GetStrLen(pobjFuncModuleEN.funcModuleId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[功能模块Id(funcModuleId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleId}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleName) == false &&
    GetStrLen(pobjFuncModuleEN.funcModuleName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[功能模块名称(funcModuleName)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleName}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleNameSim) == false &&
    GetStrLen(pobjFuncModuleEN.funcModuleNameSim) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[功能模块简称(funcModuleNameSim)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleNameSim}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjFuncModuleEN.memo) == false && GetStrLen(pobjFuncModuleEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.memo}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updDate) == false &&
    GetStrLen(pobjFuncModuleEN.updDate) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.updDate}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updUser) == false &&
    GetStrLen(pobjFuncModuleEN.updUser) > 20
  ) {
    throw new Error(
      `(errid:Watl000413)字段[修改人(updUser)]的长度不能超过20(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.updUser}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjFuncModuleEN.prjId) == false && GetStrLen(pobjFuncModuleEN.prjId) > 4) {
    throw new Error(
      `(errid:Watl000413)字段[PrjId(prjId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.prjId}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleEnName) == false &&
    GetStrLen(pobjFuncModuleEN.funcModuleEnName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[FuncModuleEnName(funcModuleEnName)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleEnName}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.useStateId) == false &&
    GetStrLen(pobjFuncModuleEN.useStateId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[UseStateId(useStateId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.useStateId}(clsFuncModuleBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleId) == false &&
    undefined !== pobjFuncModuleEN.funcModuleId &&
    tzDataType.isString(pobjFuncModuleEN.funcModuleId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[功能模块Id(funcModuleId)]的值:[${pobjFuncModuleEN.funcModuleId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleName) == false &&
    undefined !== pobjFuncModuleEN.funcModuleName &&
    tzDataType.isString(pobjFuncModuleEN.funcModuleName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[功能模块名称(funcModuleName)]的值:[${pobjFuncModuleEN.funcModuleName}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleNameSim) == false &&
    undefined !== pobjFuncModuleEN.funcModuleNameSim &&
    tzDataType.isString(pobjFuncModuleEN.funcModuleNameSim) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[功能模块简称(funcModuleNameSim)]的值:[${pobjFuncModuleEN.funcModuleNameSim}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.memo) == false &&
    undefined !== pobjFuncModuleEN.memo &&
    tzDataType.isString(pobjFuncModuleEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjFuncModuleEN.memo}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updDate) == false &&
    undefined !== pobjFuncModuleEN.updDate &&
    tzDataType.isString(pobjFuncModuleEN.updDate) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改日期(updDate)]的值:[${pobjFuncModuleEN.updDate}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updUser) == false &&
    undefined !== pobjFuncModuleEN.updUser &&
    tzDataType.isString(pobjFuncModuleEN.updUser) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[修改人(updUser)]的值:[${pobjFuncModuleEN.updUser}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjFuncModuleEN.orderNum &&
    undefined !== pobjFuncModuleEN.orderNum &&
    tzDataType.isNumber(pobjFuncModuleEN.orderNum) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[序号(orderNum)]的值:[${pobjFuncModuleEN.orderNum}], 非法,应该为数值型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.prjId) == false &&
    undefined !== pobjFuncModuleEN.prjId &&
    tzDataType.isString(pobjFuncModuleEN.prjId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[PrjId(prjId)]的值:[${pobjFuncModuleEN.prjId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleEnName) == false &&
    undefined !== pobjFuncModuleEN.funcModuleEnName &&
    tzDataType.isString(pobjFuncModuleEN.funcModuleEnName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[FuncModuleEnName(funcModuleEnName)]的值:[${pobjFuncModuleEN.funcModuleEnName}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.useStateId) == false &&
    undefined !== pobjFuncModuleEN.useStateId &&
    tzDataType.isString(pobjFuncModuleEN.useStateId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[UseStateId(useStateId)]的值:[${pobjFuncModuleEN.useStateId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckPropertyNew0)`,
    );
  }
...
export function FuncModule_CheckProperty4Update(pobjFuncModuleEN: clsFuncModuleEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[功能模块Id(funcModuleId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleId}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[功能模块名称(funcModuleName)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleName}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleNameSim) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[功能模块简称(funcModuleNameSim)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleNameSim}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjFuncModuleEN.memo) == false && GetStrLen(pobjFuncModuleEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.memo}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.updDate}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[修改人(updUser)]的长度不能超过20(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.updUser}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjFuncModuleEN.prjId) == false && GetStrLen(pobjFuncModuleEN.prjId) > 4) {
    throw new Error(
      `(errid:Watl000416)字段[PrjId(prjId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.prjId}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleEnName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[FuncModuleEnName(funcModuleEnName)]的长度不能超过30(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.funcModuleEnName}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.useStateId) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[UseStateId(useStateId)]的长度不能超过4(In 功能模块(FuncModule))!值:${pobjFuncModuleEN.useStateId}(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[功能模块Id(funcModuleId)]的值:[${pobjFuncModuleEN.funcModuleId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[功能模块名称(funcModuleName)]的值:[${pobjFuncModuleEN.funcModuleName}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleNameSim) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[功能模块简称(funcModuleNameSim)]的值:[${pobjFuncModuleEN.funcModuleNameSim}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjFuncModuleEN.memo}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updDate) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改日期(updDate)]的值:[${pobjFuncModuleEN.updDate}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.updUser) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[修改人(updUser)]的值:[${pobjFuncModuleEN.updUser}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjFuncModuleEN.orderNum &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[序号(orderNum)]的值:[${pobjFuncModuleEN.orderNum}], 非法,应该为数值型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.prjId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[PrjId(prjId)]的值:[${pobjFuncModuleEN.prjId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleEnName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[FuncModuleEnName(funcModuleEnName)]的值:[${pobjFuncModuleEN.funcModuleEnName}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjFuncModuleEN.useStateId) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[UseStateId(useStateId)]的值:[${pobjFuncModuleEN.useStateId}], 非法,应该为字符型(In 功能模块(FuncModule))!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    IsNullOrEmpty(pobjFuncModuleEN.funcModuleId) === true ||
    pobjFuncModuleEN.funcModuleId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000064)字段[功能模块Id]不能为空(In 功能模块)!(clsFuncModuleBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function FuncModule_GetObjLstByJSONObjLst(
  arrFuncModuleObjLstS: Array<clsFuncModuleEN>,
): Array<clsFuncModuleEN> {
...
export function FuncModule_GetCombineCondition(objFuncModuleCond: clsFuncModuleEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_FuncModuleId,
    ) == true
  ) {
    const strComparisonOpFuncModuleId: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_FuncModuleId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_FuncModuleId,
      objFuncModuleCond.funcModuleId,
  ...
  if (
    ...
    const strComparisonOpFuncModuleName: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_FuncModuleName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_FuncModuleName,
      objFuncModuleCond.funcModuleName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_FuncModuleNameSim,
    ) == true
  ) {
    const strComparisonOpFuncModuleNameSim: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_FuncModuleNameSim];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_FuncModuleNameSim,
      objFuncModuleCond.funcModuleNameSim,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_Memo,
      objFuncModuleCond.memo,
      strComparisonOpMemo,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_UpdDate,
    ) == true
  ) {
    const strComparisonOpUpdDate: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_UpdDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_UpdDate,
      objFuncModuleCond.updDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_UpdUser,
    ) == true
  ) {
    const strComparisonOpUpdUser: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_UpdUser];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_UpdUser,
      objFuncModuleCond.updUser,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_OrderNum,
    ) == true
  ) {
    const strComparisonOpOrderNum: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_OrderNum];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsFuncModuleEN.con_OrderNum,
      objFuncModuleCond.orderNum,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_PrjId,
    ) == true
  ) {
    const strComparisonOpPrjId: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_PrjId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_PrjId,
      objFuncModuleCond.prjId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_FuncModuleEnName,
    ) == true
  ) {
    const strComparisonOpFuncModuleEnName: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_FuncModuleEnName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_FuncModuleEnName,
      objFuncModuleCond.funcModuleEnName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objFuncModuleCond.dicFldComparisonOp,
      clsFuncModuleEN.con_UseStateId,
    ) == true
  ) {
    const strComparisonOpUseStateId: string =
      objFuncModuleCond.dicFldComparisonOp[clsFuncModuleEN.con_UseStateId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsFuncModuleEN.con_UseStateId,
      objFuncModuleCond.useStateId,
 ...
 */
export function FuncModule_CopyObjTo(
  objFuncModuleENS: clsFuncModuleEN,
  objFuncModuleENT: clsFuncModuleEN,
): void {
