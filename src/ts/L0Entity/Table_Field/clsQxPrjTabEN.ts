...
public static readonly _CurrTabName: string = "QxPrjTab"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "TabId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 20;
public static readonly _AttributeName = ["tabId", "tabName", "tabCnName", "qxPrjId", "sQLDSTypeId", "tabStateId", "isParaTab", "funcModuleAgcId", "owner", "keyword", "tabTypeId", "relaViewId", "primaryTypeId", "primaryTypeName", "keyFldId", "keyFldName", "updUserId", "updDate", "memo", "synchDate"];
//以下是属性变量
