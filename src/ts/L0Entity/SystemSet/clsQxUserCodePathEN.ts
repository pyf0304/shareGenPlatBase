...
public static readonly _CurrTabName: string = "QxUserCodePath"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 11;
public static readonly _AttributeName = ["mId", "qxPrjId", "userId", "qxCodeTypeId", "codePath", "codePathBackup", "isTemplate", "updDate", "updUserId", "memo", "isGeneReport"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_QxCodeTypeId = "qxCodeTypeId";    //代码类型Id

 /**
 * 常量:"CodePath"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_CodePath = "codePath";    //代码路径

 /**
 * 常量:"CodePathBackup"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_CodePathBackup = "codePathBackup";    //备份代码路径

 /**
 * 常量:"IsTemplate"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsTemplate = "isTemplate";    //是否模板
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsGeneReport = "isGeneReport";    //IsGeneReport
