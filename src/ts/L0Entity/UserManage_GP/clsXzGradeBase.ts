...
export class clsXzGradeBase {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_GradeBaseId(): string {
    return 'gradeBaseId';
  } //年级代号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_GradeBaseNameA(): string {
    return 'gradeBaseNameA';
  } //年级名称缩写
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_EnterSchoolDate(): string {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_CurrentTermSeq(): string {
    return 'currentTermSeq';
  } //当前学期
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_ExecPlanTermIndex(): string {
    return 'execPlanTermIndex';
  } //生成执行计划学期
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_SetEPTermIndexDate(): string {
    return 'setEPTermIndexDate';
  } //设定执行计划学期日期
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IsOffed(): string {
    return 'isOffed';
  } //是否毕业
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_GradeIndex(): string {
    return 'gradeIndex';
  } //年级序号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_BeginYearMonth(): string {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_EndYearMonth(): string {
    return 'endYearMonth';
  } //结束年月
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_AllowUpBaseInfo(): string {
    return 'allowUpBaseInfo';
  } //允许修改基本信息
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_PointCalcVersionId(): string {
    return 'pointCalcVersionId';
  } //绩点计算版本Id
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IdStudyLevel(): string {
    return 'idStudyLevel';
  } //学段流水号
