 ...
 **/
export async function QxPrjMenus_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
 ...
 */
export function QxPrjMenus_FuncMapByFldName(
  strFldName: string,
...
export async function QxPrjMenus_FuncMapUpMenuName(objQxPrjMenus: clsQxPrjMenusENEx) {
  ...
  try {
    if (IsNullOrEmpty(objQxPrjMenus.upMenuName) == true) {
      ...
      const vQxPrjMenusSimMenuName = await vQxPrjMenusSim_func(
        clsvQxPrjMenusSimEN.con_MenuId,
        clsvQxPrjMenusSimEN.con_MenuName,
        vQxPrjMenusSimMenuId,
    ...
    const strMsg = Format(
      '(errid:Watl001493)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      qxPrjMenus_ConstructorName,
      strThisFuncName,
    );
 ...
 **/
export async function QxPrjMenus_AddNewObjSave(
  objQxPrjMenusEN: clsQxPrjMenusEN,
 ...
 **/
export async function QxPrjMenus_CheckUniCond4Add(
  objQxPrjMenusEN: clsQxPrjMenusEN,
): Promise<boolean> {
 ...
 **/
export async function QxPrjMenus_CheckUniCond4Update(
  objQxPrjMenusEN: clsQxPrjMenusEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function QxPrjMenus_EditRecordExAsync(
  objQxPrjMenusEN: clsQxPrjMenusEN,
): Promise<boolean> {
...
*/
export async function QxPrjMenus_BindDdl_MenuIdByMenuSetIdInDiv(
 ...
 * @param strQxPrjId:
*/
export async function QxPrjMenus_BindDdl_MenuIdByQxPrjIdInDiv(
  objDiv: HTMLDivElement,
  strDdlName: string,
  strQxPrjId: string,
) {
