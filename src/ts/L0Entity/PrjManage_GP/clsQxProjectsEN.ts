...
public static readonly _CurrTabName: string = "QxProjects"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "QxPrjId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 8;
public static readonly _AttributeName = ["qxPrjId", "prjName", "prjDomain", "isDefaultPrj", "qxPrjDataBaseId", "updDate", "updUser", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_PrjDomain = "prjDomain";    //工程域名

 /**
 * 常量:"IsDefaultPrj"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsDefaultPrj = "isDefaultPrj";    //是否默认工程
