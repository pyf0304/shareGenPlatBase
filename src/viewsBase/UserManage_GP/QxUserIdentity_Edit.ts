...
import { QxUserIdentity_CheckPropertyNew,QxUserIdentity_IsExistAsync,QxUserIdentity_AddNewRecordAsync,QxUserIdentity_ReFreshCache,QxUserIdentity_AddNewRecordWithMaxIdAsync,QxUserIdentity_GetObjByIdentityIdAsync,QxUserIdentity_CheckProperty4Update,QxUserIdentity_UpdateRecordAsync } from "@/ts/L3ForWApi/UserManage_GP/clsQxUserIdentityWApi";
import { clsQxUserIdentityEN } from "@/ts/L0Entity/UserManage_GP/clsQxUserIdentityEN";
import { QxUserIdentity_DeleteKeyIdCache,divVarSet,refQxUserIdentity_Edit } from "@/viewsShare/UserManage_GP/QxUserIdentityVueShare";
...
if (this.iShowList != null) this.iShowList.BindGvCache(clsQxUserIdentityEN._CurrTabName, returnKeyId);
}
}
else
{
...
if (this.iShowList != null) this.iShowList.BindGvCache(clsQxUserIdentityEN._CurrTabName, this.keyId);
}
}
break;
case "确认修改":
