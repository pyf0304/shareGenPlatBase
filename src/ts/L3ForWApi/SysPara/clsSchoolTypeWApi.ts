 ...
 * @returns 对象
 **/
export async function SchoolType_GetObjBySchoolTypeIdAsync(
  strSchoolTypeId: string,
): Promise<clsSchoolTypeEN | null> {
  const strThisFuncName = 'GetObjBySchoolTypeIdAsync';

  if (IsNullOrEmpty(strSchoolTypeId) == true) {
    const strMsg = Format(
      '参数:[strSchoolTypeId]不能为空!(In clsSchoolTypeWApi.GetObjBySchoolTypeIdAsync)',
    );
  ...
  if (strSchoolTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strSchoolTypeId]的长度:[{0}]不正确!(clsSchoolTypeWApi.GetObjBySchoolTypeIdAsync)',
      strSchoolTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function SchoolType_GetObjBySchoolTypeIdlocalStorage(strSchoolTypeId: string) {
  ...
  if (IsNullOrEmpty(strSchoolTypeId) == true) {
    const strMsg = Format(
      '参数:[strSchoolTypeId]不能为空!(In clsSchoolTypeWApi.GetObjBySchoolTypeIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strSchoolTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strSchoolTypeId]的长度:[{0}]不正确!(clsSchoolTypeWApi.GetObjBySchoolTypeIdlocalStorage)',
      strSchoolTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function SchoolType_GetObjBySchoolTypeIdCache(
  strSchoolTypeId: string,
  ...
  if (IsNullOrEmpty(strSchoolTypeId) == true) {
    const strMsg = Format(
      '参数:[strSchoolTypeId]不能为空!(In clsSchoolTypeWApi.GetObjBySchoolTypeIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strSchoolTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strSchoolTypeId]的长度:[{0}]不正确!(clsSchoolTypeWApi.GetObjBySchoolTypeIdCache)',
      strSchoolTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrSchoolTypeSel = arrSchoolTypeObjLstCache.filter(
      (x) => x.schoolTypeId == strSchoolTypeId,
    );
...
export async function SchoolType_UpdateObjInLstCache(objSchoolType: clsSchoolTypeEN) {
  ...
  try {
    const arrSchoolTypeObjLstCache = await SchoolType_GetObjLstCache();
    const obj = arrSchoolTypeObjLstCache.find((x) => x.schoolTypeId == objSchoolType.schoolTypeId);
    if (obj != null) {
...
export async function SchoolType_GetNameBySchoolTypeIdCache(strSchoolTypeId: string) {
  if (IsNullOrEmpty(strSchoolTypeId) == true) {
    const strMsg = Format(
      '参数:[strSchoolTypeId]不能为空!(In clsSchoolTypeWApi.GetNameBySchoolTypeIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strSchoolTypeId.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strSchoolTypeId]的长度:[{0}]不正确!(clsSchoolTypeWApi.GetNameBySchoolTypeIdCache)',
      strSchoolTypeId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function SchoolType_func(
  strInFldName: string,
  ...
  if (clsSchoolTypeEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsSchoolTypeEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function SchoolType_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrSchoolTypeSel = arrSchoolTypeSel.filter(
 ...
 **/
export async function SchoolType_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function SchoolType_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsSchoolTypeEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function SchoolType_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsSchoolTypeEN>> {
 ...
 * @returns 对象列表子集
 */
export async function SchoolType_GetSubObjLstCache(objSchoolTypeCond: clsSchoolTypeEN) {
  const strThisFuncName = 'GetSubObjLstCache';
  const arrSchoolTypeObjLstCache = await SchoolType_GetObjLstCache();
  let arrSchoolTypeSel = arrSchoolTypeObjLstCache;
  if (objSchoolTypeCond.sfFldComparisonOp == null || objSchoolTypeCond.sfFldComparisonOp == '')
    return arrSchoolTypeSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objSchoolTypeCond.sfFldComparisonOp,
  );
  //console.log("clsSchoolTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    const sstrKeys = GetObjKeys(objSchoolTypeCond);
    //console.log(sstrKeys);
    for (const strKey of sstrKeys) {
      if (Object.prototype.hasOwnProperty.call(dicFldComparisonOp, strKey) == false) continue;
      arrSchoolTypeSel = arrSchoolTypeSel.filter((x) => x.GetFldValue(strKey) != null);
      const strComparisonOp = dicFldComparisonOp[strKey];
      const strValue = objSchoolTypeCond.GetFldValue(strKey);
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objSchoolTypeCond),
      schoolType_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function SchoolType_GetObjLstBySchoolTypeIdLstAsync(
  arrSchoolTypeId: Array<string>,
): Promise<Array<clsSchoolTypeEN>> {
 ...
 * @returns 对象列表
 */
export async function SchoolType_GetObjLstBySchoolTypeIdLstCache(
  arrSchoolTypeIdLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstBySchoolTypeIdLstCache';
  try {
    const arrSchoolTypeObjLstCache = await SchoolType_GetObjLstCache();
    const arrSchoolTypeSel = arrSchoolTypeObjLstCache.filter(
      (x) => arrSchoolTypeIdLst.indexOf(x.schoolTypeId) > -1,
    );
    return arrSchoolTypeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function SchoolType_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function SchoolType_GetObjLstByRangeAsync(
 ...
 * @returns 对象列表
 */
export async function SchoolType_GetObjLstByPagerCache(objPagerPara: stuPagerPara) {
  const strThisFuncName = 'GetObjLstByPagerCache';
  if (objPagerPara.pageIndex == 0) return new Array<clsSchoolTypeEN>();
  const arrSchoolTypeObjLstCache = await SchoolType_GetObjLstCache();
  if (arrSchoolTypeObjLstCache.length == 0) return arrSchoolTypeObjLstCache;
  let arrSchoolTypeSel = arrSchoolTypeObjLstCache;
  const objCond = JSON.parse(objPagerPara.whereCond);
  const objSchoolTypeCond = new clsSchoolTypeEN();
  ObjectAssign(objSchoolTypeCond, objCond);
  let dicFldComparisonOp: { [index: string]: string } = {};
  if (objCond.sfFldComparisonOp != '') {
    dicFldComparisonOp = JSON.parse(objCond.sfFldComparisonOp);
  }
  //console.log("clsSchoolTypeWApi->GetObjLstByPagerCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    ...
    if (arrSchoolTypeSel.length == 0) return arrSchoolTypeSel;
    ...
    if (objPagerPara.orderBy != null && objPagerPara.orderBy.length > 0) {
      ...
      arrSchoolTypeSel = arrSchoolTypeSel.sort(SchoolType_SortFunByKey(strSortFld, strSortType));
    } else {
      //如果排序字段名[OrderBy]为空,就调用排序函数
      arrSchoolTypeSel = arrSchoolTypeSel.sort(objPagerPara.sortFun);
    }
    arrSchoolTypeSel = arrSchoolTypeSel.slice(intStart, intEnd);
    return arrSchoolTypeSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function SchoolType_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function SchoolType_DelSchoolTypesAsync(
  arrSchoolTypeId: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function SchoolType_AddNewRecordAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function SchoolType_AddNewRecordWithMaxIdAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
): Promise<string> {
 ...
 **/
export async function SchoolType_AddNewObjSave(
  objSchoolTypeEN: clsSchoolTypeEN,
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function SchoolType_AddNewRecordWithReturnKeyAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function SchoolType_UpdateRecordAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objSchoolTypeEN.sfUpdFldSetStr === undefined ||
    objSchoolTypeEN.sfUpdFldSetStr === null ||
    objSchoolTypeEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function SchoolType_EditRecordExAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function SchoolType_UpdateWithConditionAsync(
  objSchoolTypeEN: clsSchoolTypeEN,
  strWhereCond: string,
): Promise<boolean> {
 ...
 * @returns 对象列表子集
 */
export async function SchoolType_IsExistRecordCache(objSchoolTypeCond: clsSchoolTypeEN) {
  const strThisFuncName = 'IsExistRecordCache';
  const arrSchoolTypeObjLstCache = await SchoolType_GetObjLstCache();
  if (arrSchoolTypeObjLstCache == null) return false;
  let arrSchoolTypeSel = arrSchoolTypeObjLstCache;
  if (objSchoolTypeCond.sfFldComparisonOp == null || objSchoolTypeCond.sfFldComparisonOp == '')
    return arrSchoolTypeSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objSchoolTypeCond.sfFldComparisonOp,
  );
  //console.log("clsSchoolTypeWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @returns 对象列表记录数
 */
export async function SchoolType_GetRecCountByCondCache(objSchoolTypeCond: clsSchoolTypeEN) {
...
*/
export async function SchoolType_BindDdl_SchoolTypeIdInDivCache(
...
export function SchoolType_CheckPropertyNew(pobjSchoolTypeEN: clsSchoolTypeEN) {
  ...
  if (IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeName) === true) {
    throw new Error(
      `(errid:Watl000411)字段[学校类型名]不能为空(In 学校类型)!(clsSchoolTypeBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeId) == false &&
    GetStrLen(pobjSchoolTypeEN.schoolTypeId) > 2
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学校类型Id(schoolTypeId)]的长度不能超过2(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.schoolTypeId}(clsSchoolTypeBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeName) == false &&
    GetStrLen(pobjSchoolTypeEN.schoolTypeName) > 30
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学校类型名(schoolTypeName)]的长度不能超过30(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.schoolTypeName}(clsSchoolTypeBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjSchoolTypeEN.memo) == false && GetStrLen(pobjSchoolTypeEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.memo}(clsSchoolTypeBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeId) == false &&
    undefined !== pobjSchoolTypeEN.schoolTypeId &&
    tzDataType.isString(pobjSchoolTypeEN.schoolTypeId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校类型Id(schoolTypeId)]的值:[${pobjSchoolTypeEN.schoolTypeId}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeName) == false &&
    undefined !== pobjSchoolTypeEN.schoolTypeName &&
    tzDataType.isString(pobjSchoolTypeEN.schoolTypeName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校类型名(schoolTypeName)]的值:[${pobjSchoolTypeEN.schoolTypeName}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.memo) == false &&
    undefined !== pobjSchoolTypeEN.memo &&
    tzDataType.isString(pobjSchoolTypeEN.memo) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[备注(memo)]的值:[${pobjSchoolTypeEN.memo}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckPropertyNew0)`,
    );
  }
...
export function SchoolType_CheckProperty4Update(pobjSchoolTypeEN: clsSchoolTypeEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学校类型Id(schoolTypeId)]的长度不能超过2(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.schoolTypeId}(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[学校类型名(schoolTypeName)]的长度不能超过30(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.schoolTypeName}(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjSchoolTypeEN.memo) == false && GetStrLen(pobjSchoolTypeEN.memo) > 1000) {
    throw new Error(
      `(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 学校类型(SchoolType))!值:${pobjSchoolTypeEN.memo}(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校类型Id(schoolTypeId)]的值:[${pobjSchoolTypeEN.schoolTypeId}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校类型名(schoolTypeName)]的值:[${pobjSchoolTypeEN.schoolTypeName}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.memo) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[备注(memo)]的值:[${pobjSchoolTypeEN.memo}], 非法,应该为字符型(In 学校类型(SchoolType))!(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    IsNullOrEmpty(pobjSchoolTypeEN.schoolTypeId) === true ||
    pobjSchoolTypeEN.schoolTypeId.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000064)字段[学校类型Id]不能为空(In 学校类型)!(clsSchoolTypeBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function SchoolType_GetObjLstByJSONObjLst(
  arrSchoolTypeObjLstS: Array<clsSchoolTypeEN>,
): Array<clsSchoolTypeEN> {
...
export function SchoolType_GetCombineCondition(objSchoolTypeCond: clsSchoolTypeEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objSchoolTypeCond.dicFldComparisonOp,
      clsSchoolTypeEN.con_SchoolTypeId,
    ) == true
  ) {
    const strComparisonOpSchoolTypeId: string =
      objSchoolTypeCond.dicFldComparisonOp[clsSchoolTypeEN.con_SchoolTypeId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsSchoolTypeEN.con_SchoolTypeId,
      objSchoolTypeCond.schoolTypeId,
  ...
  if (
    ...
    const strComparisonOpSchoolTypeName: string =
      objSchoolTypeCond.dicFldComparisonOp[clsSchoolTypeEN.con_SchoolTypeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsSchoolTypeEN.con_SchoolTypeName,
      objSchoolTypeCond.schoolTypeName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objSchoolTypeCond.dicFldComparisonOp,
      clsSchoolTypeEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objSchoolTypeCond.dicFldComparisonOp[clsSchoolTypeEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsSchoolTypeEN.con_Memo,
      objSchoolTypeCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function SchoolType_CopyObjTo(
  objSchoolTypeENS: clsSchoolTypeEN,
  objSchoolTypeENT: clsSchoolTypeEN,
): void {
