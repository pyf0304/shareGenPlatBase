...
public static readonly _CurrTabName: string = "QxUserMenuDetail"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 12;
public static readonly _AttributeName = ["mId", "menuId", "menuName", "isDisp", "upMenuId", "linkFile", "imgFile", "isCustomMenu", "userId", "qxPrjId", "orderNum", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_IsCustomMenu = "isCustomMenu";    //是否定制菜单
