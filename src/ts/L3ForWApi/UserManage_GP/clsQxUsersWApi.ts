...
import { XzClg_func } from '@/ts/L3ForWApi/UserManage_GP/clsXzClgWApi';
...
import { XzGradeBase_func } from '@/ts/L3ForWApi/UserManage_GP/clsXzGradeBaseWApi';
...
export async function QxUsers_FuncMapCollegeName(objQxUsers: clsQxUsersENEx) {
  ...
  try {
    if (IsNullOrEmpty(objQxUsers.collegeName) == true) {
      ...
      if (IsNullOrEmpty(objQxUsers.idSchool) == true) {
        const strMsg = `函数映射[CollegeName]数据出错,idSchool不能为空!(in ${qxUsers_ConstructorName}.${strThisFuncName})`;
        console.error(strMsg);
        alert(strMsg);
        return;
      }
...
export function QxUsers_CheckPropertyNew(pobjQxUsersEN: clsQxUsersEN) {
  ...
  if (
    IsNullOrEmpty(pobjQxUsersEN.idGradeBase) == false &&
    GetStrLen(pobjQxUsersEN.idGradeBase) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[年级流水号(idGradeBase)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idGradeBase}(clsQxUsersBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjQxUsersEN.idSchool) == false && GetStrLen(pobjQxUsersEN.idSchool) > 4) {
    throw new Error(
      `(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idSchool}(clsQxUsersBL:CheckPropertyNew)`,
    );
  }
  ...
  if (
    IsNullOrEmpty(pobjQxUsersEN.idXzCollege) == false &&
    GetStrLen(pobjQxUsersEN.idXzCollege) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学院Id(idXzCollege)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idXzCollege}(clsQxUsersBL:CheckPropertyNew)`,
    );
  }
  ...
  if (
    IsNullOrEmpty(pobjQxUsersEN.idGradeBase) == false &&
    undefined !== pobjQxUsersEN.idGradeBase &&
    tzDataType.isString(pobjQxUsersEN.idGradeBase) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级流水号(idGradeBase)]的值:[${pobjQxUsersEN.idGradeBase}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxUsersEN.idSchool) == false &&
    undefined !== pobjQxUsersEN.idSchool &&
    tzDataType.isString(pobjQxUsersEN.idSchool) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjQxUsersEN.idSchool}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjQxUsersEN.idXzCollege) == false &&
    undefined !== pobjQxUsersEN.idXzCollege &&
    tzDataType.isString(pobjQxUsersEN.idXzCollege) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学院Id(idXzCollege)]的值:[${pobjQxUsersEN.idXzCollege}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckPropertyNew0)`,
    );
  }
  if (
...
export function QxUsers_CheckProperty4Update(pobjQxUsersEN: clsQxUsersEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[年级流水号(idGradeBase)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idGradeBase}(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxUsersEN.idSchool) == false && GetStrLen(pobjQxUsersEN.idSchool) > 4) {
    throw new Error(
      `(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idSchool}(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxUsersEN.headPic) == false && GetStrLen(pobjQxUsersEN.headPic) > 50) {
    throw new Error(
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学院Id(idXzCollege)]的长度不能超过4(In 用户(QxUsers))!值:${pobjQxUsersEN.idXzCollege}(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjQxUsersEN.updDate) == false && GetStrLen(pobjQxUsersEN.updDate) > 20) {
    throw new Error(
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级流水号(idGradeBase)]的值:[${pobjQxUsersEN.idGradeBase}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxUsersEN.idSchool) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjQxUsersEN.idSchool}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxUsersEN.headPic) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学院Id(idXzCollege)]的值:[${pobjQxUsersEN.idXzCollege}], 非法,应该为字符型(In 用户(QxUsers))!(clsQxUsersBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjQxUsersEN.updDate) == false &&
...
export function QxUsers_GetCombineCondition(objQxUsersCond: clsQxUsersEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxUsersCond.dicFldComparisonOp,
      clsQxUsersEN.con_IdGradeBase,
    ) == true
  ) {
    const strComparisonOpIdGradeBase: string =
      objQxUsersCond.dicFldComparisonOp[clsQxUsersEN.con_IdGradeBase];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxUsersEN.con_IdGradeBase,
      objQxUsersCond.idGradeBase,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxUsersCond.dicFldComparisonOp,
      clsQxUsersEN.con_IdSchool,
    ) == true
  ) {
    const strComparisonOpIdSchool: string =
      objQxUsersCond.dicFldComparisonOp[clsQxUsersEN.con_IdSchool];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxUsersEN.con_IdSchool,
      objQxUsersCond.idSchool,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objQxUsersCond.dicFldComparisonOp,
      clsQxUsersEN.con_IdXzCollege,
    ) == true
  ) {
    const strComparisonOpIdXzCollege: string =
      objQxUsersCond.dicFldComparisonOp[clsQxUsersEN.con_IdXzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsQxUsersEN.con_IdXzCollege,
      objQxUsersCond.idXzCollege,
