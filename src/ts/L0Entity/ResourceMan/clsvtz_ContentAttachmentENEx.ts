...
export class  clsvtz_ContentAttachmentENEx extends clsvtz_ContentAttachmentEN
{
//以下是属性变量
...
//return propName in new clsvtz_ContentAttachmentENEx();
const instance = new clsvtz_ContentAttachmentENEx();
