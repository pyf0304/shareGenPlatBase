/**
 * 类名:QxCmProject_EditEx(界面:QxCmProjectCRUD,00140045)
 * 表名:QxCmProject(00140119)
 * 版本:2026.03.27.1(服务器:WIN-SRV103-116)
 * 日期:2026/03/30 06:30:19
 * 生成者:
 工程名称:统一平台(0014)
...
/* QxCmProject_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export default class QxCmProject_EditEx extends QxCmProject_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: QxCmProject_EditEx = <QxCmProject_EditEx>(
      QxCmProject_Edit.GetPageEditObj('QxCmProject_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[QxCmProject_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
