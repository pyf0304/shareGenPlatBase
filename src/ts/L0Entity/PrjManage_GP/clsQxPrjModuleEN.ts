...
public static _CurrTabName= "QxPrjModule"; //当前表名,与该类相关的表名
public static _KeyFldName= "ModuleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 4;
public static AttributeName = ["moduleId", "moduleName", "qxPrjId", "memo"];
//以下是属性变量
