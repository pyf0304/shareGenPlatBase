      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('roleName|Ex')">
              角色名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'roleName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('menuName|Ex')">
              菜单名
              <span>
                <i
                  :class="
                    sortColumnKey === 'menuName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('menuSetId|Ex')">
              菜单集Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'menuSetId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('menuSetName|Ex')">
              菜单集名称
              <span>
                <i
                  :class="
                    sortColumnKey === 'menuSetName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('isLeafNode|Ex')">
              是否叶子
              <span>
                <i
                  :class="
                    sortColumnKey === 'isLeafNode|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('pageDispModeId|Ex')">
              页面显示模式Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'pageDispModeId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('upMenuId|Ex')">
              上级菜单Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'upMenuId|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.menuId"></td>

            <td v-html="item.menuName"></td>

            <td v-html="item.menuSetId"></td>

            <td v-html="item.menuSetName"></td>

            <td v-html="item.isLeafNode"></td>

            <td v-html="item.pageDispModeId"></td>

            <td v-html="item.inUse"></td>

            <td v-html="item.upMenuId"></td>

            <td v-html="item.isDisp"></td>
          </tr> </tbody
      ></table>
    </template>
  </div>
