...
export class clsvStudentInfo {
   ...
   */
  public static get con_IdStudentInfo(): string {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_StuId(): string {
    return 'stuId';
  } //学号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_StuName(): string {
    return 'stuName';
  } //姓名
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_PoliticsId(): string {
    return 'politicsId';
  } //政治面貌Id
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_EthnicId(): string {
    return 'ethnicId';
  } //民族Id
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_CollegeIdInGP(): string {
    return 'collegeIdInGP';
  } //CollegeIdInGP
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_GradeBaseName(): string {
    return 'gradeBaseName';
  } //年级名称
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_AdminClsTypeName(): string {
    return 'adminClsTypeName';
  } //行政班级类型名称
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_NativePlace(): string {
    return 'nativePlace';
  } //籍贯
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_Duty(): string {
    return 'duty';
  } //职位
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_StuCardNo(): string {
    return 'stuCardNo';
  } //学生证号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_LiveAddress(): string {
    return 'liveAddress';
  } //居住地址
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_HomePhone(): string {
    return 'homePhone';
  } //住宅电话
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IdCardNo2(): string {
    return 'idCardNo2';
  } //内卡号
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IsAvconClassUser(): string {
    return 'isAvconClassUser';
  } //IsAvconClassUser
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IsLeaved(): string {
    return 'isLeaved';
  } //是否离开
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_UserId4Avcon(): string {
    return 'userId4Avcon';
  } //UserId4Avcon
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_EnrollmentDate(): string {
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_PostCode(): string {
    return 'postCode';
  } //邮编
   ...
   * (AutoGCLib.StoreEntityLayer4TypeScript:Gen_StoreEN_PropertyNameConst)
   */
  public static get con_IdGrade(): string {
    return 'idGrade';
  } //年级流水号
}
