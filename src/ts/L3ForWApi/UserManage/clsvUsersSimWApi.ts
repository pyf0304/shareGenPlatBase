 ...
 * @returns 对象
 **/
export async function vUsersSim_GetObjByUserIdAsync(
  strUserId: string,
): Promise<clsvUsersSimEN | null> {
...
export async function vUsersSim_GetObjByUserIdlocalStorage(strUserId: string) {
  ...
  if (IsNullOrEmpty(strUserId) == true) {
    const strMsg = Format(
      '参数:[strUserId]不能为空!(In clsvUsersSimWApi.GetObjByUserIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
 ...
 * @returns 对象
 */
export async function vUsersSim_GetObjByUserIdCache(
  strUserId: string,
  strCmPrjId: string,
 ...
 * @returns 返回一个输出字段值
*/
export async function vUsersSim_func(
  strInFldName: string,
  ...
  if (strCmPrjIdClassfy.length != 6) {
    const strMsg = Format(
      '缓存分类变量:[strCmPrjIdClassfy]的长度:[{0}]不正确!(clsvUsersSimWApi.func)',
 ...
 * @returns 返回一个关键字值列表
*/
export async function vUsersSim_funcKey(
  strInFldName: string,
  strInValue: any,
  ...
  if (strCmPrjIdClassfy.length != 6) {
    const strMsg = Format(
      '缓存分类变量:[strCmPrjIdClassfy]的长度:[{0}]不正确!(clsvUsersSimWApi.funcKey)',
      strCmPrjIdClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrvUsersSimSel = arrvUsersSimSel.filter(
 ...
 **/
export async function vUsersSim_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function vUsersSim_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsvUsersSimEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function vUsersSim_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsvUsersSimEN>> {
...
export async function vUsersSim_GetObjLstCache(strCmPrjId: string): Promise<Array<clsvUsersSimEN>> {
  ...
  if (IsNullOrEmpty(strCmPrjId) == true) {
    const strMsg = Format(
      '参数:[strCmPrjId]不能为空！(In clsvUsersSimWApi.vUsersSim_GetObjLstCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strCmPrjId.length != 6) {
    const strMsg = Format(
      '缓存分类变量:[strCmPrjId]的长度:[{0}]不正确！(clsvUsersSimWApi.vUsersSim_GetObjLstCache)',
      strCmPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象列表子集
 */
export async function vUsersSim_GetSubObjLstCache(
  objvUsersSimCond: clsvUsersSimEN,
  strCmPrjId: string,
) {
  const strThisFuncName = 'GetSubObjLstCache';
  const arrvUsersSimObjLstCache = await vUsersSim_GetObjLstCache(strCmPrjId);
  let arrvUsersSimSel = arrvUsersSimObjLstCache;
  if (objvUsersSimCond.sfFldComparisonOp == null || objvUsersSimCond.sfFldComparisonOp == '')
    return arrvUsersSimSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvUsersSimCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objvUsersSimCond),
      vUsersSim_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function vUsersSim_GetObjLstByUserIdLstAsync(
 ...
 * @returns 对象列表
 */
export async function vUsersSim_GetObjLstByUserIdLstCache(
  ...
  try {
    const arrvUsersSimObjLstCache = await vUsersSim_GetObjLstCache(strCmPrjId);
    const arrvUsersSimSel = arrvUsersSimObjLstCache.filter(
 ...
 * @returns 获取的相应对象列表
 **/
export async function vUsersSim_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vUsersSim_GetObjLstByRangeAsync(
 ...
 * @returns 对象列表
 */
export async function vUsersSim_GetObjLstByPagerCache(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vUsersSim_GetObjLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsvUsersSimEN>> {
 ...
 * @returns 对象列表子集
 */
export async function vUsersSim_IsExistRecordCache(
  objvUsersSimCond: clsvUsersSimEN,
  strCmPrjId: string,
) {
  ...
  let arrvUsersSimSel = arrvUsersSimObjLstCache;
  if (objvUsersSimCond.sfFldComparisonOp == null || objvUsersSimCond.sfFldComparisonOp == '')
    return arrvUsersSimSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvUsersSimCond.sfFldComparisonOp,
  );
  //console.log("clsvUsersSimWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @returns 对象列表记录数
 */
export async function vUsersSim_GetRecCountByCondCache(
  objvUsersSimCond: clsvUsersSimEN,
  strCmPrjId: string,
) {
...
export function vUsersSim_ReFreshThisCache(strCmPrjId: string): void {
  if (IsNullOrEmpty(strCmPrjId) == true) {
    const strMsg = Format(
      '参数:[strCmPrjId]不能为空!(In clsvUsersSimWApi.vUsersSim_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strCmPrjId.length != 6) {
    const strMsg = Format(
      '缓存分类变量:[strCmPrjId]的长度:[{0}]不正确!(clsvUsersSimWApi.vUsersSim_ReFreshThisCache)',
      strCmPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @param strCmPrjId:
*/
export async function vUsersSim_BindDdl_UserIdInDivCache(
  ...
  if (strCmPrjId.length != 6) {
    const strMsg = Format(
      '缓存分类变量:[strCmPrjId]的长度:[{0}]不正确！(clsvUsersSimWApi.BindDdl_UserIdInDiv)',
      strCmPrjId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个生成的对象列表
 */
export function vUsersSim_GetObjLstByJSONObjLst(
  arrvUsersSimObjLstS: Array<clsvUsersSimEN>,
): Array<clsvUsersSimEN> {
...
export function vUsersSim_GetCombineCondition(objvUsersSimCond: clsvUsersSimEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersSimCond.dicFldComparisonOp,
      clsvUsersSimEN.con_UserId,
    ) == true
  ) {
    const strComparisonOpUserId: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_UserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_UserId,
      objvUsersSimCond.userId,
  ...
  if (
    ...
    const strComparisonOpUserName: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_UserName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_UserName,
      objvUsersSimCond.userName,
  ...
  if (
    ...
    const strComparisonOpIdXzCollege: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_Id_XzCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersSimCond.dicFldComparisonOp,
      clsvUsersSimEN.con_CollegeName,
    ) == true
  ) {
    const strComparisonOpCollegeName: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_CollegeName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_CollegeName,
      objvUsersSimCond.collegeName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersSimCond.dicFldComparisonOp,
      clsvUsersSimEN.con_IdXzMajor,
    ) == true
  ) {
    const strComparisonOpIdXzMajor: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_IdXzMajor];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_IdXzMajor,
      objvUsersSimCond.id_XzMajor,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersSimCond.dicFldComparisonOp,
      clsvUsersSimEN.con_MajorName,
    ) == true
  ) {
    const strComparisonOpMajorName: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_MajorName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_MajorName,
      objvUsersSimCond.majorName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvUsersSimCond.dicFldComparisonOp,
      clsvUsersSimEN.con_HeadPic,
    ) == true
  ) {
    const strComparisonOpHeadPic: string =
      objvUsersSimCond.dicFldComparisonOp[clsvUsersSimEN.con_HeadPic];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvUsersSimEN.con_HeadPic,
      objvUsersSimCond.headPic,
 ...
 */
export function vUsersSim_CopyObjTo(
  objvUsersSimENS: clsvUsersSimEN,
  objvUsersSimENT: clsvUsersSimEN,
): void {
