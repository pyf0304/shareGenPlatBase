...
public static AttributeName = ["rId", "roleName", "roleENName", "roleIndex", "qxPrjId", "isInUse", "updDate", "updUserId", "memo"];
//以下是属性变量
 ...
 */
 public static get con_RId(): string {return "rId";}    //角色Id
