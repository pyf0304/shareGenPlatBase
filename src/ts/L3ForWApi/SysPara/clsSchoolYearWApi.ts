 ...
 * @returns 对象
 **/
export async function SchoolYear_GetObjBySchoolYearAsync(
  strSchoolYear: string,
): Promise<clsSchoolYearEN | null> {
  const strThisFuncName = 'GetObjBySchoolYearAsync';

  if (IsNullOrEmpty(strSchoolYear) == true) {
    const strMsg = Format(
      '参数:[strSchoolYear]不能为空!(In clsSchoolYearWApi.GetObjBySchoolYearAsync)',
    );
...
export async function SchoolYear_GetObjBySchoolYearlocalStorage(strSchoolYear: string) {
  ...
  if (IsNullOrEmpty(strSchoolYear) == true) {
    const strMsg = Format(
      '参数:[strSchoolYear]不能为空!(In clsSchoolYearWApi.GetObjBySchoolYearlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
 ...
 * @returns 对象
 */
export async function SchoolYear_GetObjBySchoolYearCache(
  strSchoolYear: string,
  ...
  if (IsNullOrEmpty(strSchoolYear) == true) {
    const strMsg = Format(
      '参数:[strSchoolYear]不能为空!(In clsSchoolYearWApi.GetObjBySchoolYearCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
...
export async function SchoolYear_UpdateObjInLstCache(objSchoolYear: clsSchoolYearEN) {
  ...
  try {
    const arrSchoolYearObjLstCache = await SchoolYear_GetObjLstCache();
    const obj = arrSchoolYearObjLstCache.find((x) => x.schoolYear == objSchoolYear.schoolYear);
    if (obj != null) {
...
export async function SchoolYear_GetNameBySchoolYearCache(strSchoolYear: string) {
  if (IsNullOrEmpty(strSchoolYear) == true) {
    const strMsg = Format(
      '参数:[strSchoolYear]不能为空!(In clsSchoolYearWApi.GetNameBySchoolYearCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
 ...
 * @returns 返回一个输出字段值
 */
export async function SchoolYear_func(
  strInFldName: string,
  ...
  if (clsSchoolYearEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsSchoolYearEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function SchoolYear_funcKey(
  strInFldName: string,
  strInValue: any,
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrSchoolYearSel = arrSchoolYearSel.filter(
 ...
 **/
export async function SchoolYear_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function SchoolYear_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsSchoolYearEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function SchoolYear_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsSchoolYearEN>> {
 ...
 * @returns 对象列表子集
 */
export async function SchoolYear_GetSubObjLstCache(objSchoolYearCond: clsSchoolYearEN) {
  const strThisFuncName = 'GetSubObjLstCache';
  const arrSchoolYearObjLstCache = await SchoolYear_GetObjLstCache();
  let arrSchoolYearSel = arrSchoolYearObjLstCache;
  if (objSchoolYearCond.sfFldComparisonOp == null || objSchoolYearCond.sfFldComparisonOp == '')
    return arrSchoolYearSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objSchoolYearCond.sfFldComparisonOp,
  );
  //console.log("clsSchoolYearWApi->GetSubObjLstCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    const sstrKeys = GetObjKeys(objSchoolYearCond);
    //console.log(sstrKeys);
    for (const strKey of sstrKeys) {
      if (Object.prototype.hasOwnProperty.call(dicFldComparisonOp, strKey) == false) continue;
      arrSchoolYearSel = arrSchoolYearSel.filter((x) => x.GetFldValue(strKey) != null);
      const strComparisonOp = dicFldComparisonOp[strKey];
      const strValue = objSchoolYearCond.GetFldValue(strKey);
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objSchoolYearCond),
      schoolYear_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function SchoolYear_GetObjLstBySchoolYearLstAsync(
  arrSchoolYear: Array<string>,
): Promise<Array<clsSchoolYearEN>> {
...
export async function SchoolYear_GetObjLstBySchoolYearLstCache(arrSchoolYearLst: Array<string>) {
  ...
  try {
    const arrSchoolYearObjLstCache = await SchoolYear_GetObjLstCache();
    const arrSchoolYearSel = arrSchoolYearObjLstCache.filter(
      (x) => arrSchoolYearLst.indexOf(x.schoolYear) > -1,
    );
    return arrSchoolYearSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function SchoolYear_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function SchoolYear_GetObjLstByRangeAsync(
...
export async function SchoolYear_GetObjLstByPagerCache(objPagerPara: stuPagerPara) {
  ...
  const objSchoolYearCond = new clsSchoolYearEN();
  ObjectAssign(objSchoolYearCond, objCond);
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function SchoolYear_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function SchoolYear_DelSchoolYearsAsync(
  arrSchoolYear: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function SchoolYear_AddNewRecordAsync(
  objSchoolYearEN: clsSchoolYearEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function SchoolYear_AddNewRecordWithMaxIdAsync(
  objSchoolYearEN: clsSchoolYearEN,
): Promise<string> {
 ...
 **/
export async function SchoolYear_AddNewObjSave(
  objSchoolYearEN: clsSchoolYearEN,
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function SchoolYear_AddNewRecordWithReturnKeyAsync(
  objSchoolYearEN: clsSchoolYearEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function SchoolYear_UpdateRecordAsync(
  objSchoolYearEN: clsSchoolYearEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objSchoolYearEN.sfUpdFldSetStr === undefined ||
    objSchoolYearEN.sfUpdFldSetStr === null ||
    objSchoolYearEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 获取修改是否成功？
 **/
export async function SchoolYear_EditRecordExAsync(
  objSchoolYearEN: clsSchoolYearEN,
): Promise<boolean> {
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function SchoolYear_UpdateWithConditionAsync(
  objSchoolYearEN: clsSchoolYearEN,
  strWhereCond: string,
): Promise<boolean> {
 ...
 * @returns 对象列表子集
 */
export async function SchoolYear_IsExistRecordCache(objSchoolYearCond: clsSchoolYearEN) {
  const strThisFuncName = 'IsExistRecordCache';
  const arrSchoolYearObjLstCache = await SchoolYear_GetObjLstCache();
  if (arrSchoolYearObjLstCache == null) return false;
  let arrSchoolYearSel = arrSchoolYearObjLstCache;
  if (objSchoolYearCond.sfFldComparisonOp == null || objSchoolYearCond.sfFldComparisonOp == '')
    return arrSchoolYearSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objSchoolYearCond.sfFldComparisonOp,
  );
  //console.log("clsSchoolYearWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @returns 对象列表记录数
 */
export async function SchoolYear_GetRecCountByCondCache(objSchoolYearCond: clsSchoolYearEN) {
...
*/
export async function SchoolYear_BindDdl_SchoolYearInDivCache(
...
export function SchoolYear_CheckPropertyNew(pobjSchoolYearEN: clsSchoolYearEN) {
  ...
  if (
    null === pobjSchoolYearEN.isVisible ||
    (pobjSchoolYearEN.isVisible != null && pobjSchoolYearEN.isVisible.toString() === '')
  ) {
    throw new Error(
      `(errid:Watl000411)字段[是否显示]不能为空(In 学年)!(clsSchoolYearBL:CheckPropertyNew0)`,
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYear) == false &&
    GetStrLen(pobjSchoolYearEN.schoolYear) > 10
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学年(schoolYear)]的长度不能超过10(In 学年(SchoolYear))!值:${pobjSchoolYearEN.schoolYear}(clsSchoolYearBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYearName) == false &&
    GetStrLen(pobjSchoolYearEN.schoolYearName) > 10
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学年名(schoolYearName)]的长度不能超过10(In 学年(SchoolYear))!值:${pobjSchoolYearEN.schoolYearName}(clsSchoolYearBL:CheckPropertyNew)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYear) == false &&
    undefined !== pobjSchoolYearEN.schoolYear &&
    tzDataType.isString(pobjSchoolYearEN.schoolYear) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学年(schoolYear)]的值:[${pobjSchoolYearEN.schoolYear}], 非法,应该为字符型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYearName) == false &&
    undefined !== pobjSchoolYearEN.schoolYearName &&
    tzDataType.isString(pobjSchoolYearEN.schoolYearName) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学年名(schoolYearName)]的值:[${pobjSchoolYearEN.schoolYearName}], 非法,应该为字符型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjSchoolYearEN.isCurrentSchoolYear &&
    undefined !== pobjSchoolYearEN.isCurrentSchoolYear &&
    tzDataType.isBoolean(pobjSchoolYearEN.isCurrentSchoolYear) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[是否当前学年(isCurrentSchoolYear)]的值:[${pobjSchoolYearEN.isCurrentSchoolYear}], 非法,应该为布尔型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckPropertyNew0)`,
    );
  }
  if (
    null != pobjSchoolYearEN.isVisible &&
    undefined !== pobjSchoolYearEN.isVisible &&
    tzDataType.isBoolean(pobjSchoolYearEN.isVisible) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[是否显示(isVisible)]的值:[${pobjSchoolYearEN.isVisible}], 非法,应该为布尔型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckPropertyNew0)`,
    );
  }
...
export function SchoolYear_CheckProperty4Update(pobjSchoolYearEN: clsSchoolYearEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学年(schoolYear)]的长度不能超过10(In 学年(SchoolYear))!值:${pobjSchoolYearEN.schoolYear}(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYearName) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[学年名(schoolYearName)]的长度不能超过10(In 学年(SchoolYear))!值:${pobjSchoolYearEN.schoolYearName}(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学年(schoolYear)]的值:[${pobjSchoolYearEN.schoolYear}], 非法,应该为字符型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYearName) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学年名(schoolYearName)]的值:[${pobjSchoolYearEN.schoolYearName}], 非法,应该为字符型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjSchoolYearEN.isCurrentSchoolYear &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否当前学年(isCurrentSchoolYear)]的值:[${pobjSchoolYearEN.isCurrentSchoolYear}], 非法,应该为布尔型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  if (
    null != pobjSchoolYearEN.isVisible &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[是否显示(isVisible)]的值:[${pobjSchoolYearEN.isVisible}], 非法,应该为布尔型(In 学年(SchoolYear))!(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  //检查主键是否为Null或者空!
  if (
    IsNullOrEmpty(pobjSchoolYearEN.schoolYear) === true ||
    pobjSchoolYearEN.schoolYear.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000064)字段[学年]不能为空(In 学年)!(clsSchoolYearBL:CheckProperty4Update)`,
    );
  }
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function SchoolYear_GetObjLstByJSONObjLst(
  arrSchoolYearObjLstS: Array<clsSchoolYearEN>,
): Array<clsSchoolYearEN> {
...
export function SchoolYear_GetCombineCondition(objSchoolYearCond: clsSchoolYearEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objSchoolYearCond.dicFldComparisonOp,
      clsSchoolYearEN.con_SchoolYear,
    ) == true
  ) {
    const strComparisonOpSchoolYear: string =
      objSchoolYearCond.dicFldComparisonOp[clsSchoolYearEN.con_SchoolYear];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsSchoolYearEN.con_SchoolYear,
      objSchoolYearCond.schoolYear,
  ...
  if (
    ...
    const strComparisonOpSchoolYearName: string =
      objSchoolYearCond.dicFldComparisonOp[clsSchoolYearEN.con_SchoolYearName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsSchoolYearEN.con_SchoolYearName,
      objSchoolYearCond.schoolYearName,
      strComparisonOpSchoolYearName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objSchoolYearCond.dicFldComparisonOp,
      clsSchoolYearEN.con_IsCurrentSchoolYear,
    ) == true
  ) {
 ...
 */
export function SchoolYear_CopyObjTo(
  objSchoolYearENS: clsSchoolYearEN,
  objSchoolYearENT: clsSchoolYearEN,
): void {
