/**
 * 类名:QxRolesV2_EditEx(界面:QxRolesV2CRUD,00140037)
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: QxRolesV2_EditEx = <QxRolesV2_EditEx>(
      QxRolesV2_Edit.GetPageEditObj('QxRolesV2_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[QxRolesV2_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
