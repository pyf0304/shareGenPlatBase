 ...
 * @returns 对象
 **/
export async function vTeacherInfo_Sim_GetObjByIdTeacherAsync(
  strIdTeacher: string,
): Promise<clsvTeacherInfo_SimEN | null> {
  const strThisFuncName = 'GetObjByIdTeacherAsync';

  if (IsNullOrEmpty(strIdTeacher) == true) {
    const strMsg = Format(
      '参数:[strIdTeacher]不能为空!(In clsvTeacherInfo_SimWApi.GetObjByIdTeacherAsync)',
    );
  ...
  if (strIdTeacher.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdTeacher]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.GetObjByIdTeacherAsync)',
      strIdTeacher.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    ...
    if (error.statusText == 'error') {
      const strInfo = Format(
        ...
        strUrl,
        vTeacherInfo_Sim_ConstructorName,
        strThisFuncName,
      );
...
export async function vTeacherInfo_Sim_GetObjByIdTeacherlocalStorage(strIdTeacher: string) {
  ...
  if (IsNullOrEmpty(strIdTeacher) == true) {
    const strMsg = Format(
      '参数:[strIdTeacher]不能为空!(In clsvTeacherInfo_SimWApi.GetObjByIdTeacherlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdTeacher.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdTeacher]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.GetObjByIdTeacherlocalStorage)',
      strIdTeacher.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 对象
 */
export async function vTeacherInfo_Sim_GetObjByIdTeacherCache(
  strIdTeacher: string,
  strIdSchoolPs: string,
  ...
  if (IsNullOrEmpty(strIdTeacher) == true) {
    const strMsg = Format(
      '参数:[strIdTeacher]不能为空!(In clsvTeacherInfo_SimWApi.GetObjByIdTeacherCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdTeacher.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdTeacher]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.GetObjByIdTeacherCache)',
      strIdTeacher.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
  const arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstCache(strIdSchoolPs);
  try {
    const arrvTeacherInfo_SimSel = arrvTeacherInfo_SimObjLstCache.filter(
    ...
    if (arrvTeacherInfo_SimSel.length > 0) {
      ...
      if (bolTryAsyncOnce == true) {
        const objvTeacherInfo_SimConst = await vTeacherInfo_Sim_GetObjByIdTeacherAsync(
          strIdTeacher,
        );
        if (objvTeacherInfo_SimConst != null) {
          vTeacherInfo_Sim_ReFreshThisCache(strIdSchoolPs);
 ...
 * @returns 返回两个对象比较的结果
 */
export function vTeacherInfo_Sim_SortFunDefa(
  a: clsvTeacherInfo_SimEN,
  b: clsvTeacherInfo_SimEN,
): number {
 ...
 * @returns 返回两个对象比较的结果
 */
export function vTeacherInfo_Sim_SortFunDefa2Fld(
  a: clsvTeacherInfo_SimEN,
  b: clsvTeacherInfo_SimEN,
): number {
...
export function vTeacherInfo_Sim_SortFunByKey(strKey: string, AscOrDesc: string) {
  ...
  if (AscOrDesc == 'Asc' || AscOrDesc == '') {
    switch (strKey) {
      ...
      case clsvTeacherInfo_SimEN.con_IdSchoolPs:
        return (a: clsvTeacherInfo_SimEN, b: clsvTeacherInfo_SimEN) => {
 ...
 * @returns 对象
 */
export async function vTeacherInfo_Sim_GetNameByIdTeacherCache(
  strIdTeacher: string,
  strIdSchoolPs: string,
) {
  if (IsNullOrEmpty(strIdTeacher) == true) {
    const strMsg = Format(
      '参数:[strIdTeacher]不能为空!(In clsvTeacherInfo_SimWApi.GetNameByIdTeacherCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdTeacher.length != 8) {
    const strMsg = Format(
      '缓存分类变量:[strIdTeacher]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.GetNameByIdTeacherCache)',
      strIdTeacher.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @param strInValue:输入字段值
 @param strIdSchoolPs:缓存的分类字段
 * @returns 返回一个输出字段值
*/
export async function vTeacherInfo_Sim_func(
  strInFldName: string,
  strOutFldName: string,
  strInValue: string,
  strIdSchoolPsClassfy: string,
) {
  //const strThisFuncName = "func";

  if (IsNullOrEmpty(strIdSchoolPsClassfy) == true) {
    const strMsg = Format('参数:[strIdSchoolPsClassfy]不能为空!(In clsvTeacherInfo_SimWApi.func)');
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdSchoolPsClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdSchoolPsClassfy]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.func)',
      strIdSchoolPsClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
  ...
  if (clsvTeacherInfo_SimEN.AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      ...
      strOutFldName,
      clsvTeacherInfo_SimEN.AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
  ...
  const objvTeacherInfo_Sim = await vTeacherInfo_Sim_GetObjByIdTeacherCache(
    strIdTeacher,
    strIdSchoolPsClassfy,
  );
 ...
 * @returns 返回一个关键字值列表
*/
export async function vTeacherInfo_Sim_funcKey(
  strInFldName: string,
  strInValue: any,
  ...
  if (IsNullOrEmpty(strIdSchoolPsClassfy) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPsClassfy]不能为空!(In clsvTeacherInfo_SimWApi.funcKey)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdSchoolPsClassfy.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdSchoolPsClassfy]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.funcKey)',
      strIdSchoolPsClassfy.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  const arrvTeacherInfo_Sim = await vTeacherInfo_Sim_GetObjLstCache(strIdSchoolPsClassfy);
    ...
    case 'string':
      switch (strComparisonOp) {
        case enumComparisonOp.Equal_01: // " = "
          arrvTeacherInfo_SimSel = arrvTeacherInfo_SimSel.filter(
 ...
 **/
export async function vTeacherInfo_Sim_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 * @returns 第一条记录对象
 **/
export async function vTeacherInfo_Sim_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsvTeacherInfo_SimEN | null> {
 ...
 **/
export async function vTeacherInfo_Sim_GetObjLstClientCache(strIdSchoolPs: string) {
  const strThisFuncName = 'GetObjLstClientCache';
  //初始化列表缓存
  let strWhereCond = '1=1';
  if (IsNullOrEmpty(clsvTeacherInfo_SimEN.WhereFormat) == false) {
    strWhereCond = Format(clsvTeacherInfo_SimEN.WhereFormat, strIdSchoolPs);
  } else {
    strWhereCond = Format("IdSchoolPs='{0}'", strIdSchoolPs);
  }
  const strKey = Format('{0}_{1}', clsvTeacherInfo_SimEN._CurrTabName, strIdSchoolPs);
  ...
  if (CacheHelper.Exsits(strKey)) {
    ...
    const arrvTeacherInfo_SimObjLstT = vTeacherInfo_Sim_GetObjLstByJSONObjLst(
      arrvTeacherInfo_SimExObjLstCache,
    );
  ...
  try {
    ...
    const strInfo = Format(
      ...
      strKey,
      arrvTeacherInfo_SimExObjLst.length,
    );
    console.log(strInfo);
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstlocalStorage(strIdSchoolPs: string) {
  ...
  if (IsNullOrEmpty(clsvTeacherInfo_SimEN.WhereFormat) == false) {
    ...
    strWhereCond = Format("{0}='{1}'", clsvTeacherInfo_SimEN.con_IdSchoolPs, strIdSchoolPs);
  }
  const strKey = Format('{0}_{1}', clsvTeacherInfo_SimEN._CurrTabName, strIdSchoolPs);
  if (IsNullOrEmpty(clsvTeacherInfo_SimEN.CacheAddiCondition) == false) {
    strWhereCond += Format(' and {0}', clsvTeacherInfo_SimEN.CacheAddiCondition);
  ...
  if (Object.prototype.hasOwnProperty.call(localStorage, strKey)) {
    ...
    const arrvTeacherInfo_SimExObjLstCache: Array<clsvTeacherInfo_SimEN> =
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstlocalStoragePureCache(strIdSchoolPs: string) {
  //初始化列表缓存
  const strKey = Format('{0}_{1}', clsvTeacherInfo_SimEN._CurrTabName, strIdSchoolPs);
  if (strKey == '') {
    console.error('关键字为空!不正确');
 ...
 * @returns 获取的相应对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsvTeacherInfo_SimEN>> {
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstsessionStorage(strIdSchoolPs: string) {
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstsessionStoragePureCache(strIdSchoolPs: string) {
  //初始化列表缓存
  const strKey = Format('{0}_{1}', clsvTeacherInfo_SimEN._CurrTabName, strIdSchoolPs);
  if (strKey == '') {
    console.error('关键字为空!不正确');
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstCache(
  strIdSchoolPs: string,
): Promise<Array<clsvTeacherInfo_SimEN>> {
  //const strThisFuncName = "GetObjLst_Cache";

  if (IsNullOrEmpty(strIdSchoolPs) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPs]不能为空！(In clsvTeacherInfo_SimWApi.vTeacherInfo_Sim_GetObjLstCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdSchoolPs.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdSchoolPs]的长度:[{0}]不正确！(clsvTeacherInfo_SimWApi.vTeacherInfo_Sim_GetObjLstCache)',
      strIdSchoolPs.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
  ...
  switch (clsvTeacherInfo_SimEN.CacheModeId) {
    case '04': //sessionStorage
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstsessionStorage(
        strIdSchoolPs,
      );
      break;
    case '03': //localStorage
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstlocalStorage(strIdSchoolPs);
      break;
    case '02': //ClientCache
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstClientCache(strIdSchoolPs);
      break;
    default:
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstClientCache(strIdSchoolPs);
      break;
 ...
 * @returns 从本地缓存中获取的对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstPureCache(strIdSchoolPs: string) {
  //const strThisFuncName = "GetObjLstPureCache";
  let arrvTeacherInfo_SimObjLstCache;
  switch (clsvTeacherInfo_SimEN.CacheModeId) {
    case '04': //sessionStorage
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstsessionStoragePureCache(
        strIdSchoolPs,
      );
      break;
    case '03': //localStorage
      arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstlocalStoragePureCache(
        strIdSchoolPs,
      );
      break;
    case '02': //ClientCache
 ...
 * @returns 对象列表子集
 */
export async function vTeacherInfo_Sim_GetSubObjLstCache(
  objvTeacherInfo_SimCond: clsvTeacherInfo_SimEN,
  strIdSchoolPs: string,
) {
  ...
  if (
    objvTeacherInfo_SimCond.sfFldComparisonOp == null ||
    objvTeacherInfo_SimCond.sfFldComparisonOp == ''
  )
    return arrvTeacherInfo_SimSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvTeacherInfo_SimCond.sfFldComparisonOp,
  );
  //console.log("clsvTeacherInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
  //console.log(dicFldComparisonOp);
  try {
    const sstrKeys = GetObjKeys(objvTeacherInfo_SimCond);
    //console.log(sstrKeys);
    for (const strKey of sstrKeys) {
      if (Object.prototype.hasOwnProperty.call(dicFldComparisonOp, strKey) == false) continue;
      arrvTeacherInfo_SimSel = arrvTeacherInfo_SimSel.filter((x) => x.GetFldValue(strKey) != null);
      const strComparisonOp = dicFldComparisonOp[strKey];
      const strValue = objvTeacherInfo_SimCond.GetFldValue(strKey);
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objvTeacherInfo_SimCond),
      vTeacherInfo_Sim_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstByIdTeacherLstAsync(
 ...
 * @returns 对象列表
 */
export async function vTeacherInfo_Sim_GetObjLstByIdTeacherLstCache(
  arrIdTeacherLst: Array<string>,
  strIdSchoolPs: string,
) {
  ...
  try {
    const arrvTeacherInfo_SimObjLstCache = await vTeacherInfo_Sim_GetObjLstCache(strIdSchoolPs);
    const arrvTeacherInfo_SimSel = arrvTeacherInfo_SimObjLstCache.filter(
      (x) => arrIdTeacherLst.indexOf(x.idTeacher) > -1,
    );
    return arrvTeacherInfo_SimSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function vTeacherInfo_Sim_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vTeacherInfo_Sim_GetObjLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsvTeacherInfo_SimEN>> {
  const strThisFuncName = 'GetObjLstByPagerAsync';
  if (objPagerPara.pageIndex == 0) return new Array<clsvTeacherInfo_SimEN>();
 ...
 * @returns 对象列表子集
 */
export async function vTeacherInfo_Sim_IsExistRecordCache(
  objvTeacherInfo_SimCond: clsvTeacherInfo_SimEN,
  strIdSchoolPs: string,
) {
  ...
  if (
    ...
    return arrvTeacherInfo_SimSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objvTeacherInfo_SimCond.sfFldComparisonOp,
  );
  //console.log("clsvTeacherInfo_SimWApi->GetSubObjLstCache->dicFldComparisonOp:");
 ...
 * @returns 对象
 */
export async function vTeacherInfo_Sim_IsExistCache(strIdTeacher: string, strIdSchoolPs: string) {
 ...
 * @returns 获取某一条件的记录数
 **/
export async function vTeacherInfo_Sim_GetRecCountByCondAsync(
  strWhereCond: string,
): Promise<number> {
 ...
 * @returns 对象列表记录数
 */
export async function vTeacherInfo_Sim_GetRecCountByCondCache(
  objvTeacherInfo_SimCond: clsvTeacherInfo_SimEN,
  strIdSchoolPs: string,
) {
 ...
 **/
export function vTeacherInfo_Sim_ReFreshThisCache(strIdSchoolPs: string): void {
  if (IsNullOrEmpty(strIdSchoolPs) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPs]不能为空!(In clsvTeacherInfo_SimWApi.vTeacherInfo_Sim_ReFreshThisCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdSchoolPs.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdSchoolPs]的长度:[{0}]不正确!(clsvTeacherInfo_SimWApi.vTeacherInfo_Sim_ReFreshThisCache)',
      strIdSchoolPs.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @param strIdSchoolPs:
*/
export async function vTeacherInfo_Sim_BindDdl_IdTeacherByIdSchoolPsInDivCache(
  ...
  if (objDdl == null) {
    const strMsg = Format('下拉框：{0} 不存在!(In BindDdl_IdTeacherByIdSchoolPsInDiv)', strDdlName);
    alert(strMsg);
    console.error(strMsg);
    throw strMsg;
  }
  ...
  let arrObjLstSel = await vTeacherInfo_Sim_GetObjLstCache(strIdSchoolPs);
  if (arrObjLstSel == null) return;
  arrObjLstSel = arrObjLstSel.filter((x) => x.idSchoolPs == strIdSchoolPs);
  BindDdl_ObjLstInDivObj_V(
    objDiv,
    strDdlName,
    arrObjLstSel,
 ...
 * @param strIdSchoolPs:
*/
export async function vTeacherInfo_Sim_BindDdl_IdTeacherInDivCache(
  objDiv: HTMLDivElement,
  strDdlName: string,
  strIdSchoolPs: string,
) {
  if (IsNullOrEmpty(strIdSchoolPs) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPs]不能为空！(In clsvTeacherInfo_SimWApi.BindDdl_IdTeacherInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdSchoolPs.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdSchoolPs]的长度:[{0}]不正确！(clsvTeacherInfo_SimWApi.BindDdl_IdTeacherInDiv)',
      strIdSchoolPs.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  const arrObjLstSel = await vTeacherInfo_Sim_GetObjLstCache(strIdSchoolPs);
  if (arrObjLstSel == null) return;
  BindDdl_ObjLstInDivObj_V(
    objDiv,
    strDdlName,
 ...
 * @param strIdSchoolPs:
*/
export async function vTeacherInfo_Sim_GetArrvTeacherInfo_SimByIdSchoolPs(strIdSchoolPs: string) {
  if (IsNullOrEmpty(strIdSchoolPs) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPs]不能为空！(In clsvTeacherInfo_SimWApi.BindDdl_IdTeacherByIdSchoolPsInDiv)',
    );
 ...
 * @param strIdSchoolPs:
*/
export async function vTeacherInfo_Sim_GetArrvTeacherInfo_Sim(strIdSchoolPs: string) {
  if (IsNullOrEmpty(strIdSchoolPs) == true) {
    const strMsg = Format(
      '参数:[strIdSchoolPs]不能为空！(In clsvTeacherInfo_SimWApi.BindDdl_IdTeacherInDiv)',
    );
 ...
 * @returns 返回一个生成的对象
 */
export function vTeacherInfo_Sim_GetJSONStrByObj(
  pobjvTeacherInfo_SimEN: clsvTeacherInfo_SimEN,
): string {
  let strJson = '';
  try {
 ...
 * @returns 返回一个生成的对象列表
 */
export function vTeacherInfo_Sim_GetObjLstByJSONObjLst(
  arrvTeacherInfo_SimObjLstS: Array<clsvTeacherInfo_SimEN>,
): Array<clsvTeacherInfo_SimEN> {
 ...
 */
export function vTeacherInfo_Sim_GetCombineCondition(
  objvTeacherInfo_SimCond: clsvTeacherInfo_SimEN,
): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvTeacherInfo_SimCond.dicFldComparisonOp,
      clsvTeacherInfo_SimEN.con_IdTeacher,
    ) == true
  ) {
    const strComparisonOpIdTeacher: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_IdTeacher];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_IdTeacher,
      objvTeacherInfo_SimCond.idTeacher,
  ...
  if (
    ...
    const strComparisonOpTeacherId: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_TeacherId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_TeacherId,
      objvTeacherInfo_SimCond.teacherId,
  ...
  if (
    ...
    const strComparisonOpTeacherName: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_TeacherName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_TeacherName,
      objvTeacherInfo_SimCond.teacherName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvTeacherInfo_SimCond.dicFldComparisonOp,
      clsvTeacherInfo_SimEN.con_IdXzCollege,
    ) == true
  ) {
    const strComparisonOpIdXzCollege: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_IdXzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_IdXzCollege,
      objvTeacherInfo_SimCond.idXzCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvTeacherInfo_SimCond.dicFldComparisonOp,
      clsvTeacherInfo_SimEN.con_IdSchoolPs,
    ) == true
  ) {
    const strComparisonOpIdSchoolPs: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_IdSchoolPs];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_IdSchoolPs,
      objvTeacherInfo_SimCond.idSchoolPs,
      strComparisonOpIdSchoolPs,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objvTeacherInfo_SimCond.dicFldComparisonOp,
      clsvTeacherInfo_SimEN.con_TeachIdCollege,
    ) == true
  ) {
    const strComparisonOpTeachIdCollege: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_TeachIdCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_TeachIdCollege,
      objvTeacherInfo_SimCond.teachIdCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvTeacherInfo_SimCond.dicFldComparisonOp,
      clsvTeacherInfo_SimEN.con_TeachIdMajor,
    ) == true
  ) {
    const strComparisonOpTeachIdMajor: string =
      objvTeacherInfo_SimCond.dicFldComparisonOp[clsvTeacherInfo_SimEN.con_TeachIdMajor];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvTeacherInfo_SimEN.con_TeachIdMajor,
      objvTeacherInfo_SimCond.teachIdMajor,
 ...
 */
export function vTeacherInfo_Sim_CopyObjTo(
  objvTeacherInfo_SimENS: clsvTeacherInfo_SimEN,
  objvTeacherInfo_SimENT: clsvTeacherInfo_SimEN,
): void {
  ...
  objvTeacherInfo_SimENT.idSchoolPs = objvTeacherInfo_SimENS.idSchoolPs; //学校流水号
 ...
 * @param objvTeacherInfo_SimENT:目标对象
 */
export function vTeacherInfo_Sim_GetObjFromJsonObj(
  objvTeacherInfo_SimENS: clsvTeacherInfo_SimEN,
): clsvTeacherInfo_SimEN {
