...
public static readonly _CurrTabName: string = "vQxUserGroupPotence"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 20;
public static readonly _AttributeName = ["mId", "userId", "userName", "groupId", "groupName", "roleId", "roleName", "qxPrjId", "prjName", "potenceId", "potenceName", "potenceTypeId", "potenceTypeName", "menuId", "menuName", "upMenuId", "relaMid", "symbolForProgramme", "symbolName", "memo"];
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_SymbolForProgramme = "symbolForProgramme";    //编程标志

 /**
 * 常量:"SymbolName"
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_SymbolName = "symbolName";    //标志名称
