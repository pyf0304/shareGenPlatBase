 ...
 **/
export  function QxPrjMenus_CopyToEx(objQxPrjMenusENS:clsQxPrjMenusEN ): clsQxPrjMenusENEx
{
const strThisFuncName  = QxPrjMenus_CopyToEx.name;
...
{
const strMsg = Format("(errid:Watl001294)Copy表对象数据出错,{0}.(in {1}.{2})", e, qxPrjMenus_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
 return objQxPrjMenusENT;
}
...
*/
export  function QxPrjMenus_FuncMapByFldName(strFldName: string, objQxPrjMenusEx: clsQxPrjMenusENEx)
{
const strThisFuncName = QxPrjMenus_FuncMapByFldName.name;
...
return QxPrjMenus_FuncMapPageDispModeName(objQxPrjMenusEx);
case clsQxPrjMenusENEx.con_UpMenuName:
return QxPrjMenus_FuncMapUpMenuName(objQxPrjMenusEx);
case clsQxPrjMenusENEx.con_DateTimeSim:
return QxPrjMenus_FuncMapDateTimeSim(objQxPrjMenusEx);
        default:
 ...
 * @returns 返回两个对象比较的结果
*/
export  function QxPrjMenus_SortFunByExKey(strKey:string, AscOrDesc: string)
{
...
case clsQxPrjMenusENEx.con_UpMenuName:
return (a: clsQxPrjMenusENEx, b: clsQxPrjMenusENEx) => {
    if (a.upMenuName === null && b.upMenuName === null) return 0;
 ...
 **/
export  async function QxPrjMenus_FuncMapPageDispModeName(objQxPrjMenus:clsQxPrjMenusENEx )
{
const strThisFuncName = QxPrjMenus_FuncMapPageDispModeName.name;
try
{
...
{
const strMsg = Format("(errid:Watl001396)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxPrjMenus_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxPrjMenusS:源对象
 **/
export  async function QxPrjMenus_FuncMapDateTimeSim(objQxPrjMenus:clsQxPrjMenusENEx )
{
const strThisFuncName = QxPrjMenus_FuncMapDateTimeSim.name;
try
{
...
{
const strMsg = Format("(errid:Watl001326)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxPrjMenus_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
 ...
 * @param objQxPrjMenusS:源对象
 **/
export  async function QxPrjMenus_FuncMapUpMenuName(objQxPrjMenus:clsQxPrjMenusENEx )
{
const strThisFuncName = QxPrjMenus_FuncMapUpMenuName.name;
try
{
if (IsNullOrEmpty(objQxPrjMenus.upMenuName) == true){
 const vQxPrjMenusSimMenuId = objQxPrjMenus.upMenuId;
if (IsNullOrEmpty(objQxPrjMenus.qxPrjId) == true)
{
const strMsg = `函数映射[UpMenuName]数据出错,qxPrjId不能为空!(in ${ qxPrjMenus_ConstructorName }.${strThisFuncName})`
console.error(strMsg);
alert(strMsg);
return;
}
 const vQxPrjMenusSimMenuName = await vQxPrjMenusSim_func(clsvQxPrjMenusSimEN.con_MenuId, clsvQxPrjMenusSimEN.con_MenuName, vQxPrjMenusSimMenuId , objQxPrjMenus.qxPrjId);
 objQxPrjMenus.upMenuName = vQxPrjMenusSimMenuName;
}
}
catch (e)
{
const strMsg = Format("(errid:Watl001493)函数映射表对象数据出错,{0}.(in {1}.{2})", e, qxPrjMenus_ConstructorName, strThisFuncName);
console.error(strMsg);
alert(strMsg);
}
}
