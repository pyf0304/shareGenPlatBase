 ...
 * @returns 对象
 **/
export async function vXzGradeBase_GetObjByIdGradeBaseAsync(
  strIdGradeBase: string,
): Promise<clsvXzGradeBaseEN | null> {
  const strThisFuncName = 'GetObjByIdGradeBaseAsync';

  if (IsNullOrEmpty(strIdGradeBase) == true) {
    const strMsg = Format(
      '参数:[strIdGradeBase]不能为空!(In clsvXzGradeBaseWApi.GetObjByIdGradeBaseAsync)',
    );
  ...
  if (strIdGradeBase.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdGradeBase]的长度:[{0}]不正确!(clsvXzGradeBaseWApi.GetObjByIdGradeBaseAsync)',
 ...
 **/
export async function vXzGradeBase_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
 ...
 * @returns 第一条记录对象
 **/
export async function vXzGradeBase_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsvXzGradeBaseEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function vXzGradeBase_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsvXzGradeBaseEN>> {
 ...
 * @returns 对象列表
 **/
export async function vXzGradeBase_GetObjLstByIdGradeBaseLstAsync(
 ...
 * @returns 获取的相应对象列表
 **/
export async function vXzGradeBase_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vXzGradeBase_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function vXzGradeBase_GetObjLstByPagerAsync(
...
export async function vXzGradeBase_(objDiv: HTMLDivElement, strDdlName: string) {
  ...
  BindDdl_ObjLstInDivObj_V(
    ...
    strDdlName,
    arrObjLstSel,
    clsvXzGradeBaseEN.con_IdGradeBase,
    clsvXzGradeBaseEN.con_GradeBaseName,
    'v年级...',
  );
}
 ...
 * @returns 返回一个生成的对象列表
 */
export function vXzGradeBase_GetObjLstByJSONObjLst(
  arrvXzGradeBaseObjLstS: Array<clsvXzGradeBaseEN>,
): Array<clsvXzGradeBaseEN> {
...
export function vXzGradeBase_GetCombineCondition(objvXzGradeBaseCond: clsvXzGradeBaseEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_IdGradeBase,
    ) == true
  ) {
    const strComparisonOpIdGradeBase: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_IdGradeBase];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_IdGradeBase,
      objvXzGradeBaseCond.id_GradeBase,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_GradeBaseId,
    ) == true
  ) {
    const strComparisonOpGradeBaseId: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_GradeBaseId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_GradeBaseId,
      objvXzGradeBaseCond.gradeBaseId,
  ...
  if (
    ...
    const strComparisonOpGradeBaseName: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_GradeBaseName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_GradeBaseName,
      objvXzGradeBaseCond.gradeBaseName,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_GradeBaseNameA,
    ) == true
  ) {
    const strComparisonOpGradeBaseNameA: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_GradeBaseNameA];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_GradeBaseNameA,
      objvXzGradeBaseCond.gradeBaseNameA,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_SchoolYear,
    ) == true
  ) {
    const strComparisonOpSchoolYear: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_SchoolYear];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_SchoolYear,
      objvXzGradeBaseCond.schoolYear,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_SchoolTerm,
    ) == true
  ) {
    const strComparisonOpSchoolTerm: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_SchoolTerm];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_SchoolTerm,
      objvXzGradeBaseCond.schoolTerm,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_EnterSchoolDate,
    ) == true
  ) {
    const strComparisonOpEnterSchoolDate: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_EnterSchoolDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_EnterSchoolDate,
      objvXzGradeBaseCond.enterSchoolDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_CurrentTermSeq,
    ) == true
  ) {
    const strComparisonOpCurrentTermSeq: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_CurrentTermSeq];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsvXzGradeBaseEN.con_CurrentTermSeq,
      objvXzGradeBaseCond.currentTermSeq,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_SetEPTermIndexDate,
    ) == true
  ) {
    const strComparisonOpSetEPTermIndexDate: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_SetEPTermIndexDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_SetEPTermIndexDate,
      objvXzGradeBaseCond.setEPTermIndexDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_GradeIndex,
    ) == true
  ) {
    const strComparisonOpGradeIndex: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_GradeIndex];
    strWhereCond += Format(
      ' And {0} {2} {1}',
      clsvXzGradeBaseEN.con_GradeIndex,
      objvXzGradeBaseCond.gradeIndex,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_BeginYearMonth,
    ) == true
  ) {
    const strComparisonOpBeginYearMonth: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_BeginYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_BeginYearMonth,
      objvXzGradeBaseCond.beginYearMonth,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_EndYearMonth,
    ) == true
  ) {
    const strComparisonOpEndYearMonth: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_EndYearMonth];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_EndYearMonth,
      objvXzGradeBaseCond.endYearMonth,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_AllowUpBaseInfo,
    ) == true
  ) {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_Prefix,
    ) == true
  ) {
    const strComparisonOpPrefix: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_Prefix];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_Prefix,
      objvXzGradeBaseCond.prefix,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_PointCalcVersionId,
    ) == true
  ) {
    const strComparisonOpPointCalcVersionId: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_PointCalcVersionId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_PointCalcVersionId,
      objvXzGradeBaseCond.pointCalcVersionId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_ModifyUserId,
    ) == true
  ) {
    const strComparisonOpModifyUserId: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_ModifyUserId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_ModifyUserId,
      objvXzGradeBaseCond.modifyUserId,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_ModifyDate,
    ) == true
  ) {
    const strComparisonOpModifyDate: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_ModifyDate];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_ModifyDate,
      objvXzGradeBaseCond.modifyDate,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_IdStudyLevel,
    ) == true
  ) {
    const strComparisonOpIdStudyLevel: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_IdStudyLevel];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_IdStudyLevel,
      objvXzGradeBaseCond.idStudyLevel,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_StudyLevelName,
    ) == true
  ) {
    const strComparisonOpStudyLevelName: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_StudyLevelName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_StudyLevelName,
      objvXzGradeBaseCond.studyLevelName,
      strComparisonOpStudyLevelName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_IsVisible,
    ) == true
  ) {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objvXzGradeBaseCond.dicFldComparisonOp,
      clsvXzGradeBaseEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objvXzGradeBaseCond.dicFldComparisonOp[clsvXzGradeBaseEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsvXzGradeBaseEN.con_Memo,
      objvXzGradeBaseCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function vXzGradeBase_CopyObjTo(
  objvXzGradeBaseENS: clsvXzGradeBaseEN,
  objvXzGradeBaseENT: clsvXzGradeBaseEN,
): void {
  objvXzGradeBaseENT.id_GradeBase = objvXzGradeBaseENS.id_GradeBase; //入学年级流水号
 ...
 * @param objvXzGradeBaseENT:目标对象
 */
export function vXzGradeBase_GetObjFromJsonObj(
  objvXzGradeBaseENS: clsvXzGradeBaseEN,
): clsvXzGradeBaseEN {
