...
export function StudentInfo_CheckPropertyNew(pobjStudentInfoEN: clsStudentInfoEN) {
  ...
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzCollege) == false &&
    GetStrLen(pobjStudentInfoEN.id_XzCollege) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学院流水号(id_XzCollege)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_XzCollege}(clsStudentInfoBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzMajor) == false &&
    GetStrLen(pobjStudentInfoEN.id_XzMajor) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[专业流水号(idXzMajor)]的长度不能超过8(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_XzMajor}(clsStudentInfoBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_GradeBase) == false &&
    GetStrLen(pobjStudentInfoEN.id_GradeBase) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[入学年级流水号(id_GradeBase)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_GradeBase}(clsStudentInfoBL:CheckPropertyNew)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_School) == false &&
    GetStrLen(pobjStudentInfoEN.id_School) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学校流水号(idSchool)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_School}(clsStudentInfoBL:CheckPropertyNew)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzCollege) == false &&
    undefined !== pobjStudentInfoEN.id_XzCollege &&
    tzDataType.isString(pobjStudentInfoEN.id_XzCollege) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学院流水号(id_XzCollege)]的值:[${pobjStudentInfoEN.id_XzCollege}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzMajor) == false &&
    undefined !== pobjStudentInfoEN.id_XzMajor &&
    tzDataType.isString(pobjStudentInfoEN.id_XzMajor) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业流水号(idXzMajor)]的值:[${pobjStudentInfoEN.id_XzMajor}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_GradeBase) == false &&
    undefined !== pobjStudentInfoEN.id_GradeBase &&
    tzDataType.isString(pobjStudentInfoEN.id_GradeBase) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[入学年级流水号(id_GradeBase)]的值:[${pobjStudentInfoEN.id_GradeBase}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false &&
  ...
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_School) == false &&
    undefined !== pobjStudentInfoEN.id_School &&
    tzDataType.isString(pobjStudentInfoEN.id_School) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学校流水号(idSchool)]的值:[${pobjStudentInfoEN.id_School}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.userId) == false &&
...
export function StudentInfo_CheckProperty4Update(pobjStudentInfoEN: clsStudentInfoEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学院流水号(id_XzCollege)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_XzCollege}(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzMajor) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[专业流水号(idXzMajor)]的长度不能超过8(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_XzMajor}(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_GradeBase) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[入学年级流水号(id_GradeBase)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_GradeBase}(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[学校流水号(idSchool)]的长度不能超过4(In 学生(StudentInfo))!值:${pobjStudentInfoEN.id_School}(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.userId) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学院流水号(id_XzCollege)]的值:[${pobjStudentInfoEN.id_XzCollege}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_XzMajor) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业流水号(idXzMajor)]的值:[${pobjStudentInfoEN.id_XzMajor}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.id_GradeBase) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[入学年级流水号(id_GradeBase)]的值:[${pobjStudentInfoEN.id_GradeBase}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.idGrade) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[学校流水号(idSchool)]的值:[${pobjStudentInfoEN.id_School}], 非法,应该为字符型(In 学生(StudentInfo))!(clsStudentInfoBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjStudentInfoEN.userId) == false &&
...
export function StudentInfo_GetCombineCondition(objStudentInfoCond: clsStudentInfoEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objStudentInfoCond.dicFldComparisonOp,
      clsStudentInfoEN.con_Id_XzCollege,
    ) == true
  ) {
    const strComparisonOpIdXzCollege: string =
      objStudentInfoCond.dicFldComparisonOp[clsStudentInfoEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsStudentInfoEN.con_Id_XzCollege,
      objStudentInfoCond.id_XzCollege,
  ...
  if (
    ...
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsStudentInfoEN.con_IdGradeBase,
      objStudentInfoCond.id_GradeBase,
...
export function StudentInfo_CopyObjTo(
  ...
  objStudentInfoENT.id_GradeBase = objStudentInfoENS.id_GradeBase; //入学年级流水号
  ...
  objStudentInfoENT.id_School = objStudentInfoENS.id_School; //学校流水号
