...
export async function XzAdminCls_func(
  ...
  if (clsXzAdminClsEN._AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      '输出字段名:[{0}]不正确,不在输出字段范围之内!({1})',
      strOutFldName,
      clsXzAdminClsEN._AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 **/
export async function XzAdminCls_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
...
export async function XzAdminCls_GetObjLstByPagerCache(objPagerPara: stuPagerPara) {
  ...
  let arrXzAdminClsSel = arrXzAdminClsObjLstCache;
  const objXzAdminClsCond = objPagerPara.conditionCollection;
  if (objXzAdminClsCond == null) {
 ...
 **/
export async function XzAdminCls_AddNewObjSave(
  objXzAdminClsEN: clsXzAdminClsEN,
 ...
 **/
export async function XzAdminCls_CheckUniCond4Add(
  objXzAdminClsEN: clsXzAdminClsEN,
): Promise<boolean> {
 ...
 **/
export async function XzAdminCls_CheckUniCond4Update(
  objXzAdminClsEN: clsXzAdminClsEN,
): Promise<boolean> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function XzAdminCls_EditRecordExAsync(
  objXzAdminClsEN: clsXzAdminClsEN,
): Promise<boolean> {
...
export async function XzAdminCls_IsExistRecordCache(objXzAdminClsCond: ConditionCollection) {
  ...
  let arrXzAdminClsSel = arrXzAdminClsObjLstCache;
  if (objXzAdminClsCond.GetConditions().length == 0)
 ...
 * @param strIdGrade:
*/
export async function XzAdminCls_BindDdl_IdAdminClsByIdGradeCache(
  ...
  if (IsNullOrEmpty(strIdGrade) == true) {
    const strMsg = Format(
      '参数:[strIdGrade]不能为空！(In clsXzAdminClsWApi.BindDdl_IdAdminClsByIdGrade)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdGrade.length != 2) {
    const strMsg = Format(
      '缓存分类变量:[strIdGrade]的长度:[{0}]不正确！(clsXzAdminClsWApi.BindDdl_IdAdminClsByIdGrade)',
      strIdGrade.length,
    );
    console.error(strMsg);
    throw strMsg;
...
*/
export async function XzAdminCls_BindDdl_IdAdminClsByIdAdminClsTypeInDivCache(
  objDiv: HTMLDivElement,
  strDdlName: string,
  ...
  if (IsNullOrEmpty(strIdAdminClsType) == true) {
    const strMsg = Format(
      '参数:[strIdAdminClsType]不能为空！(In clsXzAdminClsWApi.BindDdl_IdAdminClsByIdAdminClsTypeInDiv)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strIdAdminClsType.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strIdAdminClsType]的长度:[{0}]不正确！(clsXzAdminClsWApi.BindDdl_IdAdminClsByIdAdminClsTypeInDiv)',
  ...
  if (objDdl == null) {
    const strMsg = Format(
      '下拉框：{0} 不存在!(In BindDdl_IdAdminClsByIdAdminClsTypeInDiv)',
      strDdlName,
    );
    alert(strMsg);
    console.error(strMsg);
...
export function XzAdminCls_CheckPropertyNew(pobjXzAdminClsEN: clsXzAdminClsEN) {
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzMajor) === true ||
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzCollege) === true ||
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_GradeBase) === true ||
    pobjXzAdminClsEN.id_GradeBase.toString() === '0'
  ) {
    throw new Error(
      `(errid:Watl000411)字段[入学年级流水号]不能为空(In 行政班)!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzMajor) == false &&
    GetStrLen(pobjXzAdminClsEN.id_XzMajor) > 8
  ) {
    throw new Error(
      `(errid:Watl000413)字段[专业流水号(idXzMajor)]的长度不能超过8(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_XzMajor}(clsXzAdminClsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzCollege) == false &&
    GetStrLen(pobjXzAdminClsEN.id_XzCollege) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[学院流水号(id_XzCollege)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_XzCollege}(clsXzAdminClsBL:CheckPropertyNew)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.headTeacherId) == false &&
    GetStrLen(pobjXzAdminClsEN.headTeacherId) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[班主任Id(headTeacherId)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.headTeacherId}(clsXzAdminClsBL:CheckPropertyNew)`,
    );
  }
  if (IsNullOrEmpty(pobjXzAdminClsEN.idGrade) == false && GetStrLen(pobjXzAdminClsEN.idGrade) > 2) {
    throw new Error(
      `(errid:Watl000413)字段[年级流水号(idGrade)]的长度不能超过2(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.idGrade}(clsXzAdminClsBL:CheckPropertyNew)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_GradeBase) == false &&
    GetStrLen(pobjXzAdminClsEN.id_GradeBase) > 4
  ) {
    throw new Error(
      `(errid:Watl000413)字段[入学年级流水号(id_GradeBase)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_GradeBase}(clsXzAdminClsBL:CheckPropertyNew)`,
    );
  }
  if (
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzMajor) == false &&
    undefined !== pobjXzAdminClsEN.id_XzMajor &&
    tzDataType.isString(pobjXzAdminClsEN.id_XzMajor) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[专业流水号(idXzMajor)]的值:[${pobjXzAdminClsEN.id_XzMajor}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzCollege) == false &&
    undefined !== pobjXzAdminClsEN.id_XzCollege &&
    tzDataType.isString(pobjXzAdminClsEN.id_XzCollege) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[学院流水号(id_XzCollege)]的值:[${pobjXzAdminClsEN.id_XzCollege}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.idUniZone) == false &&
  ...
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.headTeacherId) == false &&
    undefined !== pobjXzAdminClsEN.headTeacherId &&
    tzDataType.isString(pobjXzAdminClsEN.headTeacherId) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[班主任Id(headTeacherId)]的值:[${pobjXzAdminClsEN.headTeacherId}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.idGrade) == false &&
    undefined !== pobjXzAdminClsEN.idGrade &&
    tzDataType.isString(pobjXzAdminClsEN.idGrade) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[年级流水号(idGrade)]的值:[${pobjXzAdminClsEN.idGrade}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_GradeBase) == false &&
    undefined !== pobjXzAdminClsEN.id_GradeBase &&
    tzDataType.isString(pobjXzAdminClsEN.id_GradeBase) === false
  ) {
    throw new Error(
      `(errid:Watl000414)字段[入学年级流水号(id_GradeBase)]的值:[${pobjXzAdminClsEN.id_GradeBase}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckPropertyNew0)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.adminClsId) == false &&
...
export function XzAdminCls_CheckProperty4Update(pobjXzAdminClsEN: clsXzAdminClsEN) {
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[专业流水号(idXzMajor)]的长度不能超过8(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_XzMajor}(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzCollege) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[学院流水号(id_XzCollege)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_XzCollege}(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.idUniZone) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000416)字段[班主任Id(headTeacherId)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.headTeacherId}(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (IsNullOrEmpty(pobjXzAdminClsEN.idGrade) == false && GetStrLen(pobjXzAdminClsEN.idGrade) > 2) {
    throw new Error(
      `(errid:Watl000416)字段[年级流水号(idGrade)]的长度不能超过2(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.idGrade}(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_GradeBase) == false &&
    ...
    throw new Error(
      `(errid:Watl000416)字段[入学年级流水号(id_GradeBase)]的长度不能超过4(In 行政班(XzAdminCls))!值:${pobjXzAdminClsEN.id_GradeBase}(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.adminClsId) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[专业流水号(idXzMajor)]的值:[${pobjXzAdminClsEN.id_XzMajor}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_XzCollege) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[学院流水号(id_XzCollege)]的值:[${pobjXzAdminClsEN.id_XzCollege}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.idUniZone) == false &&
  ...
  if (
    ...
    throw new Error(
      `(errid:Watl000417)字段[班主任Id(headTeacherId)]的值:[${pobjXzAdminClsEN.headTeacherId}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.idGrade) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[年级流水号(idGrade)]的值:[${pobjXzAdminClsEN.idGrade}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.id_GradeBase) == false &&
    ...
    throw new Error(
      `(errid:Watl000417)字段[入学年级流水号(id_GradeBase)]的值:[${pobjXzAdminClsEN.id_GradeBase}], 非法,应该为字符型(In 行政班(XzAdminCls))!(clsXzAdminClsBL:CheckProperty4Update)`,
    );
  }
  if (
    IsNullOrEmpty(pobjXzAdminClsEN.adminClsId) == false &&
...
export function XzAdminCls_GetCombineCondition(objXzAdminClsCond: clsXzAdminClsEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzAdminClsCond.dicFldComparisonOp,
      clsXzAdminClsEN.con_Id_XzCollege,
    ) == true
  ) {
    const strComparisonOpIdXzCollege: string =
      objXzAdminClsCond.dicFldComparisonOp[clsXzAdminClsEN.con_Id_XzCollege];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzAdminClsEN.con_Id_XzCollege,
      objXzAdminClsCond.id_XzCollege,
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objXzAdminClsCond.dicFldComparisonOp,
      clsXzAdminClsEN.con_HeadTeacherId,
    ) == true
  ) {
    const strComparisonOpHeadTeacherId: string =
      objXzAdminClsCond.dicFldComparisonOp[clsXzAdminClsEN.con_HeadTeacherId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzAdminClsEN.con_HeadTeacherId,
      objXzAdminClsCond.headTeacherId,
      strComparisonOpHeadTeacherId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objXzAdminClsCond.dicFldComparisonOp,
      clsXzAdminClsEN.con_IdGrade,
    ) == true
  ) {
    const strComparisonOpIdGrade: string =
      objXzAdminClsCond.dicFldComparisonOp[clsXzAdminClsEN.con_IdGrade];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzAdminClsEN.con_IdGrade,
      objXzAdminClsCond.idGrade,
  ...
  if (
    ...
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsXzAdminClsEN.con_IdGradeBase,
      objXzAdminClsCond.id_GradeBase,
...
export function XzAdminCls_CopyObjTo(
  ...
  objXzAdminClsENT.id_GradeBase = objXzAdminClsENS.id_GradeBase; //入学年级流水号
