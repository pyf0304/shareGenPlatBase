...
public static readonly _AttributeName = ["id_XzCollege", "collegeId", "collegeIdInGP", "collegeName", "collegeNameA", "clgEnglishName", "phoneNumber", "webSite", "id_Uni", "modifyUserId", "memo", "isVisible", "orderNum", "modifyDate", "id_School", "userTypeId"];
//以下是属性变量
