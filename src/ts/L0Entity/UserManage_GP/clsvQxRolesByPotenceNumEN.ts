 ...
 /**
 * 类名:clsvQxRolesByPotenceNumEN
 * 表名:vQxRolesByPotenceNum(00140084)
 * 版本:2026.04.01.1(服务器:WIN-SRV103-116)
 * 日期:2026/04/01 02:04:42
 * 生成者:pyf
 工程名称:统一平台(0014)
...
export class  clsvQxRolesByPotenceNumEN extends clsGeneralTabV
{
...
public static readonly _CurrTabName: string = "vQxRolesByPotenceNum"; //当前表名,与该类相关的表名
public static readonly _KeyFldName: string = "RoleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static readonly _AttributeCount = 11;
public static readonly _AttributeName = ["roleId", "roleName", "roleENName", "roleIndex", "qxPrjId", "prjName", "isInUse", "updDate", "updUserId", "memo", "potenceNum"];
//以下是属性变量
...
return this.potenceNum;
case "sfFldComparisonOp":
return this.sfFldComparisonOp;
default:
strMsg = `字段名:[${strFldName}]在表对象:[vQxRolesByPotenceNum]中不存在!`;
...
break;
case clsvQxRolesByPotenceNumEN.con_PotenceNum:
this.potenceNum = Number(strValue);
break;
case "sfFldComparisonOp":
this.sfFldComparisonOp = strValue;
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[vQxRolesByPotenceNum]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
public memo = "";    //备注
public potenceNum = 0;    //PotenceNum
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_PropertyNameConst)
 */
 public static readonly con_PotenceNum = "potenceNum";    //PotenceNum
...
//return propName in new clsvQxRolesByPotenceNumEN();
const instance = new clsvQxRolesByPotenceNumEN();
