 ...
 **/
export async function XzMajorShoolType_GetFldValueAsync(
  strFldName: string,
  strWhereCond: string,
): Promise<Array<string>> {
 ...
 **/
export async function XzMajorShoolType_AddNewObjSave(
  objXzMajorShoolTypeEN: clsXzMajorShoolTypeEN,
 ...
 **/
export async function XzMajorShoolType_CheckUniCond4Add(
  objXzMajorShoolTypeEN: clsXzMajorShoolTypeEN,
): Promise<boolean> {
 ...
 **/
export async function XzMajorShoolType_CheckUniCond4Update(
  objXzMajorShoolTypeEN: clsXzMajorShoolTypeEN,
): Promise<boolean> {
 ...
 **/
export async function XzMajorShoolType_UpdateObjSave(
  objXzMajorShoolTypeEN: clsXzMajorShoolTypeEN,
): Promise<boolean> {
  ...
  if (
    ...
    objXzMajorShoolTypeEN.idXzMajorShoolType == undefined
  ) {
 ...
 * @returns 获取修改是否成功？
 **/
export async function XzMajorShoolType_EditRecordExAsync(
  objXzMajorShoolTypeEN: clsXzMajorShoolTypeEN,
): Promise<boolean> {
