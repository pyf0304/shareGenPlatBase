...
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxUserRoleRelation4Synch]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[QxUserRoleRelation4Synch]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
