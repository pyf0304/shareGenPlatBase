...
import {
  ...
  QxDepartmentType_GetObjLstAsync,
...
export async function QxDepartmentTypeEx_GetObjExLstByPagerAsync(
  ...
  if (
    ...
    clsQxDepartmentTypeEN._AttributeName.indexOf(objSortInfo.SortFld) == -1
  ) {
...
export function QxDepartmentTypeEx_FuncMapByFldName(
  ...
  let strMsg = '';
  //如果是本表中字段,不需要映射
  const arrFldName = clsQxDepartmentTypeEN._AttributeName;
